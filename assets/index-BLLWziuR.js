import{R as I,V as F,C as U,a as w,S as W,A as q,D as k,F as A,P as Y,W as X,b as _,c as D,L as C,d as z,e as B,H as Z,T,f as v,M as E,g as x,h as K,B as J,i as O,j as H,k as R,l as N,m as P,n as Q,o as ee,p as V,q as te}from"./three-4x0lhi4J.js";import{g as l}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const oe={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/les-ombres-de-la-mer/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/les-ombres-de-la-mer/"},ie="/mondes-immerges/accueil/";function S(r){return oe[r]||ie}class se{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new I,this.mouse=new F,this.clock=new U,this.labelsVisible=!1,this.currentVideoPath="/mondes-immerges/videos/globe-video.webm",this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new W;const e=new q(16777215,1.2);this.scene.add(e);const t=new k(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new Y(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new X({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=_;const o=this.renderer.getContext();console.log("WebGL Version:",o.getParameter(o.VERSION)),console.log("WebGL Vendor:",o.getParameter(o.VENDOR)),console.log("Max Texture Size:",o.getParameter(o.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(o){console.error("Erreur lors de la création du renderer WebGL:",o),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e)}setupLighting(){const e=new q(4210768,.5);this.scene.add(e);const t=new k(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const o=new Z(35071,65416,.6);this.scene.add(o)}createCelestialBodies(){const e=new T,t=e.load("/mondes-immerges/images/sun-texture.jpg"),o=new v(3,32,32),i=new E({map:t,transparent:!0,opacity:.95}),s=new x(o,i);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/mondes-immerges/images/moon-texture.jpg"),a=new v(1.5,32,32),c=new K({map:n}),d=new x(a,c);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,c=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),p=c*Math.sin(n);const m=p*Math.sin(d);p=p*Math.cos(d),e.push(new w(u,m,p))}new J().setFromPoints(e);const o=new v(.2,16,16),i=new E({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(o,i),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const o=document.createElement("video");o.src=this.currentVideoPath,o.loop=!0,o.muted=!0,o.autoplay=!1,o.playsInline=!0,o.crossOrigin="anonymous",o.preload="auto",this.videoElement=o,console.log("📦 Préchargement de la vidéo du globe...",this.currentVideoPath);let i=!1;const s=setTimeout(()=>{i||(console.warn("⚠️ Timeout préchargement vidéo - continuation"),i=!0,e())},1e4);o.addEventListener("canplaythrough",()=>{i||(console.log("✅ Vidéo du globe préchargée et prête"),i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("canplay",()=>{i||(console.log("✅ Vidéo du globe peut être jouée"),i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("error",h=>{i||(console.error("❌ Erreur chargement vidéo globe:",h),console.warn("Continuation malgré l'erreur"),i=!0,clearTimeout(s),e())}),o.addEventListener("ended",()=>{o.play()}),setInterval(()=>{o.paused&&!o.ended&&(console.log("Vidéo en pause, relance..."),o.play().catch(h=>{console.error("Impossible de relancer la vidéo:",h)}))},1e3),this.videoTexture=new D(o),this.videoTexture.minFilter=C,this.videoTexture.magFilter=C,this.videoTexture.format=z,this.videoTexture.colorSpace=B;const n=new v(1.99,64,64),a=new E({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:O}),c=new x(n,a);c.renderOrder=0,this.scene.add(c),this.depthSphere=c;const d=new v(2,64,64),u=new E({map:this.videoTexture,transparent:!0,opacity:1,side:O,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(d,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const p=new v(2.02,64,64),m=new E({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(p,m),this.clouds.renderOrder=2,this.scene.add(this.clouds),o.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new H({vertexShader:`
...
`),(t?t.querySelectorAll("button"):[]).forEach(i=>{i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function Ee(){if(y.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),y.initialized=!0,!me())return;we();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{be()},300))},200)}function Me(){y.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),y.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(y.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),y.domReady=!0,ge(),setTimeout(()=>{Ee()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Me,{once:!0});window.addEventListener("pageshow",r=>{(r.persisted||window.performance&&window.performance.navigation.type===2)&&(console.log("🔄 Page restaurée depuis le cache, rechargement..."),window.location.reload())});
