...
export class ContentPanel {
    ...
    init() {
        ...
        if (this.videoElement) {
            ...
            this.videoElement.addEventListener('error', () => {
                ...
                placeholder.src = `${import.meta.env.BASE_URL}images/video-placeholder.jpg`;
    ...
    createDrawerElements() {
        ...
        this.drawer.style.cssText = `
            ...
            width: 100%;
            height: 70%;
            background: linear-gradient(to bottom, rgba(2, 8, 20, 0.95) 0%, rgba(0, 10, 30, 0.97) 100%); /* PERF FIX: removed backdrop-filter fullscreen */
