import{R as L,V as U,C as W,a as y,S as _,A as q,D as k,F as A,P as X,W as Y,b as Z,c as D,L as T,d as z,e as B,H as K,T as I,f as v,M as C,g as x,h as J,B as Q,i as $,j as O,k as H,l as V,m as ee,n as te,o as R,p as oe,q as ie}from"./three-Bmxrupip.js";import{g as c}from"./gsap-xHO-obUW.js";import{i as se}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ne={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ae="/nationalgeographic.fr-mondesimmerges/accueil/";function re(l){return ne[l]||ae}class le{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new L,this.mouse=new U,this.clock=new W,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new y(100,20,100),moonPosition:new y(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new _;const e=new q(16777215,1.2);this.scene.add(e);const t=new k(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new X(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new Y({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Z;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `,e.appendChild(t),this.container.appendChild(e)}setupLighting(){const e=new q(4210768,.5);this.scene.add(e);const t=new k(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new K(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new I,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new v(3,32,32),o=new C({map:t,transparent:!0,opacity:.95}),n=new x(i,o);n.position.copy(this.celestialParams.sunPosition),this.scene.add(n);const s=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new v(1.5,32,32),d=new J({map:s}),r=new x(a,d);r.position.copy(this.celestialParams.moonPosition),this.scene.add(r),this.sun=n,this.moon=r}createOrbitPath(){const e=[];for(let n=0;n<=100;n++){const s=n/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,d=this.orbitParams.ellipseMinorAxis,r=this.orbitParams.inclination;let p=a*Math.cos(s),u=d*Math.sin(s);const h=u*Math.sin(r);u=u*Math.cos(r),e.push(new y(p,h,u))}new Q().setFromPoints(e);const i=new v(.2,16,16),o=new C({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(r=>{console.error("Impossible de relancer la vidéo:",r)}))},1e3),this.videoTexture=new D(e),this.videoTexture.minFilter=T,this.videoTexture.magFilter=T,this.videoTexture.format=z,this.videoTexture.colorSpace=B;const t=new v(1.99,64,64),i=new C({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:$}),o=new x(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const n=new v(2,64,64),s=new C({map:this.videoTexture,transparent:!0,opacity:1,side:$,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(n,s),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const a=new v(2.02,64,64),d=new C({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(a,d),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(r=>{console.error("Erreur lors de la lecture de la vidéo:",r),this.handleVideoError()})}createAtmosphere(){const e=new v(2.08,64,64),t=new O({vertexShader:`
            ...
            `,uniforms:{cameraPosition:{value:new y}},blending:V,side:H,transparent:!0}),i=new x(e,t);this.scene.add(i),this.atmosphere=i,this.updateAtmosphereUniforms=()=>{this.atmosphere&&this.atmosphere.material.uniforms&&this.atmosphere.material.uniforms.cameraPosition.value.copy(this.camera.position)}}createSkybox(){new I().load("/nationalgeographic.fr-mondesimmerges/interface/images/night-sky.png",i=>{this.renderer.toneMapping=ee,this.renderer.toneMappingExposure=.3;const o=new te(i.image.height);o.fromEquirectangularTexture(this.renderer,i),this.scene.background=o.texture,this.scene.fog=new A(17,8e-5)},void 0,i=>{console.error("Erreur lors du chargement de la texture du ciel:",i),this.scene.background=new R(17)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const n=this.orbitParams.inclination,s=o*Math.sin(n);o=o*Math.cos(n),this.camera.position.set(i,s,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,s,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new y(i,s,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const n=this.orbitParams.inclination,s=o*Math.sin(n);o=o*Math.cos(n),this.camera.position.set(i,s,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{this.scene.remove(t),t.userData.labelContainer&&document.body.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],e.forEach(t=>{const{position:i,title:o}=t,n=i.lat*(Math.PI/180),s=i.lng*(Math.PI/180),a=2.1,d=a*Math.cos(n)*Math.cos(s),r=a*Math.sin(n),p=a*Math.cos(n)*Math.sin(s);console.log(`Hotspot ${o}: GPS(${i.lat}, ${i.lng}) -> 3D(${d.toFixed(2)}, ${r.toFixed(2)}, ${p.toFixed(2)})`);const u=new v(.05,16,16),h=new C({color:16772608,transparent:!0,opacity:1}),m=new x(u,h);m.position.set(d,r,p),m.userData={hotspot:t};const E=new v(.08,16,16),w=new C({color:16768256,transparent:!0,opacity:.7,side:H}),M=new x(E,w);m.add(M),this.addHotspotLabel(m,o,new y(d,r,p)),this.scene.add(m),this.hotspotObjects.push(m)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label-container",o.style.cssText=`
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        `;const n=document.createElement("div");n.className="hotspot-label",n.textContent=t,n.style.cssText=`
            ...
            pointer-events: auto;
            cursor: pointer;
        `,n.addEventListener("mouseenter",()=>{n.style.backgroundColor="rgba(255, 204, 0, 0.9)",n.style.color="#000",n.style.transform="scale(1.05)"}),n.addEventListener("mouseleave",()=>{n.style.backgroundColor="rgba(0, 0, 0, 0.7)",n.style.color="#ffcc00",n.style.transform="scale(1)"}),n.addEventListener("click",d=>{d.stopPropagation();const r=e.userData.hotspot;r&&(console.log(`Label cliqué: ${r.title}`),this.activateHotspot(r))});const s=document.createElement("div");s.className="connector-line",s.style.cssText=`
            position: absolute;
        ...
        `,o.appendChild(n),o.appendChild(s),document.body.appendChild(o),e.userData.label=n,e.userData.connector=s,e.userData.labelContainer=o,e.userData.worldPosition=i.clone();const a=d=>{const r=new y().copy(d).project(this.camera);if(r.z>1||r.x<-1||r.x>1||r.y<-1||r.y>1)return!1;const p=new y().subVectors(d,this.camera.position).normalize(),h=new L(this.camera.position,p).intersectObject(this.globe);if(h.length>0){const m=h[0].distance,E=this.camera.position.distanceTo(d);return m>E-.1}return!0};e.onBeforeRender=()=>{if(!e.userData.label||!e.userData.connector)return;if(!a(e.userData.worldPosition)||this.orbitParams.inHotspotMode){e.userData.label&&(e.userData.label.style.opacity="0",e.userData.label.style.display="none"),e.userData.connector&&(e.userData.connector.style.opacity="0",e.userData.connector.style.display="none");return}e.userData.label&&(e.userData.label.style.display="block"),e.userData.connector&&(e.userData.connector.style.display="block");const r=e.userData.worldPosition.clone();r.project(this.camera);const p=(r.x*.5+.5)*window.innerWidth,u=(-r.y*.5+.5)*window.innerHeight,h=window.innerWidth/2,m=window.innerHeight/2,E=Math.sqrt(Math.pow(p-h,2)+Math.pow(u-m,2)),w=Math.atan2(u-m,p-h),M=Math.min(h,m)*.6;let g,b;if(E<M){const S=M+60+Math.sin(w*5)*20;g=h+Math.cos(w)*S,b=m+Math.sin(w)*S;const f=20;g<f&&(g=f),g>window.innerWidth-f&&(g=window.innerWidth-f),b<f&&(b=f),b>window.innerHeight-f&&(b=window.innerHeight-f)}else{const S=t.length*8,f=25+S*.25,P=10;p+f+S>window.innerWidth-20?g=p-f-S:g=p+f,u-P-30<20?b=u+P:b=u-P}e.userData.label.style.left=`${g}px`,e.userData.label.style.top=`${b}px`,e.userData.label.style.opacity="1",s.style.left=`${p}px`,s.style.top=`${u}px`;const G=Math.sqrt(Math.pow(g-p,2)+Math.pow(b-u,2)),F=Math.atan2(b-u,g-p);s.style.width=`${G}px`,s.style.transform=`rotate(${F}rad)`,s.style.opacity="1",s.style.animation="pulseConnector 2s infinite alternate"}}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),d=90-s*180/Math.PI,r=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${d.toFixed(2)}, lng: ${r.toFixed(2)}`);const p=this._findNearestHotspot(d,r,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of s){const d=a.position.lat,r=a.position.lng,p=Math.sqrt(Math.pow(d-e,2)+Math.pow(r-t,2));p<n&&(n=p,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),d=new y(n,s,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=d.clone().normalize().multiplyScalar(3.5);c.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),c.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=re(e.id);console.log(`Redirection vers: ${t}`);const i=document.getElementById("transitionVideo");i?(console.log("🎬 Lecture de la vidéo de transition (normale)"),i.classList.add("active"),i.currentTime=0,i.playbackRate=1,i.play().then(()=>{console.log("✅ Vidéo de transition normale lancée"),i.addEventListener("ended",()=>{console.log("✅ Vidéo de transition terminée - Redirection..."),i.classList.remove("active"),window.location.href=t},{once:!0})}).catch(o=>{console.error("Erreur lors de la lecture de la vidéo:",o),window.location.href=t})):(console.warn("Vidéo de transition non trouvée - Redirection immédiate"),window.location.href=t)}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),a=new oe(0,.3,32),d=new O({uniforms:{color:{value:new R(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `;for(let a=0;a<3;a++){const d=document.createElement("div");d.style.cssText=`
            ...
            `;for(let r=0;r<3+a;r++){const p=document.createElement("div"),u=360/(3+a)*r;p.style.cssText=`
                ...
                `,d.appendChild(p)}o.appendChild(d)}const n=document.createElement("div");n.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,o.appendChild(n),i.appendChild(o);const s=document.createElement("style");s.textContent=`
            @keyframes orbit0 {
        ...
        `,document.head.appendChild(s),this.effectsContainer.appendChild(i),c.fromTo(i,{opacity:0},{opacity:1,duration:.5}),c.to(i,{backgroundColor:"rgba(0, 0, 0, 0)",duration:t,ease:"power2.out",delay:.3}),setTimeout(()=>{c.to(i,{opacity:0,duration:.5,onComplete:()=>{i.remove(),s.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),c.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{c.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const o={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let n=0;n<o.pulseCount;n++)setTimeout(()=>{const s=document.createElement("div");s.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),a=Math.random()*3+1,d=Math.random()*100,r=Math.random()*100,p=Math.random()*5,u=Math.random()*10+10,h=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
