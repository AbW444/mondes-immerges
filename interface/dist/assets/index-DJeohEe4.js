import{R as L,V as U,C as W,a as y,S as _,A as k,D as q,F as A,P as X,W as Y,b as Z,c as z,L as T,d as D,e as B,H as K,T as I,f as v,M as C,g as x,h as J,B as Q,i as $,j as O,k as H,l as N,m as ee,n as te,o as R,p as oe,q as ie}from"./three-Bmxrupip.js";import{g as d}from"./gsap-xHO-obUW.js";import{i as se}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ne={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ae="/nationalgeographic.fr-mondesimmerges/accueil/";function re(l){return ne[l]||ae}class le{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new L,this.mouse=new U,this.clock=new W,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new y(100,20,100),moonPosition:new y(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new _;const e=new k(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new X(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new Y({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Z;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `;const n=document.createElement("div");n.className="hotspot-label",n.textContent=t,n.style.cssText=`
            ...
            pointer-events: auto;
            cursor: pointer;
        `,n.addEventListener("mouseenter",()=>{n.style.backgroundColor="rgba(255, 204, 0, 0.9)",n.style.color="#000",n.style.transform="scale(1.05)"}),n.addEventListener("mouseleave",()=>{n.style.backgroundColor="rgba(0, 0, 0, 0.7)",n.style.color="#ffcc00",n.style.transform="scale(1)"}),n.addEventListener("click",c=>{c.stopPropagation();const r=e.userData.hotspot;r&&(console.log(`Label cliqué: ${r.title}`),this.activateHotspot(r))});const s=document.createElement("div");s.className="connector-line",s.style.cssText=`
            position: absolute;
        ...
        `,o.appendChild(n),o.appendChild(s),document.body.appendChild(o),e.userData.label=n,e.userData.connector=s,e.userData.labelContainer=o,e.userData.worldPosition=i.clone();const a=c=>{const r=new y().copy(c).project(this.camera);if(r.z>1||r.x<-1||r.x>1||r.y<-1||r.y>1)return!1;const p=new y().subVectors(c,this.camera.position).normalize(),h=new L(this.camera.position,p).intersectObject(this.globe);if(h.length>0){const m=h[0].distance,E=this.camera.position.distanceTo(c);return m>E-.1}return!0};e.onBeforeRender=()=>{if(!e.userData.label||!e.userData.connector)return;if(a(e.userData.worldPosition)&&!this.orbitParams.inHotspotMode){const r=e.userData.worldPosition.clone();r.project(this.camera);const p=(r.x*.5+.5)*window.innerWidth,u=(-r.y*.5+.5)*window.innerHeight,h=window.innerWidth/2,m=window.innerHeight/2,E=Math.sqrt(Math.pow(p-h,2)+Math.pow(u-m,2)),w=Math.atan2(u-m,p-h),M=Math.min(h,m)*.6;let g,b;if(E<M){const S=M+60+Math.sin(w*5)*20;g=h+Math.cos(w)*S,b=m+Math.sin(w)*S;const f=20;g<f&&(g=f),g>window.innerWidth-f&&(g=window.innerWidth-f),b<f&&(b=f),b>window.innerHeight-f&&(b=window.innerHeight-f)}else{const S=t.length*8,f=25+S*.25,P=10;p+f+S>window.innerWidth-20?g=p-f-S:g=p+f,u-P-30<20?b=u+P:b=u-P}e.userData.label.style.left=`${g}px`,e.userData.label.style.top=`${b}px`,e.userData.label.style.opacity="1",s.style.left=`${p}px`,s.style.top=`${u}px`;const G=Math.sqrt(Math.pow(g-p,2)+Math.pow(b-u,2)),F=Math.atan2(b-u,g-p);s.style.width=`${G}px`,s.style.transform=`rotate(${F}rad)`,s.style.opacity="1",s.style.animation="pulseConnector 2s infinite alternate"}else e.userData.label.style.opacity="0",s.style.opacity="0"}}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),c=90-s*180/Math.PI,r=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${c.toFixed(2)}, lng: ${r.toFixed(2)}`);const p=this._findNearestHotspot(c,r,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of s){const c=a.position.lat,r=a.position.lng,p=Math.sqrt(Math.pow(c-e,2)+Math.pow(r-t,2));p<n&&(n=p,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),c=new y(n,s,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=c.clone().normalize().multiplyScalar(3.5);d.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),d.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
       ...
       `,document.body.appendChild(t),d.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=re(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),a=new oe(0,.3,32),c=new O({uniforms:{color:{value:new R(16763904)},time:{value:0}},vertexShader:`
        ...
        `;const o=document.createElement("div");o.style.cssText=`
            ...
            justify-content: center;
            align-items: center;
        `;for(let a=0;a<3;a++){const c=document.createElement("div");c.style.cssText=`
                position: absolute;
                border-radius: 50%;
            ...
            `;for(let r=0;r<3+a;r++){const p=document.createElement("div"),u=360/(3+a)*r;p.style.cssText=`
                ...
                `,c.appendChild(p)}o.appendChild(c)}const n=document.createElement("div");n.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,document.head.appendChild(s),this.effectsContainer.appendChild(i),d.fromTo(i,{opacity:0},{opacity:1,duration:.5}),setTimeout(()=>{d.to(i,{opacity:0,duration:.5,onComplete:()=>{i.remove(),s.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),d.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{d.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const o={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let n=0;n<o.pulseCount;n++)setTimeout(()=>{const s=document.createElement("div");s.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
        ...
        `,this.effectsContainer.appendChild(t),d.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),a=Math.random()*3+1,c=Math.random()*100,r=Math.random()*100,p=Math.random()*5,u=Math.random()*10+10,h=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `,i.appendChild(o),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(c=>{const r=document.createElement("div");r.className="minimap-dot",r.dataset.id=c.id,r.title=c.name,r.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,r.addEventListener("mouseenter",()=>{d.to(r,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(r,c.name,{position:"top",duration:2e3})}),r.addEventListener("mouseleave",()=>{d.to(r,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),r.addEventListener("click",()=>{t&&t(c.id)}),i.appendChild(r)});const s=document.createElement("div");s.className="minimap-toggle",s.innerHTML="−",s.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
    ...
    `,document.head.appendChild(l);const e=document.getElementById("welcome-screen");e&&(e.style.display="none",e.classList.add("hidden"));const t=document.getElementById("main-container");t&&(t.classList.add("hidden"),t.style.opacity="0");let i=0;const o=8,n=()=>{i++;const a=Math.round(i/o*100);console.log(`📦 Ressource ${i}/${o} chargée (${a}%)`);const c=document.querySelector(".progress-bar"),r=document.querySelector(".progress-text");c&&(c.style.width=`${a}%`),r&&(r.textContent=`${a}%`),i>=o&&(console.log("✅ Toutes les ressources chargées - Démarrage de l'application"),we())};["Configuration système","Textures globe","Vidéos des zones","Données géographiques","Interfaces utilisateur","Modèles 3D","Données scientifiques","Effets visuels"].forEach((a,c)=>{const r=150+Math.random()*250;setTimeout(()=>{console.log(`📦 Ressource chargée: ${a}`),n()},r*(c+1))}),ve()}function ve(){const l=document.getElementById("main-container");if(!l||l.querySelector(".starry-background"))return;const e=document.createElement("div");e.className="starry-background",e.style.cssText=`
        position: absolute;
        top: 0;
        left: 0;
        width: 100%;
        ...
        pointer-events: none;
        z-index: -1;
    `,l.appendChild(e);for(let t=0;t<100;t++){const i=document.createElement("div");i.className="star";const o=Math.random()*100,n=Math.random()*100,s=Math.random()*2+1,a=Math.random()*.7+.3,c=Math.random()*5+3,r=Math.random()*3;i.style.cssText=`
            position: absolute;
            left: ${o}%;
            top: ${n}%;
            width: ${s}px;
            ...
            border-radius: 50%;
            animation: starTwinkle ${c}s ease-in-out ${r}s infinite;
            pointer-events: none;
