import{R as L,V as W,C as _,a as x,S as X,A as I,D as q,F as k,P as Y,W as Z,b as A,L as w,c as D,d as z,H as J,T,e as v,M,f as y,g as K,B as Q,h as B,i as O,j as R,k as N,l as S,m as ee,n as te,o as H,p as oe}from"./three-Ch-jLiEk.js";import{g as u}from"./gsap-xHO-obUW.js";import{i as V}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const ie={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},se="/nationalgeographic.fr-mondesimmerges/accueil/";function ne(c){return ie[c]||se}class ae{constructor(){this.video=null,this.loadingScreen=null,this.jellySpinner=null,this.isTransitioning=!1,this.config={videoPath:"videos/anim-logo-transition.webm",jellySize:120,jellyColor:"#ffcc00",transitionDuration:500,videoFadeDuration:300},this.initialize()}initialize(){console.log("🎬 Initialisation du TransitionManager");try{V.register()}catch(e){console.warn("⚠️ Jelly déjà enregistré")}this.createTransitionElements(),console.log("✅ TransitionManager initialisé")}createTransitionElements(){this.loadingScreen=document.getElementById("transition-loading-screen"),this.loadingScreen||(this.loadingScreen=document.createElement("div"),this.loadingScreen.id="transition-loading-screen",this.loadingScreen.className="transition-loading-screen",this.loadingScreen.innerHTML=`
        ...
        `,this.container.appendChild(e)}setupWebGLContextHandlers(){if(!this.renderer||!this.renderer.domElement)return;const e=this.renderer.domElement;e.addEventListener("webglcontextlost",t=>{t.preventDefault(),console.error("🔴 CONTEXTE WEBGL PERDU - Tentative de récupération..."),this.animationFrameId&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.contextLost=!0,this.showContextLostMessage()},!1),e.addEventListener("webglcontextrestored",()=>{console.log("✅ CONTEXTE WEBGL RESTAURÉ - Réinitialisation..."),this.contextLost=!1,this.hideContextLostMessage();try{this.reinitializeAfterContextLoss()}catch(t){console.error("Erreur lors de la réinitialisation:",t),setTimeout(()=>{window.location.reload()},2e3)}},!1),console.log("✅ Gestionnaires de contexte WebGL configurés")}showContextLostMessage(){if(document.getElementById("webgl-context-lost-msg"))return;const t=document.createElement("div");t.id="webgl-context-lost-msg",t.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
            transform: translate(-50%, -50%);
        ...
        `,this.container.appendChild(e),u.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),u.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}setupLighting(){const e=new I(4210768,.5);this.scene.add(e);const t=new q(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new J(35071,65416,.6);this.scene.add(i)}optimizeTexture(e){return e.generateMipmaps=!1,e.minFilter=w,e.magFilter=w,e.anisotropy=1,e}createCelestialBodies(){const e=new T,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg",d=>{this.optimizeTexture(d)}),i=new v(3,32,32),o=new M({map:t,transparent:!0,opacity:.95}),s=new y(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg",d=>{this.optimizeTexture(d)}),a=new v(1.5,32,32),r=new K({map:n}),l=new y(a,r);l.position.copy(this.celestialParams.moonPosition),this.scene.add(l),this.sun=s,this.moon=l}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,r=this.orbitParams.ellipseMinorAxis,l=this.orbitParams.inclination;let d=a*Math.cos(n),p=r*Math.sin(n);const h=p*Math.sin(l);p=p*Math.cos(l),e.push(new x(d,h,p))}new Q().setFromPoints(e);const i=new v(.2,16,16),o=new M({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new y(i,o),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const i=document.createElement("video");i.src=this.currentVideoPath,i.loop=!0,i.muted=!0,i.autoplay=!1,i.playsInline=!0,i.crossOrigin="anonymous",i.preload="auto",this.videoElement=i,console.log("📦 Préchargement de la vidéo du globe...",this.currentVideoPath);let o=!1;const s=setTimeout(()=>{o||(console.warn("⚠️ Timeout préchargement vidéo - continuation"),o=!0,e())},1e4);i.addEventListener("canplaythrough",()=>{o||(console.log("✅ Vidéo du globe préchargée et prête"),o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("canplay",()=>{o||(console.log("✅ Vidéo du globe peut être jouée"),o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("error",m=>{o||(console.error("❌ Erreur chargement vidéo globe:",m),console.warn("Continuation malgré l'erreur"),o=!0,clearTimeout(s),e())}),i.addEventListener("ended",()=>{i.play()}),setInterval(()=>{i.paused&&!i.ended&&(console.log("Vidéo en pause, relance..."),i.play().catch(m=>{console.error("Impossible de relancer la vidéo:",m)}))},1e3),this.videoTexture=new A(i),this.videoTexture.minFilter=w,this.videoTexture.magFilter=w,this.videoTexture.format=D,this.videoTexture.colorSpace=z,this.videoTexture.generateMipmaps=!1,this.videoTexture.anisotropy=1,console.log("✅ Texture vidéo optimisée pour mémoire GPU limitée");const n=new v(1.99,64,64),a=new M({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:B}),r=new y(n,a);r.renderOrder=0,this.scene.add(r),this.depthSphere=r;const l=new v(2,64,64),d=new M({map:this.videoTexture,transparent:!0,opacity:1,side:B,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new y(l,d),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const p=new v(2.02,64,64),h=new M({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new y(p,h),this.clouds.renderOrder=2,this.scene.add(this.clouds),i.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new O({vertexShader:`
        ...
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.style.cssText=`
            ...
            z-index: 999;
            opacity: 0;
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(o),document.body.appendChild(s);const a=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},r=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffcc00",o.style.transform="scale(1)"},l=d=>{d.stopPropagation();const p=e.userData.hotspot;p&&(console.log(`Label cliqué: ${p.title}`),this.activateHotspot(p))};o.addEventListener("mouseenter",a),o.addEventListener("mouseleave",r),o.addEventListener("click",l),e.userData.label=o,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:r,onClick:l},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,n=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),r=90-n*180/Math.PI,l=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${r.toFixed(2)}, lng: ${l.toFixed(2)}`);const d=this._findNearestHotspot(r,l,10);if(d){console.log(`Hotspot trouvé: ${d.title}`),this.activateHotspot(d);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,s=i;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const r=a.position.lat,l=a.position.lng,d=Math.sqrt(Math.pow(r-e,2)+Math.pow(l-t,2));d<s&&(s=d,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,s=o*Math.cos(t)*Math.cos(i),n=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),r=new x(s,n,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const l=this.camera.position.clone(),h=r.clone().normalize().multiplyScalar(3.5),m=new x().addVectors(l,h).multiplyScalar(.5);m.normalize().multiplyScalar(m.length()+1.8);const f=u.timeline();f.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}}),f.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),f.to(this.camera,{fov:40,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE (avec transition OUT) ===");const t=$(),i=ne(e.id);console.log(`Préparation de la redirection vers: ${i}`),t.transitionOut(()=>{console.log(`✅ Transition OUT terminée - Redirection vers: ${i}`),window.location.href=i})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(i),a=new H(0,.3,32),r=new O({uniforms:{color:{value:new S(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
           ...
           `,side:oe,transparent:!0,blending:N,depthWrite:!1}),l=new y(a,r);l.position.set(o,s,n),l.lookAt(0,0,0),this.scene.add(l);let d=performance.now();const p=()=>{const h=(performance.now()-d)/1e3;r.uniforms.time.value=h,h<2?requestAnimationFrame(p):(this.scene.remove(l),l.geometry.dispose(),r.dispose())};p(),u.to(l.scale,{x:4,y:4,z:1,duration:2,ease:"power1.out"}),u.to(r.uniforms.color.value,{r:1,g:.8,b:.2,duration:2,ease:"power1.out"})}exitHotspotMode(){this.orbitParams.inHotspotMode&&(console.log("Sortie du mode hotspot"),this.orbitParams.inHotspotMode=!1,u.to(this.camera,{fov:60,duration:1,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}}),setTimeout(()=>{this.orbitParams.isOrbiting=!0,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed},500))}exitHotspotModeExternal(){this.exitHotspotMode()}handleVideoError(){console.log("Tentative de résolution de l'erreur vidéo..."),new T().load("/nationalgeographic.fr-mondesimmerges/interface/images/video-placeholder.jpg",t=>{this.optimizeTexture(t),this.globe&&this.globe.material&&(console.log("Application de la texture de secours"),this.globe.material.uniforms&&this.globe.material.uniforms.map?this.globe.material.uniforms.map.value=t:this.globe.material.map=t,this.globe.material.needsUpdate=!0)})}zoom(e){const t=e?.85:1.15,i=this.orbitParams.zoomLevel*t;this.orbitParams.zoomLevel=Math.min(Math.max(i,this.orbitParams.minZoomLevel),this.orbitParams.maxZoomLevel),u.to(this.camera.position,{x:this.camera.position.x*t,y:this.camera.position.y*t,z:this.camera.position.z*t,duration:.5,ease:"back.out(1.2)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}resetView(){this.orbitParams.zoomLevel=1,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed;const e=this.orbitParams.ellipseMajorAxis,t=this.orbitParams.ellipseMinorAxis,i=this.orbitParams.inclination,o=this.orbitParams.orbitAngle,s=e*Math.cos(o),n=t*Math.sin(o),a=n*Math.sin(i),r=n*Math.cos(i);u.to(this.camera.position,{x:s,y:a,z:r,duration:1,ease:"elastic.out(1, 0.7)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}setHotspotSelectCallback(e){this.onHotspotSelect=e}setHotspotExitCallback(e){this.onHotspotExit=e}updateHotspotLabels(){if(this.orbitParams.inHotspotMode){this.hotspotObjects.forEach(e=>{e.userData.label&&(e.userData.label.style.opacity="0"),e.userData.connectorSvg&&(e.userData.connectorSvg.style.opacity="0")});return}this.hotspotObjects.forEach(e=>{if(!e.userData.label||!e.userData.worldPosition)return;const t=e.userData.worldPosition,i=t.clone().project(this.camera);if(i.z>1||i.x<-1||i.x>1||i.y<-1||i.y>1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}const o=new x().subVectors(t,this.camera.position).normalize(),n=new L(this.camera.position,o).intersectObject(this.globe);if(n.length>0){const E=n[0].distance,b=this.camera.position.distanceTo(t);if(E<b-.1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}}const a=(i.x*.5+.5)*window.innerWidth,r=(-i.y*.5+.5)*window.innerHeight,l=e.userData.labelText.length*7,d=40,p=-15;let h=a+d,m=r+p;const g=10;h+l>window.innerWidth-g&&(h=a-d-l),h<g&&(h=g),m<g&&(m=g),m>window.innerHeight-g&&(m=window.innerHeight-g),e.userData.label.style.left=`${h}px`,e.userData.label.style.top=`${m}px`,this.labelsVisible&&(e.userData.label.style.opacity="1");const f=e.userData.connectorLine;f&&(f.setAttribute("x1",a),f.setAttribute("y1",r),f.setAttribute("x2",h),f.setAttribute("y2",m+10),this.labelsVisible&&(e.userData.connectorSvg.style.opacity="1"))})}showLabels(){this.labelsVisible=!0,console.log("✅ Labels de hotspots activés + animation des markers"),this.hotspotObjects.forEach((e,t)=>{e.userData.materials&&e.userData.materials.forEach((i,o)=>{const s=o===0?.8:.5;u.to(i,{opacity:s,duration:.8,delay:t*.1,ease:"power2.out"})})})}animate(){requestAnimationFrame(this.animate.bind(this));const e=this.clock.getDelta(),t=this.clock.getElapsedTime()*1e3;this.orbitParams.isOrbiting&&!this.orbitParams.inHotspotMode&&this.updateCameraPosition(),this.updateSkyboxTime&&this.updateSkyboxTime(t),this.updateAtmosphereUniforms&&this.updateAtmosphereUniforms(),this.hotspotObjects.forEach(i=>{const o=i.userData.waveRings;o&&o.forEach(s=>{s.userData.waveTime+=e;const n=s.userData.waveTime-s.userData.initialDelay;if(n>0){const r=n%2.5/2.5,l=.05,p=l+(.18-l)*r;s.geometry.dispose(),s.geometry=new H(p,p+.02,32),s.material.opacity=.7*(1-r)}})}),this.updateHotspotLabels(),this.clouds&&(this.clouds.rotation.y+=1e-4),this.globe&&!this.orbitParams.inHotspotMode&&(this.globe.rotation.y+=2e-4),this.globe&&this.globe.material.uniforms&&this.globe.material.uniforms.time&&(this.globe.material.uniforms.time.value=t),this.videoElement&&this.videoElement.paused&&!this.videoElement.ended&&this.videoElement.play().catch(i=>{console.error("Erreur lors de la reprise de la vidéo:",i)}),this.renderer.render(this.scene,this.camera)}}class le{constructor(e){this.container=e.container,this.effectsContainer=null,this.notificationContainer=null,this.init()}init(){this.effectsContainer=document.createElement("div"),this.effectsContainer.classList.add("effects-container"),this.effectsContainer.style.position="absolute",this.effectsContainer.style.top="0",this.effectsContainer.style.left="0",this.effectsContainer.style.width="100%",this.effectsContainer.style.height="100%",this.effectsContainer.style.pointerEvents="none",this.effectsContainer.style.zIndex="5",this.container.appendChild(this.effectsContainer),this.createNotificationContainer()}createNotificationContainer(){this.notificationContainer=document.createElement("div"),this.notificationContainer.className="notification-container",this.notificationContainer.style.cssText=`
            ...
            pointer-events: none;
            max-width: 400px;
        `,this.container.appendChild(this.notificationContainer)}transitionIn(){const e=document.createElement("div");e.classList.add("transition-overlay"),e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.backgroundColor="#000000",e.style.zIndex="10",this.effectsContainer.appendChild(e),u.fromTo(e,{opacity:1},{opacity:0,duration:1.5,ease:"power2.out",onComplete:()=>{e.remove()}})}transitionOut(e){const t=document.createElement("div");t.classList.add("transition-overlay"),t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor="#000000",t.style.zIndex="10",t.style.opacity="0",this.effectsContainer.appendChild(t),u.to(t,{opacity:1,duration:1,ease:"power2.in",onComplete:()=>{e&&e()}})}createOrbitalLoaderEffect(e,t=4,i=null){const o=document.createElement("div");o.className="orbital-loader",i?o.style.cssText=`
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
            ...
            justify-content: center;
            align-items: center;
        `;for(let d=0;d<3;d++){const p=document.createElement("div");p.style.cssText=`
                position: absolute;
                border-radius: 50%;
                border: 2px solid rgba(255, 204, 0, ${.7-d*.2});
                width: ${120+d*40}px;
                height: ${120+d*40}px;
                animation: orbit${d} ${4-d*.5}s linear infinite;
            `;for(let h=0;h<3+d;h++){const m=document.createElement("div"),g=360/(3+d)*h;m.style.cssText=`
                    position: absolute;
                    width: ${8-d}px;
                    height: ${8-d}px;
                    ...
                    transform: translate(-50%, -50%) rotate(${g}deg) translateX(${60+d*20}px);
        ...
        `,document.head.appendChild(r),(i||this.effectsContainer).appendChild(o),u.fromTo(o,{opacity:0},{opacity:1,duration:.5,onComplete:()=>{i&&e&&(console.log("🎨 Orbital loader visible, début transition fond noir"),e())}}),setTimeout(()=>{i?(o.remove(),r.remove(),console.log("✅ Orbital loader supprimé instantanément")):u.to(o,{opacity:0,duration:1,onComplete:()=>{o.remove(),r.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),u.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{u.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const o={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let s=0;s<o.pulseCount;s++)setTimeout(()=>{const n=document.createElement("div");n.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
                    ...
                    z-index: 100;
                    pointer-events: none;
                `,this.effectsContainer.appendChild(n),u.to(n,{width:o.radius*2,height:o.radius*2,opacity:0,duration:o.duration,ease:"power2.out",onComplete:()=>{n.remove()}})},s*(o.duration*300))}flashScreen(e="#ffffff"){const t=document.createElement("div");t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor=e,t.style.pointerEvents="none",t.style.zIndex="20",t.style.opacity="0",this.effectsContainer.appendChild(t),u.timeline().to(t,{opacity:.7,duration:.1}).to(t,{opacity:0,duration:.3,onComplete:()=>{t.remove()}})}showNotification(e,t="info",i=3e3){this.notificationContainer||this.createNotificationContainer();const o=document.createElement("div");o.className="notification";let s="",n="#2196F3";switch(t){case"success":s="✓",n="#4CAF50";break;case"warning":s="!",n="#FF9800";break;case"error":s="✗",n="#F44336";break;default:s="i",n="#2196F3"}o.innerHTML=`
        ...
        `,this.effectsContainer.appendChild(t),u.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<i.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,r=Math.random()*100,l=Math.random()*100,d=Math.random()*5,p=Math.random()*10+10,h=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
            ...
            `,o.addEventListener("mouseenter",()=>{u.to(o,{backgroundColor:"rgba(255, 204, 0, 0.9)",color:"#000000",borderColor:"#ffcc00",boxShadow:"0 2px 15px rgba(255, 204, 0, 0.5), 0 0 8px rgba(255, 204, 0, 0.7)",duration:.25})}),o.addEventListener("mouseleave",()=>{u.to(o,{backgroundColor:"rgba(0, 10, 30, 0.7)",color:"#ffcc00",borderColor:"rgba(255, 204, 0, 0.7)",boxShadow:"0 2px 10px rgba(0, 0, 0, 0.3), 0 0 4px rgba(255, 204, 0, 0.4)",duration:.3})})}),this.infoBtn&&(this.infoBtn.style.cssText=`
                width: 50px;
                height: 50px;
                border-radius: 50%;
            ...
            `,this.infoBtn.addEventListener("mouseenter",()=>{u.to(this.infoBtn,{backgroundColor:"rgba(255, 204, 0, 0.9)",color:"#000000",borderColor:"#ffcc00",boxShadow:"0 2px 15px rgba(255, 204, 0, 0.5), 0 0 8px rgba(255, 204, 0, 0.7)",duration:.3})}),this.infoBtn.addEventListener("mouseleave",()=>{u.to(this.infoBtn,{backgroundColor:"rgba(0, 10, 30, 0.7)",color:"#ffcc00",borderColor:"rgba(255, 204, 0, 0.7)",boxShadow:"0 2px 10px rgba(0, 0, 0, 0.3), 0 0 4px rgba(255, 204, 0, 0.4)",duration:.3})})),this.infoOverlay){this.infoOverlay.style.cssText=`
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
            ...
            pointer-events: none;
            max-width: 400px;
        `,document.getElementById("main-container").appendChild(this.notificationContainer)}animateButtonsIn(){this.buttons.forEach(e=>{u.set(e,{opacity:0,y:20,scale:.8})}),this.buttons.forEach((e,t)=>{u.to(e,{opacity:1,y:0,scale:1,duration:.7,delay:1.5+t*.15,ease:"back.out(1.7)"})})}animateButtonClick(e){u.timeline().to(e,{scale:.85,duration:.15,ease:"power2.in"}).to(e,{scale:1,duration:.4,ease:"elastic.out(1.2, 0.5)"})}toggleInfoOverlay(){this.isInfoVisible?this.hideInfoOverlay():this.showInfoOverlay()}showInfoOverlay(){if(this.isInfoVisible)return;this.isInfoVisible=!0,this.infoOverlay.classList.add("visible"),u.to(this.infoOverlay,{opacity:1,duration:.4,ease:"power2.out",onStart:()=>{this.infoOverlay.style.pointerEvents="all"}});const e=this.infoOverlay.querySelector(".overlay-content");u.fromTo(e,{opacity:0,y:30,scale:.95},{opacity:1,y:0,scale:1,duration:.6,delay:.1,ease:"back.out(1.7)"}),e.querySelectorAll("h3, p, button").forEach((i,o)=>{u.fromTo(i,{opacity:0,y:20},{opacity:1,y:0,duration:.5,delay:.3+o*.1,ease:"power2.out"})})}hideInfoOverlay(){if(!this.isInfoVisible)return;this.isInfoVisible=!1;const e=this.infoOverlay.querySelector(".overlay-content");u.to(e,{opacity:0,y:30,scale:.95,duration:.4,ease:"power3.in"}),u.to(this.infoOverlay,{opacity:0,duration:.5,delay:.2,ease:"power2.in",onComplete:()=>{this.infoOverlay.classList.remove("visible"),this.infoOverlay.style.pointerEvents="none"}})}showNotification(e,t="info",i=3e3){const o=document.createElement("div");o.classList.add("notification",`notification-${t}`);let s="",n="#2196F3";switch(t){case"success":s="✓",n="#4CAF50";break;case"warning":s="!",n="#FF9800";break;case"error":s="✗",n="#F44336";break;default:s="i",n="#2196F3"}o.innerHTML=`
            <div class="notification-icon" style="background-color: ${n};">${s}</div>
            <div class="notification-message">${e}</div>
        `,o.style.cssText=`
            display: flex;
        ...
        `;o.querySelector(".notification-icon").style.cssText=a,o.querySelector(".notification-message").style.cssText=`
            flex: 1;
            line-height: 1.4;
        `,this.notificationContainer.appendChild(o),u.fromTo(o,{opacity:0,x:50},{opacity:1,x:0,duration:.4,ease:"power2.out"}),setTimeout(()=>{u.to(o,{opacity:0,x:50,duration:.4,ease:"power2.in",onComplete:()=>{o.remove()}})},i)}setUIVisibility(e){const t=e?1:0,i=e?0:20,o=e?"auto":"none",s=document.getElementById("ui-controls");s&&u.to(s,{opacity:t,y:i,duration:.4,ease:e?"power2.out":"power2.in",onComplete:()=>{s.style.pointerEvents=o}}),document.querySelectorAll(".satellite-hud, .coordinates-display").forEach(a=>{u.to(a,{opacity:t,duration:.4,ease:e?"power2.out":"power2.in"})})}showTooltip(e,t,i={}){const s={...{position:"top",duration:3e3,offset:10,className:""},...i},n=document.createElement("div");n.className=`tooltip ${s.className}`,n.textContent=t,n.style.cssText=`
            position: absolute;
            background-color: rgba(0, 10, 30, 0.9);
            color: #ffffff;
            padding: 8px 12px;
        ...
        `,i.appendChild(o),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(r=>{const l=document.createElement("div");l.className="minimap-dot",l.dataset.id=r.id,l.title=r.name,l.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,l.addEventListener("mouseenter",()=>{u.to(l,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(l,r.name,{position:"top",duration:2e3})}),l.addEventListener("mouseleave",()=>{u.to(l,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),l.addEventListener("click",()=>{t&&t(r.id)}),i.appendChild(l)});const n=document.createElement("div");n.className="minimap-toggle",n.innerHTML="−",n.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
        ...
        `,this.drawerContent=document.createElement("div"),this.drawerContent.className="drawer-content",this.drawerContent.style.cssText=`
            ...
            grid-gap: 24px;
        `,this.drawer.appendChild(this.drawerContent),document.body.appendChild(this.drawer),this.drawerToggle.addEventListener("click",()=>{this.toggleDrawer()})}toggleDrawer(){this.isDrawerOpen?this.closeDrawer():this.openDrawer()}openDrawer(){if(this.isDrawerOpen||!this.drawer)return;this.isDrawerOpen=!0,this.drawer.style.display="block",u.to(this.drawer,{y:0,duration:.7,ease:"back.out(1.2)"});const e=this.drawerToggle.querySelector(".arrow");e&&(e.classList.remove("up"),e.classList.add("down")),this.drawerToggle&&u.to(this.drawerToggle,{bottom:"auto",top:-28,duration:.5}),this.panel&&u.to(this.panel,{scale:.95,opacity:.85,duration:.5,ease:"power2.out"})}closeDrawer(){if(!this.isDrawerOpen||!this.drawer)return;this.isDrawerOpen=!1,u.to(this.drawer,{y:"100%",duration:.5,ease:"power3.in",onComplete:()=>{this.drawer.style.display="none"}});const e=this.drawerToggle.querySelector(".arrow");e&&(e.classList.remove("down"),e.classList.add("up")),this.drawerToggle&&u.to(this.drawerToggle,{top:"auto",bottom:0,duration:.5}),this.panel&&u.to(this.panel,{scale:1,opacity:1,duration:.5,ease:"power2.out"})}update(e){if(!this.titleElement||!this.descriptionElement)return;this.titleElement.textContent=e.title||"Information";let t=e.description||"";if(e.coordinates&&(t=`
            ...
            `),this.descriptionElement.innerHTML=t,this.videoElement&&e.videoSrc){if(this.videoElement.style.display="block",this.videoElement.querySelector("source"))this.videoElement.querySelector("source").src=e.videoSrc;else{const i=document.createElement("source");i.src=e.videoSrc,i.type="video/mp4",this.videoElement.appendChild(i)}this.videoElement.load()}else this.videoElement&&(this.videoElement.style.display="none");if((e.detailedInfo||e.links)&&this.drawerContent){let i="";i+="<h3>INFORMATIONS COMPLÉMENTAIRES</h3>",e.detailedInfo&&(i+=`
                ...
                `),this.drawerContent.innerHTML=i,this.drawerToggle&&(this.drawerToggle.style.display="flex")}else this.drawerToggle&&(this.drawerToggle.style.display="none")}show(){if(this.isVisible||!this.panel)return;this.isVisible=!0,this.panel.classList.remove("hidden"),this.panel.classList.add("visible"),this.closeDrawer(),u.fromTo(this.panel,{x:"100%",opacity:0,scale:.95},{x:"0%",opacity:1,scale:1,duration:.7,ease:"back.out(1.2)"});const e=document.getElementById("main-container");e&&u.to(e.querySelectorAll(":not(#content-panel)"),{filter:"blur(2px)",opacity:.8,duration:.5,ease:"power2.out"})}hide(){if(!this.isVisible||!this.panel)return;this.isVisible=!1,this.isDrawerOpen&&this.closeDrawer(),u.to(this.panel,{x:"100%",opacity:0,scale:.95,duration:.5,ease:"power3.in",onComplete:()=>{this.panel.classList.remove("visible"),this.panel.classList.add("hidden"),this.videoElement&&this.videoElement.pause()}});const e=document.getElementById("main-container");e&&u.to(e.querySelectorAll(":not(#content-panel)"),{filter:"blur(0px)",opacity:1,duration:.5,ease:"power2.out"})}}const j=[{id:"grande-barriere",title:"Grande Barrière de Corail",position:{lat:-18.2871,lng:147.6992},description:`
        ...
        `;if(e.shaderSource(n,r),e.shaderSource(a,l),e.compileShader(n),e.compileShader(a),!e.getShaderParameter(n,e.COMPILE_STATUS)){const p=e.getShaderInfoLog(n);return console.error("❌ Erreur vertex shader test:",p),!1}if(!e.getShaderParameter(a,e.COMPILE_STATUS)){const p=e.getShaderInfoLog(a);return console.error("❌ Erreur fragment shader test:",p),!1}console.log("✅ Compilation des shaders réussie");const d=e.createProgram();if(e.attachShader(d,n),e.attachShader(d,a),e.linkProgram(d),!e.getProgramParameter(d,e.LINK_STATUS)){const p=e.getProgramInfoLog(d);return console.error("❌ Erreur linkage programme test:",p),!1}console.log("✅ Linkage du programme shader réussi"),e.deleteShader(n),e.deleteShader(a),e.deleteProgram(d)}catch(n){return console.error("❌ Erreur lors du test de compilation des shaders:",n),!1}const o=e.getParameter(e.MAX_TEXTURE_SIZE);o<2048&&console.warn("⚠️  Taille de texture limitée détectée:",o);const s=e.getParameter(e.MAX_VERTEX_ATTRIBS);return s<16&&console.warn("⚠️  Nombre d'attributs vertex limité:",s),console.log("🚀 WebGL compatible - Initialisation 3D possible"),!0}catch(c){return console.warn("⚠️ Erreur lors de la vérification WebGL:",c),!1}}function be(){console.log("🌊 Application Mondes Immergés en cours de chargement..."),fe()||console.warn("⚠️ WebGL détection échouée, mais on continue (Three.js gérera)");const e=document.createElement("style");e.textContent=`
    ...
    `,document.head.appendChild(e);const t=document.getElementById("welcome-screen");t&&(t.style.display="none",t.classList.add("hidden"));const i=document.getElementById("main-container");i&&(i.classList.add("hidden"),i.style.opacity="0");let o=0;const s=8,n=()=>{o++;const r=Math.round(o/s*100);console.log(`📦 Ressource ${o}/${s} chargée (${r}%)`);const l=document.querySelector(".progress-bar"),d=document.querySelector(".progress-text");l&&(l.style.width=`${r}%`),d&&(d.textContent=`${r}%`),o>=s&&(console.log("✅ Toutes les ressources chargées - Démarrage de l'application"),ye())};["Configuration système","Textures globe","Vidéos des zones","Données géographiques","Interfaces utilisateur","Modèles 3D","Données scientifiques","Effets visuels"].forEach((r,l)=>{const d=150+Math.random()*250;setTimeout(()=>{console.log(`📦 Ressource chargée: ${r}`),n()},d*(l+1))})}function ye(){console.log("🚀 Démarrage de l'application...");try{he();const c=ge();if(!c)throw new Error("Impossible de récupérer l'instance de l'application");console.log("✅ Application initialisée avec succès"),setTimeout(()=>{ve(c)},300)}catch(c){console.error("❌ Erreur lors de l'initialisation de l'application:",c),xe(c)}}function xe(c){const e=document.createElement("div");e.style.cssText=`
        position: fixed;
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
    ...
    `,document.body.appendChild(e)}function ve(c){console.log("🎬 Démarrage de la séquence d'initialisation...");const e=document.getElementById("loading-screen");e?(e.style.opacity="0",e.style.transform="scale(1.1)",setTimeout(()=>{e.classList.add("hidden");const t=document.getElementById("main-container");t&&(t.classList.remove("hidden"),t.style.opacity="1"),console.log("🎭 Conteneur principal rendu visible"),c.startupSequence&&typeof c.startupSequence=="function"?(console.log("🚀 Lancement de la séquence de démarrage..."),c.startupSequence(),setTimeout(()=>{console.log("🌊 Démarrage de l'exploration..."),c.startExploration(!0)},5e3)):(console.log("⚠️  Méthode startupSequence non trouvée, démarrage direct"),c.startExploration(!0))},500)):(console.log("⚠️  Écran de chargement non trouvé, démarrage direct"),c.startExploration(!0))}function we(){const c=document.getElementById("loading-screen");if(!c){console.warn("⚠️  Écran de chargement non trouvé");return}if(c.querySelector(".progress-container")){console.log("🔄 Écran de chargement déjà amélioré");return}console.log("✨ Amélioration de l'écran de chargement...");const e=c.querySelector(".spinner");e&&e.remove();try{V.register();const s=document.createElement("l-jelly");s.setAttribute("size","120"),s.setAttribute("speed","0.9"),s.setAttribute("color","#ffcc00"),s.style.cssText=`
            margin-bottom: 30px;
            ...
            opacity: 1 !important;
        `;const n=c.querySelector("p");n?c.insertBefore(s,n):c.appendChild(s),console.log("✅ Spinner Jelly ajouté avec succès")}catch(s){console.warn("⚠️  Impossible de charger le spinner Jelly, utilisation du spinner CSS par défaut"),console.error("Détails de l'erreur Jelly:",s);const n=document.createElement("div");n.className="spinner";const a=c.querySelector("p");a?c.insertBefore(n,a):c.appendChild(n)}const t=document.createElement("div");t.className="progress-container";const i=document.createElement("div");i.className="progress-bar";const o=document.createElement("div");o.className="progress-text",o.textContent="0%",t.appendChild(i),t.appendChild(o),c.appendChild(t),console.log("📊 Barre de progression ajoutée")}function Ee(){console.log("🖱️  Initialisation curseur personnalisé...");const c=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!c||!e){console.log("⚠️  Éléments curseur non trouvés");return}let t=0,i=0,o=0,s=0,n=0,a=0;document.addEventListener("mousemove",d=>{t=d.clientX,i=d.clientY});function r(){o=t,s=i,c.style.left=o+"px",c.style.top=s+"px",n+=(t-n)*.1,a+=(i-a)*.1,e.style.left=n+"px",e.style.top=a+"px",requestAnimationFrame(r)}document.querySelectorAll("button, a, [data-interactive]").forEach(d=>{d.addEventListener("mouseenter",()=>{c.classList.add("hover"),e.classList.add("hover")}),d.addEventListener("mouseleave",()=>{c.classList.remove("hover"),e.classList.remove("hover")})}),r(),console.log("✅ Curseur personnalisé initialisé avec succès")}document.addEventListener("DOMContentLoaded",()=>{console.log("📄 DOM chargé - Initialisation de l'application"),we(),Ee(),setTimeout(()=>{console.log("⏰ Début de l'initialisation principale..."),be()},100)});window.addEventListener("error",c=>{console.error("❌ Erreur globale capturée:",c.error),console.error("  - Message:",c.message),console.error("  - Fichier:",c.filename),console.error("  - Ligne:",c.lineno),console.error("  - Colonne:",c.colno)});window.addEventListener("unhandledrejection",c=>{console.error("❌ Promesse rejetée non gérée:",c.reason),c.preventDefault()});window.addEventListener("error",c=>{c.target!==window&&console.error("❌ Erreur de ressource:",c.target.src||c.target.href)},!0);
