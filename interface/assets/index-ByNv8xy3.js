import{R as T,V as j,C as G,a as v,S as F,A as P,D as I,F as L,P as U,W,b as Y,c as q,L as M,d as k,e as A,H as X,T as S,f as x,M as w,g as y,h as _,B as Z,i as D,j as z,k as B,l as H,m as K,n as J,o as O,p as Q,q as ee}from"./three-Bmxrupip.js";import{g as l}from"./gsap-xHO-obUW.js";import{i as te}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const oe={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ie="/nationalgeographic.fr-mondesimmerges/accueil/";function se(a){return oe[a]||ie}class ne{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new T,this.mouse=new j,this.clock=new G,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new v(100,20,100),moonPosition:new v(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new F;const e=new P(16777215,1.2);this.scene.add(e);const t=new I(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new L(0,15e-5),this.camera=new U(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new W({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Y;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}addLogo(){const e=document.createElement("div");e.style.cssText=`
            position: absolute;
            top: 20px;
            left: 50%;
            transform: translateX(-50%);
            z-index: 100;
        `;const t=document.createElement("img");t.src="/nationalgeographic.fr-mondesimmerges/interface/images/nat-geo-logo.png",t.alt="National Geographic",t.style.cssText=`
            height: 40px;
            width: auto;
            filter: drop-shadow(0 0 5px rgba(0, 0, 0, 0.5));
        `,e.appendChild(t),this.container.appendChild(e)}setupLighting(){const e=new P(4210768,.5);this.scene.add(e);const t=new I(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new X(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new S,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new x(3,32,32),o=new w({map:t,transparent:!0,opacity:.95}),n=new y(i,o);n.position.copy(this.celestialParams.sunPosition),this.scene.add(n);const s=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),r=new x(1.5,32,32),c=new _({map:s}),d=new y(r,c);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=n,this.moon=d}createOrbitPath(){const e=[];for(let n=0;n<=100;n++){const s=n/100*Math.PI*2,r=this.orbitParams.ellipseMajorAxis,c=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=r*Math.cos(s),p=c*Math.sin(s);const h=p*Math.sin(d);p=p*Math.cos(d),e.push(new v(u,h,p))}new Z().setFromPoints(e);const i=new x(.2,16,16),o=new w({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new y(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(d=>{console.error("Impossible de relancer la vidéo:",d)}))},1e3),this.videoTexture=new q(e),this.videoTexture.minFilter=M,this.videoTexture.magFilter=M,this.videoTexture.format=k,this.videoTexture.colorSpace=A;const t=new x(1.99,64,64),i=new w({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:D}),o=new y(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const n=new x(2,64,64),s=new w({map:this.videoTexture,transparent:!0,opacity:1,side:D,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new y(n,s),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const r=new x(2.02,64,64),c=new w({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new y(r,c),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(d=>{console.error("Erreur lors de la lecture de la vidéo:",d),this.handleVideoError()})}createAtmosphere(){const e=new x(2.08,64,64),t=new z({vertexShader:`
            ...
            `,uniforms:{cameraPosition:{value:new v}},blending:H,side:B,transparent:!0}),i=new y(e,t);this.scene.add(i),this.atmosphere=i,this.updateAtmosphereUniforms=()=>{this.atmosphere&&this.atmosphere.material.uniforms&&this.atmosphere.material.uniforms.cameraPosition.value.copy(this.camera.position)}}createSkybox(){new S().load("/nationalgeographic.fr-mondesimmerges/interface/images/night-sky.png",i=>{this.renderer.toneMapping=K,this.renderer.toneMappingExposure=.3;const o=new J(i.image.height);o.fromEquirectangularTexture(this.renderer,i),this.scene.background=o.texture,this.scene.fog=new L(17,8e-5)},void 0,i=>{console.error("Erreur lors du chargement de la texture du ciel:",i),this.scene.background=new O(17)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const n=this.orbitParams.inclination,s=o*Math.sin(n);o=o*Math.cos(n),this.camera.position.set(i,s,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,s,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new v(i,s,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const n=this.orbitParams.inclination,s=o*Math.sin(n);o=o*Math.cos(n),this.camera.position.set(i,s,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{if(this.scene.remove(t),t.userData.label&&t.userData.labelHandlers){const{onMouseEnter:i,onMouseLeave:o,onClick:n}=t.userData.labelHandlers;t.userData.label.removeEventListener("mouseenter",i),t.userData.label.removeEventListener("mouseleave",o),t.userData.label.removeEventListener("click",n)}t.userData.label&&t.userData.label.parentNode&&t.userData.label.parentNode.removeChild(t.userData.label),t.userData.connectorSvg&&t.userData.connectorSvg.parentNode&&t.userData.connectorSvg.parentNode.removeChild(t.userData.connectorSvg),t.userData.labelContainer&&t.userData.labelContainer.parentNode&&t.userData.labelContainer.parentNode.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],document.querySelectorAll(".hotspot-label").forEach(t=>t.remove()),document.querySelectorAll(".hotspot-label-container").forEach(t=>t.remove()),document.querySelectorAll(".connector-line").forEach(t=>t.remove()),e.forEach(t=>{const{position:i,title:o}=t,n=i.lat*(Math.PI/180),s=i.lng*(Math.PI/180),r=2.1,c=r*Math.cos(n)*Math.cos(s),d=r*Math.sin(n),u=r*Math.cos(n)*Math.sin(s);console.log(`Hotspot ${o}: GPS(${i.lat}, ${i.lng}) -> 3D(${c.toFixed(2)}, ${d.toFixed(2)}, ${u.toFixed(2)})`);const p=new x(.05,16,16),h=new w({color:16763904,transparent:!0,opacity:.8}),m=new y(p,h);m.position.set(c,d,u),m.userData={hotspot:t};const f=new x(.08,16,16),b=new w({color:16763904,transparent:!0,opacity:.5,side:B}),E=new y(f,b);m.add(E),this.addHotspotLabel(m,o,new v(c,d,u)),this.scene.add(m),this.hotspotObjects.push(m)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label",o.textContent=t,o.style.cssText=`
            position: fixed;
        ...
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","svg");n.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
            ...
            z-index: 999;
            opacity: 0;
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","line");s.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),s.setAttribute("stroke-width","1.5"),s.setAttribute("stroke-dasharray","4, 4"),n.appendChild(s),document.body.appendChild(o),document.body.appendChild(n);const r=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},c=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffcc00",o.style.transform="scale(1)"},d=u=>{u.stopPropagation();const p=e.userData.hotspot;p&&(console.log(`Label cliqué: ${p.title}`),this.activateHotspot(p))};o.addEventListener("mouseenter",r),o.addEventListener("mouseleave",c),o.addEventListener("click",d),e.userData.label=o,e.userData.connectorSvg=n,e.userData.connectorLine=s,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:r,onMouseLeave:c,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),r=Math.atan2(o.z,o.x),c=90-s*180/Math.PI,d=r*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${c.toFixed(2)}, lng: ${d.toFixed(2)}`);const u=this._findNearestHotspot(c,d,10);if(u){console.log(`Hotspot trouvé: ${u.title}`),this.activateHotspot(u);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(r=>r.userData.hotspot).filter(Boolean);for(const r of s){const c=r.position.lat,d=r.position.lng,u=Math.sqrt(Math.pow(c-e,2)+Math.pow(d-t,2));u<n&&(n=u,o=r)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),r=o*Math.cos(t)*Math.sin(i),c=new v(n,s,r);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const p=c.clone().normalize().multiplyScalar(3.5);l.to(this.camera.position,{x:p.x,y:p.y,z:p.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),l.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
           ...
           z-index: 9999;
           pointer-events: none;
       `,document.body.appendChild(t),l.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=se(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),r=new Q(0,.3,32),c=new z({uniforms:{color:{value:new O(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `;for(let u=0;u<3;u++){const p=document.createElement("div");p.style.cssText=`
            ...
            `;for(let h=0;h<3+u;h++){const m=document.createElement("div"),f=360/(3+u)*h;m.style.cssText=`
                    position: absolute;
                    width: ${8-u}px;
                    height: ${8-u}px;
                ...
                `,p.appendChild(m)}n.appendChild(p)}const s=document.createElement("div");s.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,n.appendChild(s);const r=document.createElement("div");r.className="orbital-loading-text",r.style.cssText=`
            position: absolute;
            bottom: -60px;
            left: 50%;
            transform: translateX(-50%);
        ...
        `,n.appendChild(r),o.appendChild(n);const c=document.createElement("style");c.textContent=`
            @keyframes orbit0 {
        ...
        `,document.head.appendChild(c),(i||this.effectsContainer).appendChild(o),l.fromTo(o,{opacity:0},{opacity:1,duration:.5,onComplete:()=>{i&&e&&(console.log("🎨 Orbital loader visible, début transition fond noir"),e())}}),setTimeout(()=>{i?(o.remove(),c.remove(),console.log("✅ Orbital loader supprimé instantanément")):l.to(o,{opacity:0,duration:1,onComplete:()=>{o.remove(),c.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),l.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{l.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const o={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let n=0;n<o.pulseCount;n++)setTimeout(()=>{const s=document.createElement("div");s.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
                    ...
                    z-index: 100;
                    pointer-events: none;
                `,this.effectsContainer.appendChild(s),l.to(s,{width:o.radius*2,height:o.radius*2,opacity:0,duration:o.duration,ease:"power2.out",onComplete:()=>{s.remove()}})},n*(o.duration*300))}flashScreen(e="#ffffff"){const t=document.createElement("div");t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor=e,t.style.pointerEvents="none",t.style.zIndex="20",t.style.opacity="0",this.effectsContainer.appendChild(t),l.timeline().to(t,{opacity:.7,duration:.1}).to(t,{opacity:0,duration:.3,onComplete:()=>{t.remove()}})}showNotification(e,t="info",i=3e3){this.notificationContainer||this.createNotificationContainer();const o=document.createElement("div");o.className="notification";let n="",s="#2196F3";switch(t){case"success":n="✓",s="#4CAF50";break;case"warning":n="!",s="#FF9800";break;case"error":n="✗",s="#F44336";break;default:n="i",s="#2196F3"}o.innerHTML=`
        ...
        `,o.style.cssText=`
            ...
            backdrop-filter: blur(5px);
        `;const r=o.querySelector(".notification-icon");r&&(r.style.cssText=`
                display: flex;
                align-items: center;
                justify-content: center;
                width: 24px;
        ...
        `,this.effectsContainer.appendChild(t),l.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),r=Math.random()*3+1,c=Math.random()*100,d=Math.random()*100,u=Math.random()*5,p=Math.random()*10+10,h=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${r}px;
                height: ${r}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
            ...
            `,o.addEventListener("mouseenter",()=>{l.to(o,{backgroundColor:"rgba(255, 204, 0, 0.9)",color:"#000000",borderColor:"#ffcc00",boxShadow:"0 2px 15px rgba(255, 204, 0, 0.5), 0 0 8px rgba(255, 204, 0, 0.7)",duration:.25})}),o.addEventListener("mouseleave",()=>{l.to(o,{backgroundColor:"rgba(0, 10, 30, 0.7)",color:"#ffcc00",borderColor:"rgba(255, 204, 0, 0.7)",boxShadow:"0 2px 10px rgba(0, 0, 0, 0.3), 0 0 4px rgba(255, 204, 0, 0.4)",duration:.3})})}),this.infoBtn&&(this.infoBtn.style.cssText=`
                width: 50px;
                height: 50px;
                border-radius: 50%;
            ...
            `;const o=this.infoOverlay.querySelector(".overlay-content");if(o){o.style.cssText=`
                ...
                `;const n=o.querySelector("h3");if(n&&(n.style.cssText=`
                    ...
                    `),o.querySelectorAll("p").forEach(r=>{r.style.cssText=`
                        margin-bottom: 25px;
                        line-height: 1.8;
                        color: #e0e0e0;
                        font-size: 1.1rem;
                    ...
                    `,document.head.appendChild(r)}}}}createNotificationContainer(){this.notificationContainer=document.createElement("div"),this.notificationContainer.className="notifications-container",this.notificationContainer.style.cssText=`
            position: absolute;
            bottom: 30px;
            right: 30px;
            display: flex;
        ...
        `;const r=`
            ...
            font-weight: bold;
            flex-shrink: 0;
        `;o.querySelector(".notification-icon").style.cssText=r,o.querySelector(".notification-message").style.cssText=`
            flex: 1;
            line-height: 1.4;
        `,this.notificationContainer.appendChild(o),l.fromTo(o,{opacity:0,x:50},{opacity:1,x:0,duration:.4,ease:"power2.out"}),setTimeout(()=>{l.to(o,{opacity:0,x:50,duration:.4,ease:"power2.in",onComplete:()=>{o.remove()}})},i)}setUIVisibility(e){const t=e?1:0,i=e?0:20,o=e?"auto":"none",n=document.getElementById("ui-controls");n&&l.to(n,{opacity:t,y:i,duration:.4,ease:e?"power2.out":"power2.in",onComplete:()=>{n.style.pointerEvents=o}}),document.querySelectorAll(".satellite-hud, .coordinates-display").forEach(r=>{l.to(r,{opacity:t,duration:.4,ease:e?"power2.out":"power2.in"})})}showTooltip(e,t,i={}){const n={...{position:"top",duration:3e3,offset:10,className:""},...i},s=document.createElement("div");s.className=`tooltip ${n.className}`,s.textContent=t,s.style.cssText=`
            position: absolute;
            background-color: rgba(0, 10, 30, 0.9);
            color: #ffffff;
            padding: 8px 12px;
        ...
        `,document.body.appendChild(s);const r=e.getBoundingClientRect();switch(n.position){case"top":s.style.bottom=`${window.innerHeight-r.top+n.offset}px`,s.style.left=`${r.left+r.width/2}px`,s.style.transform="translateX(-50%) scale(0.9)";break;case"bottom":s.style.top=`${r.bottom+n.offset}px`,s.style.left=`${r.left+r.width/2}px`,s.style.transform="translateX(-50%) scale(0.9)";break;case"left":s.style.top=`${r.top+r.height/2}px`,s.style.right=`${window.innerWidth-r.left+n.offset}px`,s.style.transform="translateY(-50%) scale(0.9)";break;case"right":s.style.top=`${r.top+r.height/2}px`,s.style.left=`${r.right+n.offset}px`,s.style.transform="translateY(-50%) scale(0.9)";break}return l.to(s,{opacity:1,scale:1,duration:.3,ease:"back.out(1.7)"}),setTimeout(()=>{l.to(s,{opacity:0,scale:.9,duration:.2,ease:"power2.in",onComplete:()=>{s.remove()}})},n.duration),{hide:()=>{l.to(s,{opacity:0,scale:.9,duration:.2,ease:"power2.in",onComplete:()=>{s.remove()}})}}}createMinimap(e,t){const i=document.createElement("div");i.className="minimap",i.style.cssText=`
            position: absolute;
            bottom: 30px;
            right: 30px;
            width: 200px;
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${n}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.visualEffects&&this.visualEffects.showNotification("Retour à l'exploration globale","info",3e3),this.currentHotspot=null}}const V=new ue;function pe(){V.init()}function me(){return V}const g={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function he(){if(g.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const a=document.createElement("canvas"),e=a.getContext("webgl")||a.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),fe(),g.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),g.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(a){return console.error("❌ Erreur vérification WebGL:",a),!1}}function fe(){const a=document.getElementById("loading-screen");a&&(a.innerHTML=`
        ...
        `)}function ge(){const a=document.getElementById("loading-screen");if(!a)return;const e=a.querySelector(".spinner");e&&e.remove();try{te.register();const t=document.createElement("l-jelly");t.setAttribute("size","60"),t.setAttribute("speed","0.9"),t.setAttribute("color","#ffcc00"),a.insertBefore(t,a.firstChild),console.log("✅ Spinner initialisé")}catch(t){console.warn("⚠️  Fallback spinner CSS");const i=document.createElement("div");i.className="spinner",a.insertBefore(i,a.firstChild)}}function be(){const a=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!a||!e)return;let t=0,i=0,o=0,n=0,s=null;const r=d=>{t=d.clientX,i=d.clientY};document.addEventListener("mousemove",r,{passive:!0});function c(){a.style.left=t+"px",a.style.top=i+"px",o+=(t-o)*.1,n+=(i-n)*.1,e.style.left=o+"px",e.style.top=n+"px",s=requestAnimationFrame(c)}s=requestAnimationFrame(c),window.addEventListener("beforeunload",()=>{s&&cancelAnimationFrame(s),document.removeEventListener("mousemove",r)}),console.log("✅ Curseur initialisé")}async function ye(){if(g.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),g.appStarted=!0;try{pe();const a=me();if(!a)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),xe(),ve(),setTimeout(()=>{a.startupSequence&&typeof a.startupSequence=="function"?(console.log("🎬 Séquence de démarrage..."),a.startupSequence(()=>{N(),setTimeout(()=>{console.log("🌊 Démarrage exploration..."),a.startExploration(!0),setTimeout(()=>{$()},250)},4e3)})):(console.log("🌊 Démarrage direct..."),N(),setTimeout(()=>{a.startExploration(!0),setTimeout(()=>{$()},250)},4e3))},300)}catch(a){console.error("❌ Erreur application:",a),we()}}function xe(){const a=document.getElementById("loading-screen");if(!a)return;const e=a.querySelector("l-jelly"),t=a.querySelector(".spinner");e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),t&&(t.style.transition="opacity 0.3s ease",t.style.opacity="0",setTimeout(()=>t.remove(),300)),console.log("✅ Spinner caché, fond noir conservé")}function ve(){const a=document.getElementById("main-container");if(!a)return;a.classList.remove("hidden"),a.style.opacity="0",a.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(n=>{n.style.opacity="0"}),i&&(i.style.opacity="0"),o&&(o.style.opacity="0"),console.log("✅ Interface initialisée en mode clear")}function $(){const a=document.getElementById("ui-controls"),e=document.querySelectorAll(".satellite-hud, .coordinates-display"),t=document.querySelector(".satellite-crosshair"),i=document.querySelectorAll(".hotspot-label"),o=document.querySelectorAll("svg"),n=document.querySelector(".scanner-effect");console.log("✨ Apparition des éléments UI + hotspots + connector lines"),a&&(a.style.pointerEvents="auto"),window.gsap?(a&&gsap.to(a,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...e,t,n].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...i,...o],{opacity:1,duration:.8,ease:"power2.out"})):(a&&(a.style.transition="all 0.8s ease",a.style.opacity="1",a.style.transform="translateY(0)"),e.forEach(s=>{s.style.transition="opacity 0.8s ease",s.style.opacity="1"}),t&&(t.style.transition="opacity 0.8s ease",t.style.opacity="1"),n&&(n.style.transition="opacity 0.8s ease",n.style.opacity="1"),i.forEach(s=>{s.style.transition="opacity 0.8s ease",s.style.opacity="1"}),o.forEach(s=>{s.style.transition="opacity 0.8s ease",s.style.opacity="1"}))}function N(){const a=document.getElementById("loading-screen"),e=document.getElementById("main-container");a&&(console.log("🌑 Début transition fond noir (100% → 0% sur 4s)"),console.log("🌍 Interface (globe) visible immédiatement derrière le fond noir"),e&&(e.style.opacity="1"),a.style.transition="opacity 4s cubic-bezier(0.19, 1, 0.22, 1)",a.style.opacity="0",setTimeout(()=>{a.style.display="none",a.classList.add("hidden"),console.log("✅ Écran de chargement complètement masqué")},4e3))}function we(a){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function Ee(){const a=document.getElementById("welcome-screen");a&&(a.style.display="none",a.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Me(){if(g.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),g.initialized=!0,!he())return;Ee(),ge();let a=0;const e=setInterval(()=>{a+=12.5,a>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{ye()},300))},200)}function Ce(){g.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),g.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(g.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),g.domReady=!0,be(),setTimeout(()=>{Me()},100)});window.addEventListener("error",a=>{if(a.target!==window&&(a.target.tagName==="IMG"||a.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",a.target.src||a.target.href);return}console.error("❌ Erreur:",a.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",a=>{console.error("❌ Promesse rejetée:",a.reason),a.preventDefault()},{once:!1});window.addEventListener("beforeunload",Ce,{once:!0});
