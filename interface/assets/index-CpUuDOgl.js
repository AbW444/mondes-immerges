import{R as A,V as J,C as Q,a as y,S as ee,A as D,D as z,F as B,P as te,W as oe,b as ie,c as H,L as I,d as O,e as $,H as se,T as q,f as w,M as P,g as x,h as ne,B as ae,i as N,j as R,k as re,l as V,m as le,n as ce,o as j,p as G,q as F,r as W,s as de,t as ue}from"./three-Cp_d4H1g.js";import{g as l}from"./gsap-xHO-obUW.js";import{i as pe}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const me={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},he="/nationalgeographic.fr-mondesimmerges/accueil/";function ge(r){return me[r]||he}class fe{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new A,this.mouse=new J,this.clock=new Q,this.labelsVisible=!1,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:.7,minZoomLevel:.5,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new y(100,20,100),moonPosition:new y(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new ee;const e=new D(16777215,1.2);this.scene.add(e);const t=new z(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new B(0,15e-5),this.camera=new te(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new oe({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=ie;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}setupLighting(){const e=new D(4210768,.5);this.scene.add(e);const t=new z(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new se(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new q,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new w(3,32,32),o=new P({map:t,transparent:!0,opacity:.95}),s=new x(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new w(1.5,32,32),d=new ne({map:n}),c=new x(a,d);c.position.copy(this.celestialParams.moonPosition),this.scene.add(c),this.sun=s,this.moon=c}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,d=this.orbitParams.ellipseMinorAxis,c=this.orbitParams.inclination;let p=a*Math.cos(n),m=d*Math.sin(n);const u=m*Math.sin(c);m=m*Math.cos(c),e.push(new y(p,u,m))}new ae().setFromPoints(e);const i=new w(.2,16,16),o=new P({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(c=>{console.error("Impossible de relancer la vidéo:",c)}))},1e3),this.videoTexture=new H(e),this.videoTexture.minFilter=I,this.videoTexture.magFilter=I,this.videoTexture.format=O,this.videoTexture.colorSpace=$;const t=new w(1.99,64,64),i=new P({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:N}),o=new x(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const s=new w(2,64,64),n=new P({map:this.videoTexture,transparent:!0,opacity:1,side:N,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(s,n),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const a=new w(2.02,64,64),d=new P({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(a,d),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(c=>{console.error("Erreur lors de la lecture de la vidéo:",c),this.handleVideoError()})}createAtmosphere(){const e=new w(2.15,64,64),t=new R({vertexShader:`
            ...
            `,uniforms:{cameraPosition:{value:new y}},blending:V,side:re,transparent:!0}),i=new x(e,t);this.scene.add(i),this.atmosphere=i,this.updateAtmosphereUniforms=()=>{this.atmosphere&&this.atmosphere.material.uniforms&&this.atmosphere.material.uniforms.cameraPosition.value.copy(this.camera.position)}}createSkybox(){new q().load("/nationalgeographic.fr-mondesimmerges/interface/images/night-sky.png",i=>{this.renderer.toneMapping=le,this.renderer.toneMappingExposure=.3;const o=new ce(i.image.height);o.fromEquirectangularTexture(this.renderer,i),this.scene.background=o.texture,this.scene.fog=new B(17,8e-5)},void 0,i=>{console.error("Erreur lors du chargement de la texture du ciel:",i),this.scene.background=new j(17)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,n,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new y(i,n,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{if(this.scene.remove(t),t.userData.label&&t.userData.labelHandlers){const{onMouseEnter:i,onMouseLeave:o,onClick:s}=t.userData.labelHandlers;t.userData.label.removeEventListener("mouseenter",i),t.userData.label.removeEventListener("mouseleave",o),t.userData.label.removeEventListener("click",s)}t.userData.label&&t.userData.label.parentNode&&t.userData.label.parentNode.removeChild(t.userData.label),t.userData.connectorSvg&&t.userData.connectorSvg.parentNode&&t.userData.connectorSvg.parentNode.removeChild(t.userData.connectorSvg),t.userData.labelContainer&&t.userData.labelContainer.parentNode&&t.userData.labelContainer.parentNode.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],document.querySelectorAll(".hotspot-label").forEach(t=>t.remove()),document.querySelectorAll(".hotspot-label-container").forEach(t=>t.remove()),document.querySelectorAll(".connector-line").forEach(t=>t.remove()),e.forEach(t=>{const{position:i,title:o}=t,s=i.lat*(Math.PI/180),n=i.lng*(Math.PI/180),a=2.1,d=a*Math.cos(s)*Math.cos(n),c=a*Math.sin(s),p=a*Math.cos(s)*Math.sin(n);console.log(`Hotspot ${o}: GPS(${i.lat}, ${i.lng}) -> 3D(${d.toFixed(2)}, ${c.toFixed(2)}, ${p.toFixed(2)})`);const m=document.createElement("canvas");m.width=256,m.height=256;const u=m.getContext("2d"),h=m.width/2,g=m.height/2,f=u.createRadialGradient(h,g,0,h,g,20);f.addColorStop(0,"rgba(255, 204, 0, 1)"),f.addColorStop(1,"rgba(255, 204, 0, 0.9)"),u.fillStyle=f,u.beginPath(),u.arc(h,g,20,0,Math.PI*2),u.fill(),u.strokeStyle="rgba(255, 204, 0, 0.7)",u.lineWidth=6,u.beginPath(),u.arc(h,g,40,0,Math.PI*2),u.stroke(),u.strokeStyle="rgba(255, 204, 0, 0.4)",u.lineWidth=4,u.beginPath(),u.arc(h,g,65,0,Math.PI*2),u.stroke();const E=new G(m),C=new F({map:E,transparent:!0,depthTest:!0,depthWrite:!1,sizeAttenuation:!0}),v=new W(C);v.position.set(d,c,p),v.scale.set(.35,.35,1),v.userData={hotspot:t};const k=[];for(let L=0;L<3;L++){const T=document.createElement("canvas");T.width=256,T.height=256;const S=T.getContext("2d");S.strokeStyle="rgba(255, 204, 0, 0.8)",S.lineWidth=8,S.beginPath(),S.arc(128,128,40,0,Math.PI*2),S.stroke();const Z=new G(T),K=new F({map:Z,transparent:!0,opacity:0,depthTest:!0,depthWrite:!1}),M=new W(K);M.position.set(d,c,p),M.scale.set(.1,.1,1),M.userData.initialDelay=L*.8,M.userData.waveTime=0,this.scene.add(M),k.push(M)}v.userData.waveRings=k,this.addHotspotLabel(v,o,new y(d,c,p)),this.scene.add(v),this.hotspotObjects.push(v)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label",o.textContent=t,o.style.cssText=`
            position: fixed;
        ...
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.style.cssText=`
            ...
            z-index: 999;
            opacity: 0;
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(o),document.body.appendChild(s);const a=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},d=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffcc00",o.style.transform="scale(1)"},c=p=>{p.stopPropagation();const m=e.userData.hotspot;m&&(console.log(`Label cliqué: ${m.title}`),this.activateHotspot(m))};o.addEventListener("mouseenter",a),o.addEventListener("mouseleave",d),o.addEventListener("click",c),e.userData.label=o,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:d,onClick:c},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,n=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),d=90-n*180/Math.PI,c=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${d.toFixed(2)}, lng: ${c.toFixed(2)}`);const p=this._findNearestHotspot(d,c,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,s=i;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const d=a.position.lat,c=a.position.lng,p=Math.sqrt(Math.pow(d-e,2)+Math.pow(c-t,2));p<s&&(s=p,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,s=o*Math.cos(t)*Math.cos(i),n=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),d=new y(s,n,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const c=this.camera.position.clone(),u=d.clone().normalize().multiplyScalar(3.5),h=new y().addVectors(c,u).multiplyScalar(.5);h.normalize().multiplyScalar(h.length()+1.8);const f=l.timeline();f.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}}),f.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),f.to(this.camera,{fov:40,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
           ...
           z-index: 9999;
           pointer-events: none;
       `,document.body.appendChild(t),l.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=ge(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(i),a=new de(0,.3,32),d=new R({uniforms:{color:{value:new j(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,this.container.appendChild(this.notificationContainer)}transitionIn(){const e=document.createElement("div");e.classList.add("transition-overlay"),e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.backgroundColor="#000000",e.style.zIndex="10",this.effectsContainer.appendChild(e),l.fromTo(e,{opacity:1},{opacity:0,duration:1.5,ease:"power2.out",onComplete:()=>{e.remove()}})}transitionOut(e){const t=document.createElement("div");t.classList.add("transition-overlay"),t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor="#000000",t.style.zIndex="10",t.style.opacity="0",this.effectsContainer.appendChild(t),l.to(t,{opacity:1,duration:1,ease:"power2.in",onComplete:()=>{e&&e()}})}createOrbitalLoaderEffect(e,t=4,i=null){const o=document.createElement("div");o.className="orbital-loader",i?o.style.cssText=`
            ...
            justify-content: center;
            align-items: center;
        `;for(let p=0;p<3;p++){const m=document.createElement("div");m.style.cssText=`
                position: absolute;
                border-radius: 50%;
                border: 2px solid rgba(255, 204, 0, ${.7-p*.2});
                width: ${120+p*40}px;
                height: ${120+p*40}px;
                animation: orbit${p} ${4-p*.5}s linear infinite;
            `;for(let u=0;u<3+p;u++){const h=document.createElement("div"),g=360/(3+p)*u;h.style.cssText=`
                    position: absolute;
                    width: ${8-p}px;
                    height: ${8-p}px;
                    ...
                    transform: translate(-50%, -50%) rotate(${g}deg) translateX(${60+p*20}px);
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `;o.querySelector(".notification-icon").style.cssText=a,o.querySelector(".notification-message").style.cssText=`
            flex: 1;
            line-height: 1.4;
        `,this.notificationContainer.appendChild(o),l.fromTo(o,{opacity:0,x:50},{opacity:1,x:0,duration:.4,ease:"power2.out"}),setTimeout(()=>{l.to(o,{opacity:0,x:50,duration:.4,ease:"power2.in",onComplete:()=>{o.remove()}})},i)}setUIVisibility(e){const t=e?1:0,i=e?0:20,o=e?"auto":"none",s=document.getElementById("ui-controls");s&&l.to(s,{opacity:t,y:i,duration:.4,ease:e?"power2.out":"power2.in",onComplete:()=>{s.style.pointerEvents=o}}),document.querySelectorAll(".satellite-hud, .coordinates-display").forEach(a=>{l.to(a,{opacity:t,duration:.4,ease:e?"power2.out":"power2.in"})})}showTooltip(e,t,i={}){const s={...{position:"top",duration:3e3,offset:10,className:""},...i},n=document.createElement("div");n.className=`tooltip ${s.className}`,n.textContent=t,n.style.cssText=`
            position: absolute;
            background-color: rgba(0, 10, 30, 0.9);
            color: #ffffff;
            padding: 8px 12px;
        ...
        `,i.appendChild(o),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(d=>{const c=document.createElement("div");c.className="minimap-dot",c.dataset.id=d.id,c.title=d.name,c.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,c.addEventListener("mouseenter",()=>{l.to(c,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(c,d.name,{position:"top",duration:2e3})}),c.addEventListener("mouseleave",()=>{l.to(c,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),c.addEventListener("click",()=>{t&&t(d.id)}),i.appendChild(c)});const n=document.createElement("div");n.className="minimap-toggle",n.innerHTML="−",n.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const _=new Ee;function Me(){_.init()}function Ce(){return _}const b={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function Se(){if(b.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),Pe(),b.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),b.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return console.error("❌ Erreur vérification WebGL:",r),!1}}function Pe(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
        ...
        `)}function Te(){const r=document.getElementById("loading-screen");if(!r)return;const e=r.querySelector(".spinner");e&&e.remove();try{pe.register();const t=document.createElement("l-jelly");t.setAttribute("size","60"),t.setAttribute("speed","0.9"),t.setAttribute("color","#ffcc00"),r.insertBefore(t,r.firstChild),console.log("✅ Spinner initialisé")}catch(t){console.warn("⚠️  Fallback spinner CSS");const i=document.createElement("div");i.className="spinner",r.insertBefore(i,r.firstChild)}}function Ie(){const r=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!r||!e)return;let t=0,i=0,o=0,s=0,n=null;const a=c=>{t=c.clientX,i=c.clientY};document.addEventListener("mousemove",a,{passive:!0});function d(){r.style.left=t+"px",r.style.top=i+"px",o+=(t-o)*.1,s+=(i-s)*.1,e.style.left=o+"px",e.style.top=s+"px",n=requestAnimationFrame(d)}n=requestAnimationFrame(d),window.addEventListener("beforeunload",()=>{n&&cancelAnimationFrame(n),document.removeEventListener("mousemove",a)}),console.log("✅ Curseur initialisé")}async function Le(){if(b.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),b.appStarted=!0;try{Me();const r=Ce();if(!r)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),qe(),ke(),setTimeout(()=>{r.startupSequence&&typeof r.startupSequence=="function"?(console.log("🎬 Séquence de démarrage..."),r.startupSequence(()=>{Y(),setTimeout(()=>{console.log("🌊 Démarrage exploration..."),r.startExploration(!0),setTimeout(()=>{U(r)},200)},2500)})):(console.log("🌊 Démarrage direct..."),Y(),setTimeout(()=>{r.startExploration(!0),setTimeout(()=>{U(r)},200)},2500))},300)}catch(r){console.error("❌ Erreur application:",r),Ae()}}function qe(){const r=document.getElementById("loading-screen");if(!r)return;const e=r.querySelector("l-jelly"),t=r.querySelector(".spinner");e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),t&&(t.style.transition="opacity 0.3s ease",t.style.opacity="0",setTimeout(()=>t.remove(),300)),console.log("✅ Spinner caché, fond noir conservé")}function ke(){const r=document.getElementById("main-container");if(!r)return;r.classList.remove("hidden"),r.style.opacity="0",r.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(s=>{s.style.opacity="0"}),i&&(i.style.opacity="0"),o&&(o.style.opacity="0"),console.log("✅ Interface initialisée en mode clear")}function U(r){const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelectorAll(".hotspot-label"),s=document.querySelectorAll("svg"),n=document.querySelector(".scanner-effect");console.log("✨ Apparition des éléments UI + hotspots + connector lines"),r&&r.globeManager&&r.globeManager.showLabels(),e&&(e.style.pointerEvents="auto"),window.gsap?(e&&gsap.to(e,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...t,i,n].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...o,...s],{opacity:1,duration:.8,ease:"power2.out"})):(e&&(e.style.transition="all 0.8s ease",e.style.opacity="1",e.style.transform="translateY(0)"),t.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),i&&(i.style.transition="opacity 0.8s ease",i.style.opacity="1"),n&&(n.style.transition="opacity 0.8s ease",n.style.opacity="1"),o.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),s.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}))}function Y(){const r=document.getElementById("loading-screen"),e=document.getElementById("main-container");r&&(console.log("🌑 Début transition fond noir (100% → 0% sur 4s)"),console.log("🌍 Interface (globe) visible immédiatement derrière le fond noir"),e&&(e.style.opacity="1"),r.style.transition="opacity 2.5s cubic-bezier(0.19, 1, 0.22, 1)",r.style.opacity="0",setTimeout(()=>{r.style.display="none",r.classList.add("hidden"),console.log("✅ Écran de chargement complètement masqué")},2500))}function Ae(r){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function De(){const r=document.getElementById("welcome-screen");r&&(r.style.display="none",r.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function ze(){if(b.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),b.initialized=!0,!Se())return;De(),Te();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{Le()},300))},200)}function Be(){b.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),b.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(b.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),b.domReady=!0,Ie(),setTimeout(()=>{ze()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Be,{once:!0});
