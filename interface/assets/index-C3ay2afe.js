import{R as I,V as W,C as Y,a as w,S as X,A as L,D as q,F as k,P as _,W as Z,b as K,c as A,L as C,d as D,e as z,H as J,T as S,f as v,M,g as x,h as Q,B as ee,i as B,j as H,k as O,l as R,m as T,n as te,o as oe,p as N,q as ie}from"./three-4x0lhi4J.js";import{g as l}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const se={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ne="/nationalgeographic.fr-mondesimmerges/accueil/";function ae(r){return se[r]||ne}class re{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new I,this.mouse=new W,this.clock=new Y,this.labelsVisible=!1,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new X;const e=new L(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new k(0,15e-5),this.camera=new _(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new Z({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=K;const o=this.renderer.getContext();console.log("WebGL Version:",o.getParameter(o.VERSION)),console.log("WebGL Vendor:",o.getParameter(o.VENDOR)),console.log("Max Texture Size:",o.getParameter(o.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(o){console.error("Erreur lors de la création du renderer WebGL:",o),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}setupLighting(){const e=new L(4210768,.5);this.scene.add(e);const t=new q(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const o=new J(35071,65416,.6);this.scene.add(o)}createCelestialBodies(){const e=new S,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),o=new v(3,32,32),i=new M({map:t,transparent:!0,opacity:.95}),s=new x(o,i);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new v(1.5,32,32),c=new Q({map:n}),d=new x(a,c);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,c=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),p=c*Math.sin(n);const h=p*Math.sin(d);p=p*Math.cos(d),e.push(new w(u,h,p))}new ee().setFromPoints(e);const o=new v(.2,16,16),i=new M({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(o,i),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const o=document.createElement("video");o.src=this.currentVideoPath,o.loop=!0,o.muted=!0,o.autoplay=!1,o.playsInline=!0,o.crossOrigin="anonymous",o.preload="auto",this.videoElement=o,console.log("📦 Préchargement de la vidéo du globe...",this.currentVideoPath);let i=!1;const s=setTimeout(()=>{i||(console.warn("⚠️ Timeout préchargement vidéo - continuation"),i=!0,e())},1e4);o.addEventListener("canplaythrough",()=>{i||(console.log("✅ Vidéo du globe préchargée et prête"),i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("canplay",()=>{i||(console.log("✅ Vidéo du globe peut être jouée"),i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("error",m=>{i||(console.error("❌ Erreur chargement vidéo globe:",m),console.warn("Continuation malgré l'erreur"),i=!0,clearTimeout(s),e())}),o.addEventListener("ended",()=>{o.play()}),setInterval(()=>{o.paused&&!o.ended&&(console.log("Vidéo en pause, relance..."),o.play().catch(m=>{console.error("Impossible de relancer la vidéo:",m)}))},1e3),this.videoTexture=new A(o),this.videoTexture.minFilter=C,this.videoTexture.magFilter=C,this.videoTexture.format=D,this.videoTexture.colorSpace=z;const n=new v(1.99,64,64),a=new M({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:B}),c=new x(n,a);c.renderOrder=0,this.scene.add(c),this.depthSphere=c;const d=new v(2,64,64),u=new M({map:this.videoTexture,transparent:!0,opacity:1,side:B,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(d,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const p=new v(2.02,64,64),h=new M({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(p,h),this.clouds.renderOrder=2,this.scene.add(this.clouds),o.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new H({vertexShader:`
        ...
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(i),document.body.appendChild(s);const a=()=>{i.style.backgroundColor="rgba(255, 204, 0, 0.9)",i.style.color="#000",i.style.transform="scale(1.05)"},c=()=>{i.style.backgroundColor="rgba(0, 0, 0, 0.8)",i.style.color="#ffcc00",i.style.transform="scale(1)"},d=u=>{u.stopPropagation();const p=e.userData.hotspot;p&&(console.log(`Label cliqué: ${p.title}`),this.activateHotspot(p))};i.addEventListener("mouseenter",a),i.addEventListener("mouseleave",c),i.addEventListener("click",d),e.userData.label=i,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=o.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:c,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const i=t[0].point,n=Math.acos(i.y/2),a=Math.atan2(i.z,i.x),c=90-n*180/Math.PI,d=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${c.toFixed(2)}, lng: ${d.toFixed(2)}`);const u=this._findNearestHotspot(c,d,10);if(u){console.log(`Hotspot trouvé: ${u.title}`),this.activateHotspot(u);return}}const o=this.raycaster.intersectObjects(this.hotspotObjects);if(o.length>0){const i=o[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${i.title}`),this.activateHotspot(i)}}_findNearestHotspot(e,t,o){let i=null,s=o;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const c=a.position.lat,d=a.position.lng,u=Math.sqrt(Math.pow(c-e,2)+Math.pow(d-t,2));u<s&&(s=u,i=a)}return i}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),o=e.position.lng*(Math.PI/180),i=2.1,s=i*Math.cos(t)*Math.cos(o),n=i*Math.sin(t),a=i*Math.cos(t)*Math.sin(o),c=new w(s,n,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const d=this.camera.position.clone(),h=c.clone().normalize().multiplyScalar(3.5),m=new w().addVectors(d,h).multiplyScalar(.5);m.normalize().multiplyScalar(m.length()+1.8);const f=l.timeline();f.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}}),f.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),f.to(this.camera,{fov:40,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           ...
           z-index: 9999;
           pointer-events: none;
       `,document.body.appendChild(t),l.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const o=ae(e.id);console.log(`Redirection vers: ${o}`),window.location.href=o}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),o=(e.lng+180)*(Math.PI/180),i=-(2.1*Math.sin(t)*Math.cos(o)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(o),a=new N(0,.3,32),c=new H({uniforms:{color:{value:new T(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,this.effectsContainer.appendChild(t),l.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const o={...{count:50,container:this.container},...e},i=document.createElement("div");i.className="background-particles",i.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<o.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,c=Math.random()*100,d=Math.random()*100,u=Math.random()*5,p=Math.random()*10+10,h=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
