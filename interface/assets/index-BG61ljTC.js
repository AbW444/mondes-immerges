import{R as k,V as K,C as J,a as v,S as Q,A,D,F as z,P as ee,W as te,b as oe,c as B,L as P,d as H,e as O,H as ie,T as L,f as w,M as x,g as f,h as se,B as ne,i as $,j as N,k as ae,l as R,m as re,n as le,o as V,G as ce,p as de,q as C,r as S}from"./three-DpqYpCtB.js";import{g as l}from"./gsap-xHO-obUW.js";import{i as ue}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const pe={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},me="/nationalgeographic.fr-mondesimmerges/accueil/";function he(r){return pe[r]||me}class ge{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new k,this.mouse=new K,this.clock=new J,this.labelsVisible=!1,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:.7,minZoomLevel:.5,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new v(100,20,100),moonPosition:new v(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new Q;const e=new A(16777215,1.2);this.scene.add(e);const t=new D(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new z(0,15e-5),this.camera=new ee(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new te({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=oe;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),l.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}setupLighting(){const e=new A(4210768,.5);this.scene.add(e);const t=new D(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new ie(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new L,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new w(3,32,32),o=new x({map:t,transparent:!0,opacity:.95}),s=new f(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new w(1.5,32,32),c=new se({map:n}),d=new f(a,c);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,c=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let p=a*Math.cos(n),u=c*Math.sin(n);const m=u*Math.sin(d);u=u*Math.cos(d),e.push(new v(p,m,u))}new ne().setFromPoints(e);const i=new w(.2,16,16),o=new x({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new f(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(d=>{console.error("Impossible de relancer la vidéo:",d)}))},1e3),this.videoTexture=new B(e),this.videoTexture.minFilter=P,this.videoTexture.magFilter=P,this.videoTexture.format=H,this.videoTexture.colorSpace=O;const t=new w(1.99,64,64),i=new x({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:$}),o=new f(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const s=new w(2,64,64),n=new x({map:this.videoTexture,transparent:!0,opacity:1,side:$,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new f(s,n),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const a=new w(2.02,64,64),c=new x({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new f(a,c),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(d=>{console.error("Erreur lors de la lecture de la vidéo:",d),this.handleVideoError()})}createAtmosphere(){const e=new w(2.15,64,64),t=new N({vertexShader:`
            ...
            `,uniforms:{cameraPosition:{value:new v}},blending:R,side:ae,transparent:!0}),i=new f(e,t);this.scene.add(i),this.atmosphere=i,this.updateAtmosphereUniforms=()=>{this.atmosphere&&this.atmosphere.material.uniforms&&this.atmosphere.material.uniforms.cameraPosition.value.copy(this.camera.position)}}createSkybox(){new L().load("/nationalgeographic.fr-mondesimmerges/interface/images/night-sky.png",i=>{this.renderer.toneMapping=re,this.renderer.toneMappingExposure=.3;const o=new le(i.image.height);o.fromEquirectangularTexture(this.renderer,i),this.scene.background=o.texture,this.scene.fog=new z(17,8e-5)},void 0,i=>{console.error("Erreur lors du chargement de la texture du ciel:",i),this.scene.background=new V(17)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,n,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new v(i,n,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{if(this.scene.remove(t),t.userData.label&&t.userData.labelHandlers){const{onMouseEnter:i,onMouseLeave:o,onClick:s}=t.userData.labelHandlers;t.userData.label.removeEventListener("mouseenter",i),t.userData.label.removeEventListener("mouseleave",o),t.userData.label.removeEventListener("click",s)}t.userData.label&&t.userData.label.parentNode&&t.userData.label.parentNode.removeChild(t.userData.label),t.userData.connectorSvg&&t.userData.connectorSvg.parentNode&&t.userData.connectorSvg.parentNode.removeChild(t.userData.connectorSvg),t.userData.labelContainer&&t.userData.labelContainer.parentNode&&t.userData.labelContainer.parentNode.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],document.querySelectorAll(".hotspot-label").forEach(t=>t.remove()),document.querySelectorAll(".hotspot-label-container").forEach(t=>t.remove()),document.querySelectorAll(".connector-line").forEach(t=>t.remove()),e.forEach(t=>{const{position:i,title:o}=t,s=i.lat*(Math.PI/180),n=i.lng*(Math.PI/180),a=2.1,c=a*Math.cos(s)*Math.cos(n),d=a*Math.sin(s),p=a*Math.cos(s)*Math.sin(n);console.log(`Hotspot ${o}: GPS(${i.lat}, ${i.lng}) -> 3D(${c.toFixed(2)}, ${d.toFixed(2)}, ${p.toFixed(2)})`);const u=new ce;u.position.set(c,d,p),u.userData={hotspot:t},u.lookAt(0,0,0),u.rotateX(Math.PI);const m=new de(.04,32),h=new x({color:16763904,transparent:!0,opacity:1,side:C}),g=new f(m,h);u.add(g);const y=new S(.05,.07,32),E=new x({color:16763904,transparent:!0,opacity:.6,side:C}),M=new f(y,E);u.add(M);const W=new S(.09,.1,32),Y=new x({color:16763904,transparent:!0,opacity:.3,side:C}),X=new f(W,Y);u.add(X);const q=[];for(let I=0;I<3;I++){const _=new S(.04,.06,32),Z=new x({color:16763904,transparent:!0,opacity:0,side:C}),T=new f(_,Z);T.userData.initialDelay=I*.8,T.userData.waveTime=0,u.add(T),q.push(T)}u.userData.waveRings=q,this.addHotspotLabel(u,o,new v(c,d,p)),this.scene.add(u),this.hotspotObjects.push(u)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label",o.textContent=t,o.style.cssText=`
            position: fixed;
        ...
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.style.cssText=`
            ...
            z-index: 999;
            opacity: 0;
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(o),document.body.appendChild(s);const a=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},c=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffcc00",o.style.transform="scale(1)"},d=p=>{p.stopPropagation();const u=e.userData.hotspot;u&&(console.log(`Label cliqué: ${u.title}`),this.activateHotspot(u))};o.addEventListener("mouseenter",a),o.addEventListener("mouseleave",c),o.addEventListener("click",d),e.userData.label=o,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:c,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,n=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),c=90-n*180/Math.PI,d=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${c.toFixed(2)}, lng: ${d.toFixed(2)}`);const p=this._findNearestHotspot(c,d,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,s=i;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const c=a.position.lat,d=a.position.lng,p=Math.sqrt(Math.pow(c-e,2)+Math.pow(d-t,2));p<s&&(s=p,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,s=o*Math.cos(t)*Math.cos(i),n=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),c=new v(s,n,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=c.clone().normalize().multiplyScalar(3.5);l.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),l.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
           ...
           z-index: 9999;
           pointer-events: none;
       `,document.body.appendChild(t),l.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=he(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(i),a=new S(0,.3,32),c=new N({uniforms:{color:{value:new V(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,this.container.appendChild(this.notificationContainer)}transitionIn(){const e=document.createElement("div");e.classList.add("transition-overlay"),e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.backgroundColor="#000000",e.style.zIndex="10",this.effectsContainer.appendChild(e),l.fromTo(e,{opacity:1},{opacity:0,duration:1.5,ease:"power2.out",onComplete:()=>{e.remove()}})}transitionOut(e){const t=document.createElement("div");t.classList.add("transition-overlay"),t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor="#000000",t.style.zIndex="10",t.style.opacity="0",this.effectsContainer.appendChild(t),l.to(t,{opacity:1,duration:1,ease:"power2.in",onComplete:()=>{e&&e()}})}createOrbitalLoaderEffect(e,t=4,i=null){const o=document.createElement("div");o.className="orbital-loader",i?o.style.cssText=`
            ...
            justify-content: center;
            align-items: center;
        `;for(let p=0;p<3;p++){const u=document.createElement("div");u.style.cssText=`
                position: absolute;
                border-radius: 50%;
            ...
            `;for(let m=0;m<3+p;m++){const h=document.createElement("div"),g=360/(3+p)*m;h.style.cssText=`
                    position: absolute;
                    width: ${8-p}px;
                    height: ${8-p}px;
                ...
                `,u.appendChild(h)}s.appendChild(u)}const n=document.createElement("div");n.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,s.appendChild(a),o.appendChild(s);const c=document.createElement("style");c.textContent=`
            @keyframes orbit0 {
        ...
        `,this.effectsContainer.appendChild(t),l.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<i.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,c=Math.random()*100,d=Math.random()*100,p=Math.random()*5,u=Math.random()*10+10,m=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `)}function Te(){const r=document.getElementById("loading-screen");if(!r)return;const e=r.querySelector(".spinner");e&&e.remove();try{ue.register();const t=document.createElement("l-jelly");t.setAttribute("size","60"),t.setAttribute("speed","0.9"),t.setAttribute("color","#ffcc00"),r.insertBefore(t,r.firstChild),console.log("✅ Spinner initialisé")}catch(t){console.warn("⚠️  Fallback spinner CSS");const i=document.createElement("div");i.className="spinner",r.insertBefore(i,r.firstChild)}}function Pe(){const r=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!r||!e)return;let t=0,i=0,o=0,s=0,n=null;const a=d=>{t=d.clientX,i=d.clientY};document.addEventListener("mousemove",a,{passive:!0});function c(){r.style.left=t+"px",r.style.top=i+"px",o+=(t-o)*.1,s+=(i-s)*.1,e.style.left=o+"px",e.style.top=s+"px",n=requestAnimationFrame(c)}n=requestAnimationFrame(c),window.addEventListener("beforeunload",()=>{n&&cancelAnimationFrame(n),document.removeEventListener("mousemove",a)}),console.log("✅ Curseur initialisé")}async function Ie(){if(b.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),b.appStarted=!0;try{Ee();const r=Me();if(!r)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),Le(),qe(),setTimeout(()=>{r.startupSequence&&typeof r.startupSequence=="function"?(console.log("🎬 Séquence de démarrage..."),r.startupSequence(()=>{G(),setTimeout(()=>{console.log("🌊 Démarrage exploration..."),r.startExploration(!0),setTimeout(()=>{j(r)},200)},2500)})):(console.log("🌊 Démarrage direct..."),G(),setTimeout(()=>{r.startExploration(!0),setTimeout(()=>{j(r)},200)},2500))},300)}catch(r){console.error("❌ Erreur application:",r),ke()}}function Le(){const r=document.getElementById("loading-screen");if(!r)return;const e=r.querySelector("l-jelly"),t=r.querySelector(".spinner");e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),t&&(t.style.transition="opacity 0.3s ease",t.style.opacity="0",setTimeout(()=>t.remove(),300)),console.log("✅ Spinner caché, fond noir conservé")}function qe(){const r=document.getElementById("main-container");if(!r)return;r.classList.remove("hidden"),r.style.opacity="0",r.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(s=>{s.style.opacity="0"}),i&&(i.style.opacity="0"),o&&(o.style.opacity="0"),console.log("✅ Interface initialisée en mode clear")}function j(r){const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelectorAll(".hotspot-label"),s=document.querySelectorAll("svg"),n=document.querySelector(".scanner-effect");console.log("✨ Apparition des éléments UI + hotspots + connector lines"),r&&r.globeManager&&r.globeManager.showLabels(),e&&(e.style.pointerEvents="auto"),window.gsap?(e&&gsap.to(e,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...t,i,n].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...o,...s],{opacity:1,duration:.8,ease:"power2.out"})):(e&&(e.style.transition="all 0.8s ease",e.style.opacity="1",e.style.transform="translateY(0)"),t.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),i&&(i.style.transition="opacity 0.8s ease",i.style.opacity="1"),n&&(n.style.transition="opacity 0.8s ease",n.style.opacity="1"),o.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),s.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}))}function G(){const r=document.getElementById("loading-screen"),e=document.getElementById("main-container");r&&(console.log("🌑 Début transition fond noir (100% → 0% sur 4s)"),console.log("🌍 Interface (globe) visible immédiatement derrière le fond noir"),e&&(e.style.opacity="1"),r.style.transition="opacity 2.5s cubic-bezier(0.19, 1, 0.22, 1)",r.style.opacity="0",setTimeout(()=>{r.style.display="none",r.classList.add("hidden"),console.log("✅ Écran de chargement complètement masqué")},2500))}function ke(r){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function Ae(){const r=document.getElementById("welcome-screen");r&&(r.style.display="none",r.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function De(){if(b.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),b.initialized=!0,!Ce())return;Ae(),Te();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{Ie()},300))},200)}function ze(){b.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),b.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(b.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),b.domReady=!0,Pe(),setTimeout(()=>{De()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",ze,{once:!0});
