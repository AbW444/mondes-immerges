import{R as I,V as j,C as G,a as w,S as F,A as k,D as q,F as A,P as W,W as U,H as _,T,b as v,M as E,c as x,d as Y,B as X,e as Z,L as D,f as K,g as J,h as z,i as B,j as O,k as $,l as S,m as Q,n as ee,o as R,p as te}from"./three-DErGBpjY.js";import{g as c}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const oe={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},ie="/mondes-immerges/accueil/";function L(r){return oe[r]||ie}class se{constructor(){this.videos=new Map,this.retryAttempts=new Map,this.maxRetries=5,this.checkInterval=null,this.isActive=!0,this._contextLost=!1}onContextLost(){this._contextLost=!0,this.stopMonitoring(),console.warn("🛑 VideoManager: WebGL context lost - arrêt de toutes les relances")}onContextRestored(){this._contextLost=!1,console.log("✅ VideoManager: WebGL context restored - reprise possible"),this.videos.forEach((e,t)=>{this.playVideo(t,e)}),this.startMonitoring(2e3)}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement)){console.error("VideoManager: Élément vidéo invalide");return}const i={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,autoRetry:t.autoRetry!==!1,onError:t.onError||null,onPlay:t.onPlay||null,onStall:t.onStall||null,name:t.name||"video-"+this.videos.size};e.loop=i.shouldLoop,e.muted=i.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,i),this.retryAttempts.set(e,0),this.attachListeners(e,i),console.log(`✅ VideoManager: "${i.name}" enregistrée`)}attachListeners(e,t){e.addEventListener("ended",()=>{t.shouldLoop&&this.isActive&&(console.log(`🔄 VideoManager: "${t.name}" - Relance après ended`),this.playVideo(e,t))}),e.addEventListener("pause",()=>{e.ended||e.dataset.intentionalPause!=="true"&&(this._contextLost||this.isActive&&(console.warn(`⚠️ VideoManager: "${t.name}" - Pause détectée, relance...`),setTimeout(()=>{this.isActive&&!this._contextLost&&this.playVideo(e,t)},100)))}),e.addEventListener("stalled",()=>{console.warn(`⚠️ VideoManager: "${t.name}" - Stalled (buffering)`),t.onStall&&t.onStall(e),setTimeout(()=>{e.readyState>=2&&this.isActive&&!this._contextLost&&this.playVideo(e,t)},500)}),e.addEventListener("waiting",()=>{console.log(`⏳ VideoManager: "${t.name}" - Waiting for data...`)}),e.addEventListener("suspend",()=>{console.log(`💤 VideoManager: "${t.name}" - Suspended`)}),e.addEventListener("error",i=>{console.error(`❌ VideoManager: "${t.name}" - Erreur:`,i),t.onError&&t.onError(i);const o=this.retryAttempts.get(e)||0;o<this.maxRetries&&t.autoRetry&&this.isActive&&!this._contextLost&&(this.retryAttempts.set(e,o+1),console.log(`🔄 VideoManager: "${t.name}" - Tentative ${o+1}/${this.maxRetries}`),setTimeout(()=>{e.load(),this.playVideo(e,t)},2e3*(o+1)))}),e.addEventListener("loadeddata",()=>{console.log(`✅ VideoManager: "${t.name}" - Données chargées`)}),e.addEventListener("play",()=>{console.log(`▶️ VideoManager: "${t.name}" - Lecture démarrée`),this.retryAttempts.set(e,0),t.onPlay&&t.onPlay(e)})}playVideo(e,t){if(!e||!this.isActive||this._contextLost)return;const i=e.play();i!==void 0&&i.then(()=>{console.log(`✅ VideoManager: "${t.name}" - Play() réussi`)}).catch(o=>{if(console.error(`❌ VideoManager: "${t.name}" - Play() échoué:`,o),o.name==="NotAllowedError"){console.warn(`⚠️ VideoManager: "${t.name}" - Autoplay bloqué, en attente d'interaction...`);const s=()=>{this.playVideo(e,t),document.removeEventListener("click",s)};document.addEventListener("click",s,{once:!0})}})}startMonitoring(e=2e3){if(this.checkInterval){console.warn("VideoManager: Surveillance déjà active");return}console.log("🔍 VideoManager: Démarrage de la surveillance périodique"),this.checkInterval=setInterval(()=>{!this.isActive||this._contextLost||this.videos.forEach((t,i)=>{i.paused&&!i.ended&&t.shouldLoop&&(console.warn(`⚠️ VideoManager: "${t.name}" - En pause (surveillance), relance...`),this.playVideo(i,t)),i.readyState<3&&!i.paused&&console.log(`⏳ VideoManager: "${t.name}" - Buffering...`)})},e)}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null,console.log("⏹️ VideoManager: Surveillance arrêtée"))}unregister(e){if(this.videos.has(e)){const t=this.videos.get(e);console.log(`🗑️ VideoManager: "${t.name}" désenregistrée`),this.videos.delete(e),this.retryAttempts.delete(e)}}unregisterAll(){this.videos.clear(),this.retryAttempts.clear(),console.log("🗑️ VideoManager: Toutes les vidéos désenregistrées")}disable(){this.isActive=!1,this.stopMonitoring(),console.log("⏸️ VideoManager: Désactivé")}enable(){this.isActive=!0,this.startMonitoring(),console.log("▶️ VideoManager: Activé")}destroy(){this.disable(),this.unregisterAll(),console.log("💥 VideoManager: Détruit")}}const M=new se;class ne{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new I,this.mouse=new j,this.clock=new G,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.init()}init(){this.scene=new F;const e=new k(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new W(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const i=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),o=i||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new U({antialias:!i,alpha:!0,logarithmicDepthBuffer:!o,powerPreference:"high-performance",precision:i?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(i?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!1,this.isMobile=i;const s=this.renderer.getContext();console.log("WebGL Version:",s.getParameter(s.VERSION)),console.log("WebGL Vendor:",s.getParameter(s.VENDOR)),console.log("Max Texture Size:",s.getParameter(s.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement);const n=this.renderer.domElement;n.addEventListener("webglcontextlost",a=>{a.preventDefault(),console.warn("⚠️ WebGL context lost - arrêt du rendu"),this._contextLost=!0,M.onContextLost()}),n.addEventListener("webglcontextrestored",()=>{console.log("✅ WebGL context restored - reprise du rendu"),this._contextLost=!1,M.onContextRestored()})}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.classList.add("hotspot-connector"),s.style.cssText=`
            ...
            z-index: 50;
            opacity: 0;
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(o),document.body.appendChild(s);const a=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},l=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffdd00",o.style.transform="scale(1)"},d=u=>{u.stopPropagation();const p=e.userData.hotspot;p&&(console.log(`Label cliqué: ${p.title}`),this.activateHotspot(p))};o.addEventListener("mouseenter",a),o.addEventListener("mouseleave",l),o.addEventListener("click",d),e.userData.label=o,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:l,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,n=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),l=90-n*180/Math.PI,d=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${l.toFixed(2)}, lng: ${d.toFixed(2)}`);const u=this._findNearestHotspot(l,d,10);if(u){console.log(`Hotspot trouvé: ${u.title}`),this.activateHotspot(u);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,s=i;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const l=a.position.lat,d=a.position.lng,u=Math.sqrt(Math.pow(l-e,2)+Math.pow(d-t,2));u<s&&(s=u,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,s=o*Math.cos(t)*Math.cos(i),n=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),l=new w(s,n,a);this.orbitParams.isOrbiting=!1;const d=this.camera.position.clone(),m=l.clone().normalize().multiplyScalar(5.2),h=new w().addVectors(d,m).multiplyScalar(.5);h.normalize().multiplyScalar(h.length()+1.8);const g=c.timeline();g.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}});let b=document.getElementById("fade-overlay");b||(b=document.createElement("div"),b.id="fade-overlay",b.style.cssText=`
                position: fixed;
                top: 0;
                left: 0;
                width: 100%;
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<i.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,l=Math.random()*100,d=Math.random()*100,u=Math.random()*5,p=Math.random()*10+10,m=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
