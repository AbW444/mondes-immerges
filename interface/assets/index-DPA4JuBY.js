import{R as L,V as U,C as W,a as y,S as _,A as k,D as q,F as A,P as X,W as Y,b as Z,c as z,L as T,d as D,e as B,H as K,T as I,f as v,M as C,g as x,h as J,B as Q,i as $,j as O,k as H,l as N,m as ee,n as te,o as R,p as oe,q as ie}from"./three-Bmxrupip.js";import{g as c}from"./gsap-xHO-obUW.js";import{i as se}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ne={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ae="/nationalgeographic.fr-mondesimmerges/accueil/";function re(r){return ne[r]||ae}class le{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new L,this.mouse=new U,this.clock=new W,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new y(100,20,100),moonPosition:new y(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new _;const e=new k(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new X(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new Y({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Z;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `,o.appendChild(n),o.appendChild(s),document.body.appendChild(o),e.userData.label=n,e.userData.connector=s,e.userData.labelContainer=o,e.userData.worldPosition=i.clone();const a=d=>{const l=new y().copy(d).project(this.camera);if(l.z>1||l.x<-1||l.x>1||l.y<-1||l.y>1)return!1;const p=new y().subVectors(d,this.camera.position).normalize(),h=new L(this.camera.position,p).intersectObject(this.globe);if(h.length>0){const m=h[0].distance,E=this.camera.position.distanceTo(d);return m>E-.1}return!0};e.onBeforeRender=()=>{if(!e.userData.label||!e.userData.connector)return;if(a(e.userData.worldPosition)&&!this.orbitParams.inHotspotMode){const l=e.userData.worldPosition.clone();l.project(this.camera);const p=(l.x*.5+.5)*window.innerWidth,u=(-l.y*.5+.5)*window.innerHeight,h=window.innerWidth/2,m=window.innerHeight/2,E=Math.sqrt(Math.pow(p-h,2)+Math.pow(u-m,2)),w=Math.atan2(u-m,p-h),M=Math.min(h,m)*.6;let g,b;if(E<M){const S=M+60+Math.sin(w*5)*20;g=h+Math.cos(w)*S,b=m+Math.sin(w)*S;const f=20;g<f&&(g=f),g>window.innerWidth-f&&(g=window.innerWidth-f),b<f&&(b=f),b>window.innerHeight-f&&(b=window.innerHeight-f)}else{const S=t.length*8,f=25+S*.25,P=10;p+f+S>window.innerWidth-20?g=p-f-S:g=p+f,u-P-30<20?b=u+P:b=u-P}e.userData.label.style.left=`${g}px`,e.userData.label.style.top=`${b}px`,e.userData.label.style.opacity="1",s.style.left=`${p}px`,s.style.top=`${u}px`;const G=Math.sqrt(Math.pow(g-p,2)+Math.pow(b-u,2)),F=Math.atan2(b-u,g-p);s.style.width=`${G}px`,s.style.transform=`rotate(${F}rad)`,s.style.opacity="1",s.style.animation="pulseConnector 2s infinite alternate"}else e.userData.label.style.opacity="0",s.style.opacity="0"}}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),d=90-s*180/Math.PI,l=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${d.toFixed(2)}, lng: ${l.toFixed(2)}`);const p=this._findNearestHotspot(d,l,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of s){const d=a.position.lat,l=a.position.lng,p=Math.sqrt(Math.pow(d-e,2)+Math.pow(l-t,2));p<n&&(n=p,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),d=new y(n,s,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=d.clone().normalize().multiplyScalar(3.5);c.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),c.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
       ...
       `,document.body.appendChild(t),c.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=re(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),a=new oe(0,.3,32),d=new O({uniforms:{color:{value:new R(16763904)},time:{value:0}},vertexShader:`
        ...
        `;for(let a=0;a<3;a++){const d=document.createElement("div");d.style.cssText=`
            ...
            `;for(let l=0;l<3+a;l++){const p=document.createElement("div"),u=360/(3+a)*l;p.style.cssText=`
                    position: absolute;
                    width: ${8-a}px;
                    height: ${8-a}px;
        ...
        `,document.head.appendChild(s),this.effectsContainer.appendChild(i),c.fromTo(i,{opacity:0},{opacity:1,duration:.5}),setTimeout(()=>{c.to(i,{opacity:0,duration:.5,onComplete:()=>{i.remove(),s.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),c.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{c.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const o={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let n=0;n<o.pulseCount;n++)setTimeout(()=>{const s=document.createElement("div");s.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),a=Math.random()*3+1,d=Math.random()*100,l=Math.random()*100,p=Math.random()*5,u=Math.random()*10+10,h=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
    ...
    `,document.body.appendChild(r)}function ye(){if(console.log("🌊 Application Mondes Immergés en cours de chargement..."),!be()){console.error("❌ Initialisation interrompue - WebGL incompatible");return}const r=document.createElement("style");r.textContent=`
    ...
    `,document.head.appendChild(r);const e=document.getElementById("welcome-screen");e&&(e.style.display="none",e.classList.add("hidden"));const t=document.getElementById("main-container");t&&(t.classList.add("hidden"),t.style.opacity="0");let i=0;const o=8,n=()=>{i++;const a=Math.round(i/o*100);console.log(`📦 Ressource ${i}/${o} chargée (${a}%)`);const d=document.querySelector(".progress-bar"),l=document.querySelector(".progress-text");d&&(d.style.width=`${a}%`),l&&(l.textContent=`${a}%`),i>=o&&(console.log("✅ Toutes les ressources chargées - Démarrage de l'application"),we())};["Configuration système","Textures globe","Vidéos des zones","Données géographiques","Interfaces utilisateur","Modèles 3D","Données scientifiques","Effets visuels"].forEach((a,d)=>{const l=150+Math.random()*250;setTimeout(()=>{console.log(`📦 Ressource chargée: ${a}`),n()},l*(d+1))}),ve()}function ve(){const r=document.getElementById("main-container");if(!r||r.querySelector(".starry-background"))return;const e=document.createElement("div");e.className="starry-background",e.style.cssText=`
        position: absolute;
        top: 0;
        left: 0;
        width: 100%;
        ...
        pointer-events: none;
        z-index: -1;
    `,r.appendChild(e);for(let t=0;t<100;t++){const i=document.createElement("div");i.className="star";const o=Math.random()*100,n=Math.random()*100,s=Math.random()*2+1,a=Math.random()*.7+.3,d=Math.random()*5+3,l=Math.random()*3;i.style.cssText=`
            position: absolute;
            left: ${o}%;
            top: ${n}%;
            width: ${s}px;
            ...
            border-radius: 50%;
            animation: starTwinkle ${d}s ease-in-out ${l}s infinite;
            pointer-events: none;
        `,e.appendChild(i)}}function we(){console.log("🚀 Démarrage de l'application...");try{ge();const r=fe();if(!r)throw new Error("Impossible de récupérer l'instance de l'application");console.log("✅ Application initialisée avec succès"),setTimeout(()=>{Me(r)},300)}catch(r){console.error("❌ Erreur lors de l'initialisation de l'application:",r),Ee(r)}}function Ee(r){const e=document.createElement("div");e.style.cssText=`
        position: fixed;
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
    ...
    `,document.body.appendChild(e)}function Me(r){console.log("🎬 Démarrage de la séquence d'initialisation...");const e=document.getElementById("loading-screen");e?(e.style.opacity="0",e.style.transform="scale(1.1)",setTimeout(()=>{e.classList.add("hidden");const t=document.getElementById("main-container");t&&(t.classList.remove("hidden"),t.style.opacity="1"),console.log("🎭 Conteneur principal rendu visible"),r.startupSequence&&typeof r.startupSequence=="function"?(console.log("🚀 Lancement de la séquence de démarrage..."),r.startupSequence(),setTimeout(()=>{console.log("🌊 Démarrage de l'exploration..."),r.startExploration(!0)},5e3)):(console.log("⚠️  Méthode startupSequence non trouvée, démarrage direct"),r.startExploration(!0))},500)):(console.log("⚠️  Écran de chargement non trouvé, démarrage direct"),r.startExploration(!0))}function Ce(){const r=document.getElementById("loading-screen");if(!r){console.warn("⚠️  Écran de chargement non trouvé");return}if(r.querySelector(".progress-container")){console.log("🔄 Écran de chargement déjà amélioré");return}console.log("✨ Amélioration de l'écran de chargement...");const e=r.querySelector(".spinner");e&&e.remove();try{se.register();const n=document.createElement("l-jelly");n.setAttribute("size","60"),n.setAttribute("speed","0.9"),n.setAttribute("color","#ffcc00"),n.style.cssText=`
            margin-bottom: 30px;
            display: block;
        `;const s=r.querySelector("p");s?r.insertBefore(n,s):r.appendChild(n),console.log("✅ Spinner Jelly ajouté avec succès")}catch(n){console.warn("⚠️  Impossible de charger le spinner Jelly, utilisation du spinner CSS par défaut"),console.error("Détails de l'erreur Jelly:",n);const s=document.createElement("div");s.className="spinner";const a=r.querySelector("p");a?r.insertBefore(s,a):r.appendChild(s)}const t=document.createElement("div");t.className="progress-container";const i=document.createElement("div");i.className="progress-bar";const o=document.createElement("div");o.className="progress-text",o.textContent="0%",t.appendChild(i),t.appendChild(o),r.appendChild(t),console.log("📊 Barre de progression ajoutée")}function Se(){console.log("🖱️  Initialisation curseur personnalisé...");const r=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!r||!e){console.log("⚠️  Éléments curseur non trouvés");return}let t=0,i=0,o=0,n=0,s=0,a=0;document.addEventListener("mousemove",p=>{t=p.clientX,i=p.clientY});function d(){o=t,n=i,r.style.left=o+"px",r.style.top=n+"px",s+=(t-s)*.1,a+=(i-a)*.1,e.style.left=s+"px",e.style.top=a+"px",requestAnimationFrame(d)}document.querySelectorAll("button, a, [data-interactive]").forEach(p=>{p.addEventListener("mouseenter",()=>{r.classList.add("hover"),e.classList.add("hover")}),p.addEventListener("mouseleave",()=>{r.classList.remove("hover"),e.classList.remove("hover")})}),d(),console.log("✅ Curseur personnalisé initialisé avec succès")}document.addEventListener("DOMContentLoaded",()=>{console.log("📄 DOM chargé - Initialisation de l'application"),Ce(),Se(),setTimeout(()=>{console.log("⏰ Début de l'initialisation principale..."),ye()},100)});window.addEventListener("error",r=>{console.error("❌ Erreur globale capturée:",r.error),console.error("  - Message:",r.message),console.error("  - Fichier:",r.filename),console.error("  - Ligne:",r.lineno),console.error("  - Colonne:",r.colno)});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée non gérée:",r.reason),r.preventDefault()});window.addEventListener("error",r=>{r.target!==window&&console.error("❌ Erreur de ressource:",r.target.src||r.target.href)},!0);
