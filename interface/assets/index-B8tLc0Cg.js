import{R as I,V as j,C as G,a as w,S as F,A as k,D as q,F as A,P as U,W,b as _,H as Y,T as P,c as v,M as E,d as x,e as X,B as Z,f as K,L as D,g as J,h as Q,i as z,j as B,k as O,l as $,m as C,n as ee,o as te,p as R,q as oe}from"./three-DldaGUFj.js";import{g as c}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const ie={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},se="/mondes-immerges/accueil/";function S(r){return ie[r]||se}class ne{constructor(){this.videos=new Map,this.retryAttempts=new Map,this.maxRetries=5,this.checkInterval=null,this.isActive=!0}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement)){console.error("VideoManager: Élément vidéo invalide");return}const i={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,autoRetry:t.autoRetry!==!1,onError:t.onError||null,onPlay:t.onPlay||null,onStall:t.onStall||null,name:t.name||"video-"+this.videos.size};e.loop=i.shouldLoop,e.muted=i.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,i),this.retryAttempts.set(e,0),this.attachListeners(e,i),console.log(`✅ VideoManager: "${i.name}" enregistrée`)}attachListeners(e,t){e.addEventListener("ended",()=>{t.shouldLoop&&this.isActive&&(console.log(`🔄 VideoManager: "${t.name}" - Relance après ended`),this.playVideo(e,t))}),e.addEventListener("pause",()=>{e.ended||e.dataset.intentionalPause!=="true"&&this.isActive&&(console.warn(`⚠️ VideoManager: "${t.name}" - Pause détectée, relance...`),setTimeout(()=>{this.isActive&&this.playVideo(e,t)},100))}),e.addEventListener("stalled",()=>{console.warn(`⚠️ VideoManager: "${t.name}" - Stalled (buffering)`),t.onStall&&t.onStall(e),setTimeout(()=>{e.readyState>=2&&this.isActive&&this.playVideo(e,t)},500)}),e.addEventListener("waiting",()=>{console.log(`⏳ VideoManager: "${t.name}" - Waiting for data...`)}),e.addEventListener("suspend",()=>{console.log(`💤 VideoManager: "${t.name}" - Suspended`)}),e.addEventListener("error",i=>{console.error(`❌ VideoManager: "${t.name}" - Erreur:`,i),t.onError&&t.onError(i);const o=this.retryAttempts.get(e)||0;o<this.maxRetries&&t.autoRetry&&this.isActive&&(this.retryAttempts.set(e,o+1),console.log(`🔄 VideoManager: "${t.name}" - Tentative ${o+1}/${this.maxRetries}`),setTimeout(()=>{e.load(),this.playVideo(e,t)},2e3*(o+1)))}),e.addEventListener("loadeddata",()=>{console.log(`✅ VideoManager: "${t.name}" - Données chargées`)}),e.addEventListener("play",()=>{console.log(`▶️ VideoManager: "${t.name}" - Lecture démarrée`),this.retryAttempts.set(e,0),t.onPlay&&t.onPlay(e)})}playVideo(e,t){if(!e||!this.isActive)return;const i=e.play();i!==void 0&&i.then(()=>{console.log(`✅ VideoManager: "${t.name}" - Play() réussi`)}).catch(o=>{if(console.error(`❌ VideoManager: "${t.name}" - Play() échoué:`,o),o.name==="NotAllowedError"){console.warn(`⚠️ VideoManager: "${t.name}" - Autoplay bloqué, en attente d'interaction...`);const s=()=>{this.playVideo(e,t),document.removeEventListener("click",s)};document.addEventListener("click",s,{once:!0})}})}startMonitoring(e=2e3){if(this.checkInterval){console.warn("VideoManager: Surveillance déjà active");return}console.log("🔍 VideoManager: Démarrage de la surveillance périodique"),this.checkInterval=setInterval(()=>{this.isActive&&this.videos.forEach((t,i)=>{i.paused&&!i.ended&&t.shouldLoop&&(console.warn(`⚠️ VideoManager: "${t.name}" - En pause (surveillance), relance...`),this.playVideo(i,t)),i.readyState<3&&!i.paused&&console.log(`⏳ VideoManager: "${t.name}" - Buffering...`)})},e)}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null,console.log("⏹️ VideoManager: Surveillance arrêtée"))}unregister(e){if(this.videos.has(e)){const t=this.videos.get(e);console.log(`🗑️ VideoManager: "${t.name}" désenregistrée`),this.videos.delete(e),this.retryAttempts.delete(e)}}unregisterAll(){this.videos.clear(),this.retryAttempts.clear(),console.log("🗑️ VideoManager: Toutes les vidéos désenregistrées")}disable(){this.isActive=!1,this.stopMonitoring(),console.log("⏸️ VideoManager: Désactivé")}enable(){this.isActive=!0,this.startMonitoring(),console.log("▶️ VideoManager: Activé")}destroy(){this.disable(),this.unregisterAll(),console.log("💥 VideoManager: Détruit")}}const T=new ne;class ae{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new I,this.mouse=new j,this.clock=new G,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.init()}init(){this.scene=new F;const e=new k(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new U(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const i=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),o=i||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new W({antialias:!i,alpha:!0,logarithmicDepthBuffer:!o,powerPreference:"high-performance",precision:i?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(i?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!i,i||(this.renderer.shadowMap.type=_),this.isMobile=i;const s=this.renderer.getContext();console.log("WebGL Version:",s.getParameter(s.VERSION)),console.log("WebGL Vendor:",s.getParameter(s.VENDOR)),console.log("Max Texture Size:",s.getParameter(s.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement);const n=this.renderer.domElement;n.addEventListener("webglcontextlost",a=>{a.preventDefault(),console.warn("⚠️ WebGL context lost - arrêt du rendu"),this._contextLost=!0}),n.addEventListener("webglcontextrestored",()=>{console.log("✅ WebGL context restored - reprise du rendu"),this._contextLost=!1})}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const V=new pe;function me(){V.init()}function he(){return V}const y={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function ge(){if(y.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),fe(),y.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),y.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return console.error("❌ Erreur vérification WebGL:",r),!1}}function fe(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
    ...
    `)}function Me(){const r=document.getElementById("welcome-screen");r&&(r.style.display="none",r.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Ce(){if(y.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),y.initialized=!0,!ge())return;Me();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{xe()},300))},200)}function Se(){y.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),y.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(y.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),y.domReady=!0,be(),setTimeout(()=>{Ce()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Se,{once:!0});window.addEventListener("pageshow",r=>{(r.persisted||window.performance&&window.performance.navigation.type===2)&&(console.log("🔄 Page restaurée depuis le cache, rechargement..."),window.location.reload())});
