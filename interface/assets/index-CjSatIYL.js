import{R as B,V as Y,C as X,a as E,S as K,A as z,D as O,F as R,P as Z,W as Q,H as J,T as k,b as w,M,c as v,d as ee,B as te,e as ie,L as H,f as oe,g as se,h as $,i as N,j,k as G,l as T,m as ne,n as ae,o as V,p as re}from"./three-DErGBpjY.js";import{g as c}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const le={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},ce="/mondes-immerges/accueil/";function S(r){return le[r]||ce}class de{constructor(){this.videos=new Map,this.isActive=!0,this._contextLost=!1,this._playInProgress=new Map,this.checkInterval=null}onContextLost(){this._contextLost=!0,this.stopMonitoring()}onContextRestored(){this._contextLost=!1,this.videos.forEach((e,t)=>{this._tryPlay(t)}),this.startMonitoring()}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement))return;const i={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,onError:t.onError||null,onPlay:t.onPlay||null,name:t.name||"video-"+this.videos.size};e.loop=i.shouldLoop,e.muted=i.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,i),e.addEventListener("ended",()=>{i.shouldLoop&&this.isActive&&!this._contextLost&&(e.currentTime=0,this._tryPlay(e))}),e.addEventListener("play",()=>{i.onPlay&&i.onPlay(e)});let o=0;e.addEventListener("error",s=>{i.onError&&i.onError(s),o<2&&this.isActive&&!this._contextLost&&(o++,setTimeout(()=>{e.load(),e.addEventListener("canplay",()=>this._tryPlay(e),{once:!0})},3e3*o))})}_tryPlay(e){if(!e||!this.isActive||this._contextLost||this._playInProgress.get(e))return;this._playInProgress.set(e,!0);const t=e.play();t&&t.then?t.then(()=>{this._playInProgress.set(e,!1)}).catch(()=>{this._playInProgress.set(e,!1)}):this._playInProgress.set(e,!1)}startMonitoring(e=1e4){this.checkInterval||(this.checkInterval=setInterval(()=>{!this.isActive||this._contextLost||this.videos.forEach((t,i)=>{i.paused&&!i.ended&&t.shouldLoop&&this._tryPlay(i)})},e))}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null)}unregister(e){this.videos.delete(e),this._playInProgress.delete(e)}unregisterAll(){this.videos.clear(),this._playInProgress.clear()}disable(){this.isActive=!1,this.stopMonitoring()}enable(){this.isActive=!0,this.startMonitoring()}destroy(){this.disable(),this.unregisterAll()}}const P=new de;function C(r,...e){console.log(`[GLOBE:${r}]`,performance.now().toFixed(0)+"ms",...e)}function A(r,...e){console.warn(`[GLOBE:${r}]`,performance.now().toFixed(0)+"ms",...e)}function F(r,...e){console.error(`[GLOBE:${r}]`,performance.now().toFixed(0)+"ms",...e)}class ue{constructor(e){C("INIT","Construction GlobeManager, container:",e.containerId),this.options=e,this.container=document.getElementById(e.containerId),this.container||F("INIT","Container introuvable:",e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new B,this.mouse=new Y,this.clock=new X,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new E(100,20,100),moonPosition:new E(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.init()}init(){this.scene=new K;const e=new z(16777215,1.2);this.scene.add(e);const t=new O(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new R(0,15e-5),this.camera=new Z(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const i=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),o=i||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new Q({antialias:!i,alpha:!0,logarithmicDepthBuffer:!o,powerPreference:"high-performance",precision:i?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(i?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!1,this.isMobile=i,this.container.appendChild(this.renderer.domElement);const s=this.renderer.domElement;s.addEventListener("webglcontextlost",n=>{n.preventDefault(),this._contextLost=!0,P.onContextLost()}),s.addEventListener("webglcontextrestored",()=>{this._contextLost=!1,P.onContextRestored()})}catch(i){this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `,this.container.appendChild(e)}setupLighting(){const e=new z(4210768,.5);this.scene.add(e);const t=new O(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!1,this.scene.add(t),this.sunLight=t;const i=new J(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new k,t=e.load("/mondes-immerges/interface/images/sun-texture.jpg"),i=new w(3,32,32),o=new M({map:t,transparent:!0,opacity:.95}),s=new v(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/mondes-immerges/interface/images/moon-texture.jpg"),a=new w(1.5,32,32),l=new ee({map:n}),d=new v(a,l);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,l=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),h=l*Math.sin(n);const p=h*Math.sin(d);h=h*Math.cos(d),e.push(new E(u,p,h))}new te().setFromPoints(e);const i=new w(.2,16,16),o=new M({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new v(i,o),this.scene.add(this.cameraMarker)}createGlobe(){return C("GLOBE","Création du globe..."),new Promise((e,t)=>{const i=document.createElement("video");C("GLOBE","Chemin vidéo:",this.currentVideoPath),i.src=this.currentVideoPath,i.loop=!0,i.muted=!0,i.autoplay=!1,i.playsInline=!0,i.crossOrigin="anonymous",i.preload="auto",this.videoElement=i;let o=!1;const s=setTimeout(()=>{o||(o=!0,e())},1e4);i.addEventListener("canplaythrough",()=>{o||(o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("canplay",()=>{o||(o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("error",m=>{o||(o=!0,clearTimeout(s),e())}),P.register(i,{loop:!0,muted:!0,autoRetry:!0,name:"globe-texture",onError:m=>{},onPlay:()=>{}}),this.videoTexture=new ie(i),this.videoTexture.minFilter=H,this.videoTexture.magFilter=H,this.videoTexture.format=oe,this.videoTexture.colorSpace=se;const n=new w(1.99,64,64),a=new M({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:$}),l=new v(n,a);l.renderOrder=0,this.scene.add(l),this.depthSphere=l;const d=new w(2,64,64),u=new M({map:this.videoTexture,transparent:!0,opacity:1,side:$,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new v(d,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const h=new w(2.02,64,64),p=new M({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new v(h,p),this.clouds.renderOrder=2,this.scene.add(this.clouds),i.load()})}createAtmosphere(){const e=new w(2.15,64,64),t=new N({vertexShader:`
            ...
            `,blending:G,side:j,transparent:!0}),i=new v(e,t);this.scene.add(i),this.atmosphere=i}createSkybox(){return new Promise((e,t)=>{const i=new k,o="/mondes-immerges/interface/images/night-sky.png";let s=!1;const n=setTimeout(()=>{s||(this.scene.background=new T(17),s=!0,e())},8e3);i.load(o,a=>{if(!s){try{this.renderer.toneMapping=ne,this.renderer.toneMappingExposure=.6;const l=this.isMobile?512:1024,d=Math.min(a.image.height,l),u=new ae(d);u.fromEquirectangularTexture(this.renderer,a),this.scene.background=u.texture,a.dispose(),this.scene.fog=new R(17,5e-5)}catch(l){this.scene.background=new T(17)}s=!0,clearTimeout(n),e()}},void 0,a=>{s||(this.scene.background=new T(17),s=!0,clearTimeout(n),e())})})}preloadAllAssets(){return C("PRELOAD","Début préchargement de tous les assets..."),Promise.all([this.createGlobe(),this.createSkybox()]).then(()=>{C("PRELOAD","Tous les assets chargés OK"),this.videoElement?(C("PRELOAD","Lecture vidéo globe..."),this.videoElement.play().catch(e=>{A("PRELOAD","Erreur lecture vidéo:",e.message)})):A("PRELOAD","Pas de videoElement !"),P.startMonitoring(2e3)}).catch(e=>{F("PRELOAD","Erreur préchargement:",e),this.videoElement&&this.videoElement.play().catch(t=>{A("PRELOAD","Erreur lecture vidéo (fallback):",t.message)}),P.startMonitoring(2e3)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,n,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new E(i,n,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{if(this.scene.remove(t),t.userData.label&&t.userData.labelHandlers){const{onMouseEnter:i,onMouseLeave:o,onClick:s}=t.userData.labelHandlers;t.userData.label.removeEventListener("mouseenter",i),t.userData.label.removeEventListener("mouseleave",o),t.userData.label.removeEventListener("click",s)}t.userData.label&&t.userData.label.parentNode&&t.userData.label.parentNode.removeChild(t.userData.label),t.userData.connectorSvg&&t.userData.connectorSvg.parentNode&&t.userData.connectorSvg.parentNode.removeChild(t.userData.connectorSvg),t.userData.labelContainer&&t.userData.labelContainer.parentNode&&t.userData.labelContainer.parentNode.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],document.querySelectorAll(".hotspot-label").forEach(t=>t.remove()),document.querySelectorAll(".hotspot-label-container").forEach(t=>t.remove()),document.querySelectorAll(".connector-line").forEach(t=>t.remove()),e.forEach(t=>{const{position:i,title:o}=t,s=i.lat*(Math.PI/180),n=i.lng*(Math.PI/180),d=2+.15,u=d*Math.cos(s)*Math.cos(n),h=d*Math.sin(s),p=d*Math.cos(s)*Math.sin(n),m=new w(.05,16,16),b=new M({color:16768256,transparent:!0,opacity:0,depthTest:!0,depthWrite:!0,toneMapped:!1}),f=new v(m,b);f.position.set(u,h,p),f.userData={hotspot:t};const y=new w(.08,16,16),I=new M({color:16768256,transparent:!0,opacity:0,side:j,depthTest:!0,depthWrite:!1,toneMapped:!1}),D=new v(y,I);f.add(D),f.userData.materials=[b,I],this.addHotspotLabel(f,o,new E(u,h,p)),this.scene.add(f),this.hotspotObjects.push(f)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label",o.textContent=t,o.style.cssText=`
            position: fixed;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const U=new ye;function xe(){U.init()}function ve(){return U}function g(r,...e){console.log(`[MI:${r}]`,performance.now().toFixed(0)+"ms",...e)}function q(r,...e){console.warn(`[MI:${r}]`,performance.now().toFixed(0)+"ms",...e)}function L(r,...e){console.error(`[MI:${r}]`,performance.now().toFixed(0)+"ms",...e)}g("BOOT","Script principal chargé");const x={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function we(){if(x.webGLChecked)return g("WEBGL","Déjà vérifié"),!0;try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return L("WEBGL","WebGL non supporté"),Ee(),x.webGLChecked=!1,!1;x.webGLChecked=!0,g("WEBGL","WebGL OK — renderer:",e.getParameter(e.RENDERER));const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return L("WEBGL","Erreur vérification WebGL:",r),!1}}function Ee(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
    ...
    `,document.head.appendChild(t)}function qe(){if(x.initialized){g("INIT","Déjà initialisé, skip");return}if(x.initialized=!0,g("INIT","=== INITIALISATION ==="),!we()){L("INIT","WebGL incompatible, arrêt");return}g("INIT","Préparation environnement..."),Se(),["loading-screen","main-container","globe-container","app"].forEach(i=>{document.getElementById(i)?g("INIT",`#${i} OK`):q("INIT",`Élément manquant: #${i}`)});let e=0;const t=setInterval(()=>{e+=12.5,e>=100&&(clearInterval(t),g("INIT","Chargement simulé terminé, démarrage app..."),setTimeout(()=>{Pe()},300))},200)}function ke(){x.cleanupDone||(x.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(g("DOM","DOMContentLoaded déclenché"),x.domReady){q("DOM","DOMContentLoaded déjà traité, skip");return}x.domReady=!0,Me(),setTimeout(()=>{qe()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){q("ERR","Ressource non chargée:",r.target.tagName,r.target.src||r.target.href);return}L("ERR","Erreur globale:",r.message,r.filename,"ligne",r.lineno)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{L("PROMISE","Promise rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",ke,{once:!0});window.addEventListener("pageshow",r=>{(r.persisted||window.performance&&window.performance.navigation.type===2)&&window.location.reload()});
