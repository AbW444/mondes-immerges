import{R as z,V as X,C as _,a as M,S as K,A as O,D as R,F as H,P as Z,W as Q,H as J,T as D,b as E,M as C,c as w,d as ee,B as te,e as ie,L as $,f as oe,g as se,h as N,i as j,j as G,k as V,l as T,m as ne,n as ae,o as F,p as re}from"./three-DErGBpjY.js";import{g as c}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const le={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},ce="/mondes-immerges/accueil/";function k(r){return le[r]||ce}class de{constructor(){this.videos=new Map,this.isActive=!0,this._contextLost=!1,this._playInProgress=new Map,this.checkInterval=null}onContextLost(){this._contextLost=!0,this.stopMonitoring()}onContextRestored(){this._contextLost=!1,this.videos.forEach((e,t)=>{this._tryPlay(t)}),this.startMonitoring()}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement))return;const o={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,onError:t.onError||null,onPlay:t.onPlay||null,name:t.name||"video-"+this.videos.size};e.loop=o.shouldLoop,e.muted=o.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,o),e.addEventListener("ended",()=>{o.shouldLoop&&this.isActive&&!this._contextLost&&(e.currentTime=0,this._tryPlay(e))}),e.addEventListener("play",()=>{o.onPlay&&o.onPlay(e)});let i=0;e.addEventListener("error",s=>{o.onError&&o.onError(s),i<2&&this.isActive&&!this._contextLost&&(i++,setTimeout(()=>{e.load(),e.addEventListener("canplay",()=>this._tryPlay(e),{once:!0})},3e3*i))})}_tryPlay(e){if(!e||!this.isActive||this._contextLost||this._playInProgress.get(e))return;this._playInProgress.set(e,!0);const t=e.play();t&&t.then?t.then(()=>{this._playInProgress.set(e,!1)}).catch(()=>{this._playInProgress.set(e,!1)}):this._playInProgress.set(e,!1)}startMonitoring(e=1e4){this.checkInterval||(this.checkInterval=setInterval(()=>{!this.isActive||this._contextLost||this.videos.forEach((t,o)=>{o.paused&&!o.ended&&t.shouldLoop&&this._tryPlay(o)})},e))}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null)}unregister(e){this.videos.delete(e),this._playInProgress.delete(e)}unregisterAll(){this.videos.clear(),this._playInProgress.clear()}disable(){this.isActive=!1,this.stopMonitoring()}enable(){this.isActive=!0,this.startMonitoring()}destroy(){this.disable(),this.unregisterAll()}}const P=new de;function x(r,...e){console.log(`[GLOBE:${r}]`,performance.now().toFixed(0)+"ms",...e)}function q(r,...e){console.warn(`[GLOBE:${r}]`,performance.now().toFixed(0)+"ms",...e)}function S(r,...e){console.error(`[GLOBE:${r}]`,performance.now().toFixed(0)+"ms",...e)}class ue{constructor(e){x("INIT","Construction GlobeManager, container:",e.containerId),this.options=e,this.container=document.getElementById(e.containerId),this.container||S("INIT","Container introuvable:",e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new z,this.mouse=new X,this.clock=new _,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new M(100,20,100),moonPosition:new M(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.init()}init(){this.scene=new K;const e=new O(16777215,1.2);this.scene.add(e);const t=new R(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new H(0,15e-5),this.camera=new Z(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const o=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),i=o||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new Q({antialias:!o,alpha:!0,logarithmicDepthBuffer:!i,powerPreference:"high-performance",precision:o?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(o?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!1,this.isMobile=o,this.container.appendChild(this.renderer.domElement);const s=this.renderer.domElement;s.addEventListener("webglcontextlost",n=>{n.preventDefault(),this._contextLost=!0,P.onContextLost()}),s.addEventListener("webglcontextrestored",()=>{this._contextLost=!1,P.onContextRestored()})}catch(o){this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e)}setupLighting(){const e=new O(4210768,.5);this.scene.add(e);const t=new R(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!1,this.scene.add(t),this.sunLight=t;const o=new J(35071,65416,.6);this.scene.add(o)}createCelestialBodies(){const e=new D,t=e.load("/mondes-immerges/interface/images/sun-texture.jpg"),o=new E(3,32,32),i=new C({map:t,transparent:!0,opacity:.95}),s=new w(o,i);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/mondes-immerges/interface/images/moon-texture.jpg"),a=new E(1.5,32,32),l=new ee({map:n}),d=new w(a,l);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,l=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),h=l*Math.sin(n);const p=h*Math.sin(d);h=h*Math.cos(d),e.push(new M(u,p,h))}new te().setFromPoints(e);const o=new E(.2,16,16),i=new C({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new w(o,i),this.scene.add(this.cameraMarker)}createGlobe(){return x("GLOBE","Création du globe..."),new Promise((e,t)=>{const o=document.createElement("video");x("GLOBE","Chemin vidéo:",this.currentVideoPath),o.src=this.currentVideoPath,o.loop=!0,o.muted=!0,o.autoplay=!1,o.playsInline=!0,o.crossOrigin="anonymous",o.preload="auto",this.videoElement=o;let i=!1;const s=setTimeout(()=>{i||(i=!0,e())},1e4);o.addEventListener("canplaythrough",()=>{i||(i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("canplay",()=>{i||(i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("error",m=>{i||(i=!0,clearTimeout(s),e())}),P.register(o,{loop:!0,muted:!0,autoRetry:!0,name:"globe-texture",onError:m=>{},onPlay:()=>{}}),this.videoTexture=new ie(o),this.videoTexture.minFilter=$,this.videoTexture.magFilter=$,this.videoTexture.format=oe,this.videoTexture.colorSpace=se;const n=new E(1.99,64,64),a=new C({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:N}),l=new w(n,a);l.renderOrder=0,this.scene.add(l),this.depthSphere=l;const d=new E(2,64,64),u=new C({map:this.videoTexture,transparent:!0,opacity:1,side:N,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new w(d,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const h=new E(2.02,64,64),p=new C({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new w(h,p),this.clouds.renderOrder=2,this.scene.add(this.clouds),o.load()})}createAtmosphere(){const e=new E(2.15,64,64),t=new j({vertexShader:`
            ...
            `,blending:V,side:G,transparent:!0}),o=new w(e,t);this.scene.add(o),this.atmosphere=o}createSkybox(){return new Promise((e,t)=>{const o=new D,i="/mondes-immerges/interface/images/night-sky.png";x("SKYBOX","Chargement texture:",i);let s=!1;const n=setTimeout(()=>{s||(q("SKYBOX","TIMEOUT 15s — fallback couleur unie"),this.scene.background=new T(17),s=!0,e())},15e3);o.load(i,a=>{if(!s){try{x("SKYBOX","Texture chargée OK, dimensions:",a.image.width,"x",a.image.height),this.renderer.toneMapping=ne,this.renderer.toneMappingExposure=.6;const l=this.isMobile?512:1024,d=Math.min(a.image.height,l);x("SKYBOX","Cubemap size:",d,"(max:",l,")");const u=new ae(d);u.fromEquirectangularTexture(this.renderer,a),this.scene.background=u.texture,x("SKYBOX","Skybox appliquée avec succès"),a.dispose(),this.scene.fog=new H(17,5e-5)}catch(l){S("SKYBOX","Erreur création cubemap:",l.message),this.scene.background=new T(17)}s=!0,clearTimeout(n),e()}},a=>{a.lengthComputable&&x("SKYBOX","Progression:",Math.round(a.loaded/a.total*100)+"%")},a=>{s||(S("SKYBOX","ERREUR chargement texture:",a),S("SKYBOX","Chemin tenté:",i),this.scene.background=new T(17),s=!0,clearTimeout(n),e())})})}preloadAllAssets(){return x("PRELOAD","Début préchargement de tous les assets..."),Promise.all([this.createGlobe(),this.createSkybox()]).then(()=>{x("PRELOAD","Tous les assets chargés OK"),this.videoElement?(x("PRELOAD","Lecture vidéo globe..."),this.videoElement.play().catch(e=>{q("PRELOAD","Erreur lecture vidéo:",e.message)})):q("PRELOAD","Pas de videoElement !"),P.startMonitoring(2e3)}).catch(e=>{S("PRELOAD","Erreur préchargement:",e),this.videoElement&&this.videoElement.play().catch(t=>{q("PRELOAD","Erreur lecture vidéo (fallback):",t.message)}),P.startMonitoring(2e3)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let o=e*Math.cos(this.orbitParams.orbitAngle),i=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=i*Math.sin(s);i=i*Math.cos(s),this.camera.position.set(o,n,i),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(o,n,i),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new M(o,n,i)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let o=e*Math.cos(this.orbitParams.orbitAngle),i=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=i*Math.sin(s);i=i*Math.cos(s),this.camera.position.set(o,n,i),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{if(this.scene.remove(t),t.userData.label&&t.userData.labelHandlers){const{onMouseEnter:o,onMouseLeave:i,onClick:s}=t.userData.labelHandlers;t.userData.label.removeEventListener("mouseenter",o),t.userData.label.removeEventListener("mouseleave",i),t.userData.label.removeEventListener("click",s)}t.userData.label&&t.userData.label.parentNode&&t.userData.label.parentNode.removeChild(t.userData.label),t.userData.connectorSvg&&t.userData.connectorSvg.parentNode&&t.userData.connectorSvg.parentNode.removeChild(t.userData.connectorSvg),t.userData.labelContainer&&t.userData.labelContainer.parentNode&&t.userData.labelContainer.parentNode.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],document.querySelectorAll(".hotspot-label").forEach(t=>t.remove()),document.querySelectorAll(".hotspot-label-container").forEach(t=>t.remove()),document.querySelectorAll(".connector-line").forEach(t=>t.remove()),e.forEach(t=>{const{position:o,title:i}=t,s=o.lat*(Math.PI/180),n=o.lng*(Math.PI/180),d=2+.15,u=d*Math.cos(s)*Math.cos(n),h=d*Math.sin(s),p=d*Math.cos(s)*Math.sin(n),m=new E(.05,16,16),b=new C({color:16768256,transparent:!0,opacity:0,depthTest:!0,depthWrite:!0,toneMapped:!1}),f=new w(m,b);f.position.set(u,h,p),f.userData={hotspot:t};const y=new E(.08,16,16),I=new C({color:16768256,transparent:!0,opacity:0,side:G,depthTest:!0,depthWrite:!1,toneMapped:!1}),B=new w(y,I);f.add(B),f.userData.materials=[b,I],this.addHotspotLabel(f,i,new M(u,h,p)),this.scene.add(f),this.hotspotObjects.push(f)})}addHotspotLabel(e,t,o){const i=document.createElement("div");i.className="hotspot-label",i.textContent=t,i.style.cssText=`
            position: fixed;
        ...
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.classList.add("hotspot-connector"),s.style.cssText=`
            ...
            z-index: 50;
            opacity: 0;
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(i),document.body.appendChild(s);const a=()=>{i.style.backgroundColor="rgba(255, 204, 0, 0.9)",i.style.color="#000",i.style.transform="scale(1.05)"},l=()=>{i.style.backgroundColor="rgba(0, 0, 0, 0.8)",i.style.color="#ffdd00",i.style.transform="scale(1)"},d=u=>{u.stopPropagation();const h=e.userData.hotspot;h&&this.activateHotspot(h)};i.addEventListener("mouseenter",a),i.addEventListener("mouseleave",l),i.addEventListener("click",d),e.userData.label=i,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=o.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:l,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const i=t[0].point,n=Math.acos(i.y/2),a=Math.atan2(i.z,i.x),l=90-n*180/Math.PI,d=a*180/Math.PI-180,u=this._findNearestHotspot(l,d,10);if(u){this.activateHotspot(u);return}}const o=this.raycaster.intersectObjects(this.hotspotObjects);if(o.length>0){const i=o[0].object.userData.hotspot;this.activateHotspot(i)}}_findNearestHotspot(e,t,o){let i=null,s=o;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const l=a.position.lat,d=a.position.lng,u=Math.sqrt(Math.pow(l-e,2)+Math.pow(d-t,2));u<s&&(s=u,i=a)}return i}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;const t=e.position.lat*(Math.PI/180),o=e.position.lng*(Math.PI/180),i=2.1,s=i*Math.cos(t)*Math.cos(o),n=i*Math.sin(t),a=i*Math.cos(t)*Math.sin(o),l=new M(s,n,a);this.orbitParams.isOrbiting=!1;const d=this.camera.position.clone(),p=l.clone().normalize().multiplyScalar(5.2),m=new M().addVectors(d,p).multiplyScalar(.5);m.normalize().multiplyScalar(m.length()+1.8);const f=c.timeline();f.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}});let y=document.getElementById("fade-overlay");y||(y=document.createElement("div"),y.id="fade-overlay",y.style.cssText=`
                position: fixed;
                top: 0;
                left: 0;
                width: 100%;
                ...
                z-index: 98000;
                pointer-events: none;
            `,document.body.appendChild(y)),f.to(this.camera.position,{x:p.x,y:p.y,z:p.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),f.to(y,{opacity:1,duration:.8,ease:"power2.in"},"-=0.8"),f.to(this.camera,{fov:55,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){this.playTransitionVideoAndRedirect(e.id)}playTransitionVideoAndRedirect(e){const t=document.getElementById("transition-video-out");if(!t){const o=k(e);window.location.href=o;return}t.classList.add("active"),t.currentTime=0,t.play().then(()=>{t.addEventListener("ended",()=>{const o=k(e);window.location.href=o},{once:!0})}).catch(o=>{const i=k(e);window.location.href=i}),setTimeout(()=>{const o=k(e);window.location.href=o},1e4)}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),o=(e.lng+180)*(Math.PI/180),i=-(2.1*Math.sin(t)*Math.cos(o)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(o),a=new F(0,.3,32),l=new j({uniforms:{color:{value:new T(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
           ...
           `,side:re,transparent:!0,blending:V,depthWrite:!1}),d=new w(a,l);d.position.set(i,s,n),d.lookAt(0,0,0),this.scene.add(d);let u=performance.now();const h=()=>{const p=(performance.now()-u)/1e3;l.uniforms.time.value=p,p<2?requestAnimationFrame(h):(this.scene.remove(d),d.geometry.dispose(),l.dispose())};h(),c.to(d.scale,{x:4,y:4,z:1,duration:2,ease:"power1.out"}),c.to(l.uniforms.color.value,{r:1,g:.8,b:.2,duration:2,ease:"power1.out"})}exitHotspotMode(){this.orbitParams.inHotspotMode&&(this.orbitParams.inHotspotMode=!1,c.to(this.camera,{fov:60,duration:1,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}}),setTimeout(()=>{this.orbitParams.isOrbiting=!0,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed},500))}exitHotspotModeExternal(){this.exitHotspotMode()}handleVideoError(){new D().load("/mondes-immerges/interface/images/video-placeholder.jpg",t=>{this.globe&&this.globe.material&&(this.globe.material.uniforms&&this.globe.material.uniforms.map?this.globe.material.uniforms.map.value=t:this.globe.material.map=t,this.globe.material.needsUpdate=!0)})}zoom(e){const t=e?.85:1.15,o=this.orbitParams.zoomLevel*t;this.orbitParams.zoomLevel=Math.min(Math.max(o,this.orbitParams.minZoomLevel),this.orbitParams.maxZoomLevel),c.to(this.camera.position,{x:this.camera.position.x*t,y:this.camera.position.y*t,z:this.camera.position.z*t,duration:.5,ease:"back.out(1.2)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}resetView(){this.orbitParams.zoomLevel=1,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed;const e=this.orbitParams.ellipseMajorAxis,t=this.orbitParams.ellipseMinorAxis,o=this.orbitParams.inclination,i=this.orbitParams.orbitAngle,s=e*Math.cos(i),n=t*Math.sin(i),a=n*Math.sin(o),l=n*Math.cos(o);c.to(this.camera.position,{x:s,y:a,z:l,duration:1,ease:"elastic.out(1, 0.7)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}setHotspotSelectCallback(e){this.onHotspotSelect=e}setHotspotExitCallback(e){this.onHotspotExit=e}updateHotspotLabels(){if(this.orbitParams.inHotspotMode){this.hotspotObjects.forEach(e=>{e.userData.label&&(e.userData.label.style.opacity="0"),e.userData.connectorSvg&&(e.userData.connectorSvg.style.opacity="0")});return}this.hotspotObjects.forEach(e=>{if(!e.userData.label||!e.userData.worldPosition)return;const t=e.userData.worldPosition,o=t.clone().project(this.camera);if(o.z>1||o.x<-1||o.x>1||o.y<-1||o.y>1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}const i=new M().subVectors(t,this.camera.position).normalize(),n=new z(this.camera.position,i).intersectObject(this.globe);if(n.length>0){const y=n[0].distance,I=this.camera.position.distanceTo(t);if(y<I-.1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}}const a=(o.x*.5+.5)*window.innerWidth,l=(-o.y*.5+.5)*window.innerHeight,d=e.userData.labelText.length*7,u=40,h=-15;let p=a+u,m=l+h;const b=10;p+d>window.innerWidth-b&&(p=a-u-d),p<b&&(p=b),m<b&&(m=b),m>window.innerHeight-b&&(m=window.innerHeight-b),e.userData.label.style.left=`${p}px`,e.userData.label.style.top=`${m}px`,this.labelsVisible&&(e.userData.label.style.opacity="1");const f=e.userData.connectorLine;f&&(f.setAttribute("x1",a),f.setAttribute("y1",l),f.setAttribute("x2",p),f.setAttribute("y2",m+10),this.labelsVisible&&(e.userData.connectorSvg.style.opacity="1"))})}showLabels(){this.labelsVisible=!0,this.hotspotObjects.forEach((e,t)=>{e.userData.materials&&e.userData.materials.forEach((o,i)=>{const s=i===0?.8:.5;c.to(o,{opacity:s,duration:.8,delay:t*.1,ease:"power2.out"})})})}animate(){if(requestAnimationFrame(this.animate.bind(this)),this._contextLost)return;const e=this.clock.getDelta(),t=this.clock.getElapsedTime()*1e3;this.orbitParams.isOrbiting&&!this.orbitParams.inHotspotMode&&this.updateCameraPosition(),this.updateSkyboxTime&&this.updateSkyboxTime(t),this.hotspotObjects.forEach(o=>{const i=o.userData.waveRings;i&&i.forEach(s=>{s.userData.waveTime+=e;const n=s.userData.waveTime-s.userData.initialDelay;if(n>0){const l=n%2.5/2.5,d=.05,h=d+(.18-d)*l;s.geometry.dispose(),s.geometry=new F(h,h+.02,32),s.material.opacity=.7*(1-l)}})}),this.updateHotspotLabels(),this.clouds&&(this.clouds.rotation.y+=1e-4),this.globe&&!this.orbitParams.inHotspotMode&&(this.globe.rotation.y+=2e-4),this.globe&&this.globe.material.uniforms&&this.globe.material.uniforms.time&&(this.globe.material.uniforms.time.value=t),this.renderer.render(this.scene,this.camera)}}class pe{constructor(e){this.container=e.container,this.effectsContainer=null,this.notificationContainer=null,this.init()}init(){this.effectsContainer=document.createElement("div"),this.effectsContainer.classList.add("effects-container"),this.effectsContainer.style.position="absolute",this.effectsContainer.style.top="0",this.effectsContainer.style.left="0",this.effectsContainer.style.width="100%",this.effectsContainer.style.height="100%",this.effectsContainer.style.pointerEvents="none",this.effectsContainer.style.zIndex="5",this.container.appendChild(this.effectsContainer),this.createNotificationContainer()}createNotificationContainer(){this.notificationContainer=document.createElement("div"),this.notificationContainer.className="notification-container",this.notificationContainer.style.cssText=`
            position: absolute;
            bottom: 30px;
            right: 30px;
            display: flex;
        ...
        `,this.container.appendChild(this.notificationContainer)}transitionIn(){const e=document.createElement("div");e.classList.add("transition-overlay"),e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.backgroundColor="#000000",e.style.zIndex="10",this.effectsContainer.appendChild(e),c.fromTo(e,{opacity:1},{opacity:0,duration:1.5,ease:"power2.out",onComplete:()=>{e.remove()}})}transitionOut(e){const t=document.createElement("div");t.classList.add("transition-overlay"),t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor="#000000",t.style.zIndex="10",t.style.opacity="0",this.effectsContainer.appendChild(t),c.to(t,{opacity:1,duration:1,ease:"power2.in",onComplete:()=>{e&&e()}})}createOrbitalLoaderEffect(e,t=4,o=null){const i=document.createElement("div");i.className="orbital-loader",o?i.style.cssText=`
            ...
            justify-content: center;
            align-items: center;
        `;for(let u=0;u<3;u++){const h=document.createElement("div");h.style.cssText=`
                position: absolute;
                border-radius: 50%;
            ...
            `;for(let p=0;p<3+u;p++){const m=document.createElement("div"),b=360/(3+u)*p;m.style.cssText=`
                    position: absolute;
                    width: ${8-u}px;
                    height: ${8-u}px;
                    ...
                    transform: translate(-50%, -50%) rotate(${b}deg) translateX(${60+u*20}px);
                `,h.appendChild(m)}s.appendChild(h)}const n=document.createElement("div");n.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,s.appendChild(a),i.appendChild(s);const l=document.createElement("style");l.textContent=`
            @keyframes orbit0 {
        ...
        `,document.head.appendChild(l),(o||this.effectsContainer).appendChild(i),c.fromTo(i,{opacity:0},{opacity:1,duration:.5,onComplete:()=>{o&&e&&e()}}),setTimeout(()=>{o?(i.remove(),l.remove()):c.to(i,{opacity:0,duration:1,onComplete:()=>{i.remove(),l.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),c.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{c.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const i={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let s=0;s<i.pulseCount;s++)setTimeout(()=>{const n=document.createElement("div");n.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
                    ...
                    z-index: 100;
                    pointer-events: none;
                `,this.effectsContainer.appendChild(n),c.to(n,{width:i.radius*2,height:i.radius*2,opacity:0,duration:i.duration,ease:"power2.out",onComplete:()=>{n.remove()}})},s*(i.duration*300))}flashScreen(e="#ffffff"){const t=document.createElement("div");t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor=e,t.style.pointerEvents="none",t.style.zIndex="20",t.style.opacity="0",this.effectsContainer.appendChild(t),c.timeline().to(t,{opacity:.7,duration:.1}).to(t,{opacity:0,duration:.3,onComplete:()=>{t.remove()}})}showNotification(e,t="info",o=3e3){this.notificationContainer||this.createNotificationContainer();const i=document.createElement("div");i.className="notification";let s="",n="#2196F3";switch(t){case"success":s="✓",n="#4CAF50";break;case"warning":s="!",n="#FF9800";break;case"error":s="✗",n="#F44336";break;default:s="i",n="#2196F3"}i.innerHTML=`
        ...
        `;const a=i.querySelector(".notification-icon");a&&(a.style.cssText=`
            ...
            `);const l=i.querySelector(".notification-message");l&&(l.style.cssText=`
                flex: 1;
                line-height: 1.4;
            `),this.notificationContainer.appendChild(i),c.fromTo(i,{opacity:0,x:50},{opacity:1,x:0,duration:.4,ease:"power2.out"}),setTimeout(()=>{c.to(i,{opacity:0,x:50,duration:.4,ease:"power2.in",onComplete:()=>{i.remove()}})},o)}showSystemMessage(e){const t=document.createElement("div");t.className="system-message",t.textContent=e,t.style.cssText=`
            position: absolute;
            bottom: 20px;
            right: 20px;
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const o={...{count:50,container:this.container},...e},i=document.createElement("div");i.className="background-particles",i.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<o.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,l=Math.random()*100,d=Math.random()*100,u=Math.random()*5,h=Math.random()*10+10,p=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
                ...
                top: ${d}%;
                left: ${l}%;
                box-shadow: 0 0 ${a*2}px rgba(255, 255, 255, ${p*.8});
            `,c.to(n,{y:`${Math.random()*20-10}%`,x:`${Math.random()*20-10}%`,opacity:Math.random()*.5+.1,duration:h,delay:u,repeat:-1,yoyo:!0,ease:"sine.inOut"}),i.appendChild(n)}o.container.appendChild(i)}}class he{constructor(e){this.globeManager=e.globeManager,this.visualEffects=e.visualEffects,this.isDragging=!1,this.lastTouchTime=0,this.touchTimeout=null,this.mouseStartY=0,this.mouseStartX=0,this.scrollAmount=0,this.lastPosition={x:0,y:0},this.scrollTimerId=null,this.scrollSpeed=0,this.lastScrollTime=0,this.scrollAccumulator=0,this.inertiaEnabled=!0,this.velocityX=0,this.velocityY=0,this.inertiaAnimationId=null,this.zoomInertia=0,this.initialDistance=0,this.currentDistance=0,this.isPinching=!1,this.movementThreshold=5,this.swipeThreshold=80,this.hasMoved=!1,this.interfaceVisible=!0,this.autoHideTimeout=null,this.init()}init(){const e=this.globeManager.container;e.addEventListener("wheel",this.handleMouseWheel.bind(this),{passive:!1}),e.addEventListener("mousedown",this.handleMouseDown.bind(this)),document.addEventListener("mousemove",this.handleMouseMove.bind(this)),document.addEventListener("mouseup",this.handleMouseUp.bind(this)),e.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),e.addEventListener("touchmove",this.handleTouchMove.bind(this),{passive:!1}),e.addEventListener("touchend",this.handleTouchEnd.bind(this)),document.addEventListener("keydown",this.handleKeyDown.bind(this)),document.addEventListener("mousemove",this.resetInterfaceAutoHide.bind(this)),this.startInterfaceAutoHide()}handleMouseDown(e){this.isDragging=!0,this.hasMoved=!1,this.mouseStartX=e.clientX,this.mouseStartY=e.clientY,this.lastPosition={x:e.clientX,y:e.clientY},this.velocityX=0,this.velocityY=0,this.inertiaAnimationId&&(cancelAnimationFrame(this.inertiaAnimationId),this.inertiaAnimationId=null)}handleMouseMove(e){if(!this.isDragging)return;const t=e.clientX,o=e.clientY,i=t-this.lastPosition.x,s=o-this.lastPosition.y;(Math.abs(i)>this.movementThreshold||Math.abs(s)>this.movementThreshold)&&(this.hasMoved=!0),this.velocityX=.8*this.velocityX+.2*i,this.velocityY=.8*this.velocityY+.2*s,this.globeManager.orbitParams.orbitAngle-=i*.005;const n=this.globeManager.orbitParams.inclination+s*.003;this.globeManager.orbitParams.inclination=Math.max(.1,Math.min(Math.PI/3,n)),this.lastPosition={x:t,y:o},typeof this.globeManager._updateCameraPositionManual=="function"&&this.globeManager._updateCameraPositionManual()}handleMouseUp(e){this.isDragging&&(this.isDragging=!1,this.inertiaEnabled&&this.hasMoved&&(Math.abs(this.velocityX)>1||Math.abs(this.velocityY)>1)&&this.startInertia())}startInertia(){const t=()=>{if(this.velocityX*=.95,this.velocityY*=.95,Math.abs(this.velocityX)<.1&&Math.abs(this.velocityY)<.1){this.inertiaAnimationId=null;return}this.globeManager.orbitParams.orbitAngle-=this.velocityX*.005;const o=this.globeManager.orbitParams.inclination+this.velocityY*.003;this.globeManager.orbitParams.inclination=Math.max(.1,Math.min(Math.PI/3,o)),typeof this.globeManager._updateCameraPositionManual=="function"&&this.globeManager._updateCameraPositionManual(),this.inertiaAnimationId=requestAnimationFrame(t)};this.inertiaAnimationId=requestAnimationFrame(t)}handleTouchStart(e){e.touches.length===1?(this.isDragging=!0,this.hasMoved=!1,this.mouseStartX=e.touches[0].clientX,this.mouseStartY=e.touches[0].clientY,this.lastPosition={x:e.touches[0].clientX,y:e.touches[0].clientY},this.scrollAmount=0,this.velocityX=0,this.velocityY=0,this.inertiaAnimationId&&(cancelAnimationFrame(this.inertiaAnimationId),this.inertiaAnimationId=null)):e.touches.length===2&&(this.isPinching=!0,this.initialDistance=this.getTouchDistance(e.touches))}getTouchDistance(e){const t=e[0].clientX-e[1].clientX,o=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+o*o)}handleTouchEnd(e){this.isPinching&&e.touches.length<2&&(this.isPinching=!1),e.touches.length===0&&(this.isDragging=!1,this.inertiaEnabled&&this.hasMoved&&(Math.abs(this.velocityX)>1||Math.abs(this.velocityY)>1)&&this.startInertia())}handleTouchMove(e){if(e.preventDefault(),this.isPinching&&e.touches.length===2){this.currentDistance=this.getTouchDistance(e.touches);const t=this.currentDistance/this.initialDistance;t>1.05?(this.globeManager.zoom(!0),this.initialDistance=this.currentDistance):t<.95&&(this.globeManager.zoom(!1),this.initialDistance=this.currentDistance);return}if(!(!this.isDragging||e.touches.length!==1))if(this.globeManager.orbitParams.inHotspotMode){const t=e.touches[0].clientY,o=t-this.mouseStartY;this.scrollAmount+=o,this.scrollAmount>150&&(this.globeManager.exitHotspotModeExternal(),this.scrollAmount=0),this.mouseStartY=t}else{const t=e.touches[0].clientX,o=e.touches[0].clientY,i=t-this.lastPosition.x,s=o-this.lastPosition.y;(Math.abs(i)>this.movementThreshold||Math.abs(s)>this.movementThreshold)&&(this.hasMoved=!0),this.velocityX=.8*this.velocityX+.2*i,this.velocityY=.8*this.velocityY+.2*s,this.globeManager.orbitParams.orbitAngle-=i*.005;const n=this.globeManager.orbitParams.inclination+s*.003;this.globeManager.orbitParams.inclination=Math.max(.1,Math.min(Math.PI/3,n)),this.lastPosition={x:t,y:o},typeof this.globeManager._updateCameraPositionManual=="function"&&this.globeManager._updateCameraPositionManual()}}handleMouseWheel(e){e.preventDefault(),this.showInterface(),this.resetInterfaceAutoHide();let t=e.deltaY;if(e.deltaMode===1&&(t*=40),e.deltaMode===2&&(t*=800),this.globeManager.orbitParams.orbitAngle+=t*8e-4,e.deltaX!==0){let o=e.deltaX;e.deltaMode===1&&(o*=40),e.deltaMode===2&&(o*=800);const i=this.globeManager.orbitParams.inclination-o*5e-4;this.globeManager.orbitParams.inclination=Math.max(.1,Math.min(Math.PI/3,i))}typeof this.globeManager._updateCameraPositionManual=="function"&&this.globeManager._updateCameraPositionManual()}handleKeyDown(e){switch(this.showInterface(),this.resetInterfaceAutoHide(),e.key){case"Escape":this.globeManager.orbitParams.inHotspotMode&&(this.globeManager.exitHotspotModeExternal(),this.visualEffects&&(this.visualEffects.flashScreen("rgba(0, 0, 0, 0.4)"),this.visualEffects.showNotification("Retour à l'exploration globale","info",2e3)));break;case"ArrowUp":case"ArrowDown":case"ArrowLeft":case"ArrowRight":e.preventDefault(),this.globeManager.orbitParams.inHotspotMode&&e.key==="ArrowDown"?(this.globeManager.exitHotspotModeExternal(),this.visualEffects&&(this.visualEffects.flashScreen("rgba(0, 0, 0, 0.4)"),this.visualEffects.showNotification("Retour à l'exploration globale","info",2e3))):this.handleArrowNavigation(e.key);break;case"+":case"=":this.globeManager.zoom(!0);break;case"-":case"_":this.globeManager.zoom(!1);break;case"r":case"R":this.globeManager.resetView(),this.visualEffects&&(this.visualEffects.flashScreen("rgba(255, 255, 255, 0.2)"),this.visualEffects.showNotification("Vue réinitialisée","info",2e3));break;case"h":case"H":this.toggleInterface();break}}handleArrowNavigation(e){try{const t=this.globeManager.orbitParams.orbitAngle,o=this.globeManager.orbitParams.isOrbiting;switch(this.globeManager.orbitParams.isOrbiting=!1,e){case"ArrowLeft":this.globeManager.orbitParams.orbitAngle+=.05;break;case"ArrowRight":this.globeManager.orbitParams.orbitAngle-=.05;break;case"ArrowUp":if(!this.globeManager.orbitParams.inHotspotMode){const i=this.globeManager.orbitParams.inclination;this.globeManager.orbitParams.inclination=Math.min(i+.03,Math.PI/3)}break;case"ArrowDown":if(!this.globeManager.orbitParams.inHotspotMode){const i=this.globeManager.orbitParams.inclination;this.globeManager.orbitParams.inclination=Math.max(i-.03,.1)}break}typeof this.globeManager._updateCameraPositionManual=="function"&&this.globeManager._updateCameraPositionManual(),setTimeout(()=>{this.globeManager.orbitParams.isOrbiting=o},500)}catch(t){this.globeManager&&this.globeManager.orbitParams&&(this.globeManager.orbitParams.orbitAngle=backupAngle,this.globeManager.orbitParams.isOrbiting=!0)}}startInterfaceAutoHide(){this.autoHideTimeout&&clearTimeout(this.autoHideTimeout),this.autoHideTimeout=setTimeout(()=>{this.hideInterface()},1e4)}resetInterfaceAutoHide(){this.showInterface(),this.startInterfaceAutoHide()}hideInterface(){if(!this.interfaceVisible)return;this.interfaceVisible=!1;const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),o=document.querySelector(".satellite-crosshair");c.to(e,{opacity:0,y:20,duration:.5,ease:"power2.inOut"}),c.to([...t,o],{opacity:0,duration:.5,ease:"power2.inOut"}),setTimeout(()=>{this.interfaceVisible||(e.style.pointerEvents="none")},500)}showInterface(){if(this.interfaceVisible)return;this.interfaceVisible=!0;const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),o=document.querySelector(".satellite-crosshair");e.style.pointerEvents="auto",c.to(e,{opacity:1,y:0,duration:.5,ease:"power2.out"}),c.to([...t,o],{opacity:1,duration:.5,ease:"power2.out"})}toggleInterface(){this.interfaceVisible?this.hideInterface():(this.showInterface(),this.startInterfaceAutoHide())}}class me{constructor(e){this.options=e,this.zoomInBtn=e.zoomInBtn,this.zoomOutBtn=e.zoomOutBtn,this.resetViewBtn=e.resetViewBtn,this.infoBtn=e.infoBtn,this.closeInfoBtn=e.closeInfoBtn,this.infoOverlay=e.infoOverlay,this.globeManager=e.globeManager,this.isInfoVisible=!1,this.buttons=[],this.notificationContainer=null,this.init()}init(){this.applyEnhancedStyles(),this.buttons=[this.zoomInBtn,this.zoomOutBtn,this.resetViewBtn,this.infoBtn],this.zoomInBtn.addEventListener("click",()=>{this.globeManager.zoom(!0),this.animateButtonClick(this.zoomInBtn)}),this.zoomOutBtn.addEventListener("click",()=>{this.globeManager.zoom(!1),this.animateButtonClick(this.zoomOutBtn)}),this.resetViewBtn.addEventListener("click",()=>{this.globeManager.resetView(),this.animateButtonClick(this.resetViewBtn)}),this.infoBtn.addEventListener("click",()=>{this.toggleInfoOverlay(),this.animateButtonClick(this.infoBtn)}),this.closeInfoBtn.addEventListener("click",()=>{this.hideInfoOverlay()}),this.createNotificationContainer(),this.animateButtonsIn()}applyEnhancedStyles(){const e=document.getElementById("ui-controls");e&&(e.style.cssText=`
                position: absolute;
                bottom: 30px;
                left: 30px;
                z-index: 50;
...
`),(t?t.querySelectorAll("button"):[]).forEach(i=>{i.style.cssText=`
            ...
            `,i.addEventListener("mouseenter",()=>{c.to(i,{backgroundColor:"rgba(255, 204, 0, 0.9)",color:"#000000",borderColor:"#ffcc00",boxShadow:"0 2px 15px rgba(255, 204, 0, 0.5), 0 0 8px rgba(255, 204, 0, 0.7)",duration:.25})}),i.addEventListener("mouseleave",()=>{c.to(i,{backgroundColor:"rgba(0, 10, 30, 0.7)",color:"#ffcc00",borderColor:"rgba(255, 204, 0, 0.7)",boxShadow:"0 2px 10px rgba(0, 0, 0, 0.3), 0 0 4px rgba(255, 204, 0, 0.4)",duration:.3})})}),this.infoBtn&&(this.infoBtn.style.cssText=`
                width: 50px;
                height: 50px;
                border-radius: 50%;
        ...
        `;i.querySelector(".notification-icon").style.cssText=a,i.querySelector(".notification-message").style.cssText=`
            flex: 1;
            line-height: 1.4;
        `,this.notificationContainer.appendChild(i),c.fromTo(i,{opacity:0,x:50},{opacity:1,x:0,duration:.4,ease:"power2.out"}),setTimeout(()=>{c.to(i,{opacity:0,x:50,duration:.4,ease:"power2.in",onComplete:()=>{i.remove()}})},o)}setUIVisibility(e){const t=e?1:0,o=e?0:20,i=e?"auto":"none",s=document.getElementById("ui-controls");s&&c.to(s,{opacity:t,y:o,duration:.4,ease:e?"power2.out":"power2.in",onComplete:()=>{s.style.pointerEvents=i}}),document.querySelectorAll(".satellite-hud, .coordinates-display").forEach(a=>{c.to(a,{opacity:t,duration:.4,ease:e?"power2.out":"power2.in"})})}showTooltip(e,t,o={}){const s={...{position:"top",duration:3e3,offset:10,className:""},...o},n=document.createElement("div");n.className=`tooltip ${s.className}`,n.textContent=t,n.style.cssText=`
            position: absolute;
        ...
        `,o.appendChild(i),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(l=>{const d=document.createElement("div");d.className="minimap-dot",d.dataset.id=l.id,d.title=l.name,d.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,d.addEventListener("mouseenter",()=>{c.to(d,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(d,l.name,{position:"top",duration:2e3})}),d.addEventListener("mouseleave",()=>{c.to(d,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),d.addEventListener("click",()=>{t&&t(l.id)}),o.appendChild(d)});const n=document.createElement("div");n.className="minimap-toggle",n.innerHTML="−",n.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
            ...
            font-weight: bold;
            z-index: 1;
        `;let a=!1;return n.addEventListener("click",()=>{a?(c.to(o,{height:100,duration:.3,ease:"power2.out"}),n.innerHTML="−"):(c.to(o,{height:30,duration:.3,ease:"power2.out"}),n.innerHTML="+"),a=!a}),o.appendChild(n),e.appendChild(o),c.fromTo(o,{y:50,opacity:0},{y:0,opacity:1,duration:.5,ease:"power2.out"}),{highlight:l=>{const d=o.querySelector(`.minimap-dot[data-id="${l}"]`);d&&c.to(d,{width:12,height:12,backgroundColor:"#ffffff",boxShadow:"0 0 15px rgba(255, 255, 255, 0.9)",duration:.5,repeat:3,yoyo:!0})},hide:()=>{c.to(o,{y:50,opacity:0,duration:.3,ease:"power2.in",onComplete:()=>{o.remove()}})},element:o}}}class fe{constructor(e){this.panel=e.panel,this.closeBtn=e.closeBtn,this.titleElement=e.titleElement,this.descriptionElement=e.descriptionElement,this.videoElement=e.videoElement,this.globeManager=e.globeManager,this.isVisible=!1,this.drawerToggle=null,this.drawer=null,this.drawerContent=null,this.isDrawerOpen=!1,this.panel&&this.closeBtn&&this.titleElement&&this.descriptionElement?this.init():(this.show=()=>{},this.hide=()=>{},this.update=()=>{})}init(){this.applyDesignSystem(),this.closeBtn&&this.closeBtn.addEventListener("click",()=>{this.hide(),this.globeManager.exitHotspotModeExternal()}),this.videoElement&&(this.videoElement.addEventListener("loadeddata",()=>{c.fromTo(this.videoElement,{opacity:0},{opacity:1,duration:.8,ease:"power2.out"})}),this.videoElement.addEventListener("error",()=>{this.videoElement.style.display="none";const e=document.createElement("img");e.src="/mondes-immerges/interface/images/video-placeholder.jpg",e.alt="Vidéo non disponible",e.style.width="100%",e.style.borderRadius="3px";const t=this.videoElement.parentElement;t&&t.appendChild(e)})),this.createDrawerElements()}applyDesignSystem(){if(!this.panel)return;this.panel.style.cssText=`
            position: absolute;
            top: 5%;
            right: 5%;
            width: 380px;
        ...
        `,videoSrc:"/mondes-immerges/interface/videos/grande-barriere.mp4",scientificData:{depth:{min:15,max:45,avg:35},temperature:{min:23.5,max:28.5,avg:25.7},biodiversity:"Exceptionnelle",conservationStatus:"En danger critique",area:"348,000 km²",discoveryYear:1770,phValue:{min:8.1,max:8.4},salinity:"34-35‰"},detailedInfo:`
        ...
        `,videoSrc:"/mondes-immerges/interface/videos/triangle-corail.mp4",scientificData:{area:"5,7 millions km²",depth:{min:10,max:200,avg:53},temperature:{min:26,max:29,avg:27.6},biodiversity:"Exceptionnelle",conservationStatus:"En danger",coralSpecies:"605 (76% du total mondial)",fishSpecies:"2228+",economicValue:"1,2 billion USD/an"},detailedInfo:`
        ...
        `,evolutionData:[{year:1970,sharkPopulation:1},{year:1990,sharkPopulation:.8},{year:2e3,sharkPopulation:.68},{year:2010,sharkPopulation:.55},{year:2020,sharkPopulation:.44},{year:2025,sharkPopulation:.39,projected:!0}],sources:[{title:"État des populations de requins (IUCN Shark Specialist Group)",url:"https://www.iucnssg.org/"},{title:"Impact de la disparition des grands prédateurs marins (Shark Trust)",url:"https://www.sharktrust.org/"},{title:"Sanctuaires de requins et protection (PEW Charitable Trusts)",url:"https://www.pewtrusts.org/en/projects/global-shark-conservation"}]}];function ge(r){return Y.find(e=>e.id===r)||null}class be{constructor(){this.globeManager=null,this.visualEffects=null,this.interaction=null,this.interfaceUI=null,this.contentPanel=null,this.isInitialized=!1,this.isExploring=!1,this.currentHotspot=null,this.explorationHistory=[],this.welcomeScreen=document.getElementById("welcome-screen"),this.mainContainer=document.getElementById("main-container"),this.loadingScreen=document.getElementById("loading-screen")}init(){if(this.isInitialized)return;this.isInitialized=!0,this.visualEffects=new pe({container:this.mainContainer}),this.globeManager=new ue({containerId:"globe-container",videoPath:"/mondes-immerges/interface/videos/globe-video.mp4",skyTexturePath:"/mondes-immerges/interface/images/night-sky.png"}),this.interaction=new he({globeManager:this.globeManager,visualEffects:this.visualEffects}),this.interfaceUI=new me({zoomInBtn:document.getElementById("zoom-in"),zoomOutBtn:document.getElementById("zoom-out"),resetViewBtn:document.getElementById("reset-view"),infoBtn:document.getElementById("info-button"),closeInfoBtn:document.getElementById("close-info"),infoOverlay:document.getElementById("info-overlay"),globeManager:this.globeManager});const e={panel:document.getElementById("content-panel"),closeBtn:document.getElementById("close-panel"),titleElement:document.getElementById("hotspot-title"),descriptionElement:document.getElementById("hotspot-description"),videoElement:document.getElementById("hotspot-video"),globeManager:this.globeManager};e.panel&&e.closeBtn&&e.titleElement&&e.descriptionElement?this.contentPanel=new fe(e):this.contentPanel={show:()=>{},hide:()=>{},update:()=>{}},this.globeManager.setHotspotSelectCallback(this.handleHotspotSelect.bind(this)),this.globeManager.setHotspotExitCallback(this.handleHotspotExit.bind(this)),this.globeManager.animate(),this.globeManager.addHotspots(Y),this.initSatelliteInterface(),this.setupEventListeners(),this.addNatGeoLogo()}setupEventListeners(){const e=document.getElementById("explore-btn");e&&e.addEventListener("click",()=>{this.startExploration()}),document.addEventListener("keydown",t=>{t.key===" "&&!this.isExploring&&this.startExploration(),t.key==="Escape"&&(this.currentHotspot?(this.globeManager.exitHotspotModeExternal(),this.currentHotspot=null):this.isExploring)}),window.addEventListener("resize",this.handleResize.bind(this))}startExploration(e=!1){this.isExploring||(this.welcomeScreen&&this.welcomeScreen.classList.add("hidden"),this.mainContainer&&this.mainContainer.classList.remove("hidden"),e?this.isExploring=!0:(this.visualEffects.transitionIn(),setTimeout(()=>{this.startupSequence()},1e3),this.isExploring=!0))}returnToWelcomeScreen(){this.isExploring&&this.visualEffects.transitionOut(()=>{this.mainContainer&&this.mainContainer.classList.add("hidden"),this.welcomeScreen&&this.welcomeScreen.classList.remove("hidden"),this.isExploring=!1,this.currentHotspot=null,this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide(),this.globeManager&&this.globeManager.resetView()})}handleResize(){this.globeManager&&this.globeManager.renderer&&this.globeManager.onWindowResize()}addNatGeoLogo(){if(this.mainContainer.querySelector(".nat-geo-logo-container"))return;const t=document.createElement("div");t.className="nat-geo-logo-container",t.style.cssText=`
            position: absolute;
            top: 20px;
            left: 50%;
            transform: translateX(-50%);
            z-index: 1000;
        `;const o=document.createElement("img");o.src="/mondes-immerges/interface/images/nat-geo-logo.png",o.alt="National Geographic",o.className="nat-geo-logo",o.style.cssText=`
            height: 50px;
            width: auto;
            display: block;
            filter: drop-shadow(0 2px 8px rgba(0, 0, 0, 0.5));
        `,t.appendChild(o),this.mainContainer.appendChild(t)}initSatelliteInterface(){const e=document.getElementById("coord-lat"),t=document.getElementById("coord-lng"),o=document.getElementById("zoom-level"),i=document.getElementById("orbit-status"),s=document.getElementById("altitude-value"),n=document.getElementById("current-date"),a=document.getElementById("current-time");setInterval(()=>{const l=new Date,d={day:"2-digit",month:"2-digit",year:"numeric"};n&&(n.textContent=l.toLocaleDateString("fr-FR",d));const u=String(l.getUTCHours()).padStart(2,"0"),h=String(l.getUTCMinutes()).padStart(2,"0"),p=String(l.getUTCSeconds()).padStart(2,"0");if(a&&(a.textContent=`${u}:${h}:${p}`),this.globeManager&&this.globeManager.camera){const m=this.globeManager.camera.position,b=Math.sqrt(m.x*m.x+m.z*m.z),f=Math.atan2(m.z,m.x)*(180/Math.PI),y=Math.atan2(m.y,b)*(180/Math.PI);e&&(e.textContent=Math.abs(y).toFixed(4)+(y>=0?"":"-")),t&&(t.textContent=Math.abs(f).toFixed(4)+(f>=0?"":"-"));const W=(m.length()-2)*100;s&&(s.textContent=W.toFixed(2)),o&&this.globeManager.orbitParams&&(o.textContent=this.globeManager.orbitParams.zoomLevel.toFixed(1)),i&&this.globeManager.orbitParams&&(this.globeManager.orbitParams.inHotspotMode?(i.textContent="FIXÉE",i.style.color="#ffcc00"):this.globeManager.orbitParams.currentSpeed>this.globeManager.orbitParams.baseSpeed*1.5?(i.textContent="ACCÉLÉRÉE",i.style.color="#ff9900"):this.globeManager.orbitParams.currentSpeed<this.globeManager.orbitParams.baseSpeed?(i.textContent="RALENTIE",i.style.color="#66ccff"):(i.textContent="NORMALE",i.style.color="#ffffff"))}},100)}startupSequence(e){const t=document.getElementById("loading-screen");this.visualEffects.createOrbitalLoaderEffect(()=>{this.finalizeStartup(),e&&typeof e=="function"&&e()},3,t)}finalizeStartup(){this.showSystemMessages(),setTimeout(()=>{this.visualEffects.showNotification("Bienvenue dans l'exploration des Mondes Immergés","info",4e3)},1e3)}showSystemMessages(){}handleHotspotSelect(e){this.currentHotspot=e,this.explorationHistory.push({id:e.id,title:e.title,timestamp:Date.now()}),this.visualEffects.highlightSelection(e.position),this.visualEffects.flashScreen("rgba(255, 204, 0, 0.2)");const t=document.querySelector(".coordinates-display");t&&(t.style.backgroundColor="rgba(255, 204, 0, 0.2)",t.style.borderColor="rgba(255, 204, 0, 0.8)");const o=ge(e.id),i=this.generateDetailedInfoHTML(o),s=o.sources||[{title:"Étude scientifique de référence (National Geographic)",url:"https://www.nationalgeographic.com/environment/oceans"},{title:"Base de données océanographiques (NOAA)",url:"https://www.noaa.gov/oceans-coasts"},{title:"Conservation marine (UNESCO)",url:"https://en.unesco.org/themes/ocean"}];this.contentPanel&&this.contentPanel.update&&(this.contentPanel.update({title:e.title,description:e.description,videoSrc:e.videoSrc,coordinates:e.position,detailedInfo:i,links:s}),this.contentPanel.show()),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!1)}generateDetailedInfoHTML(e){if(!e||!e.scientificData)return"<p>Informations détaillées non disponibles pour cette zone.</p>";const t=e.scientificData;let o=`
        ...
        `;t.area&&(o+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(o+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(o+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(o+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),o+="</div>";let i="";e.detailedInfo&&(i=`
            ...
            ${i}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const U=new be;function ye(){U.init()}function xe(){return U}function g(r,...e){console.log(`[MI:${r}]`,performance.now().toFixed(0)+"ms",...e)}function A(r,...e){console.warn(`[MI:${r}]`,performance.now().toFixed(0)+"ms",...e)}function L(r,...e){console.error(`[MI:${r}]`,performance.now().toFixed(0)+"ms",...e)}g("BOOT","Script principal chargé");const v={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function ve(){if(v.webGLChecked)return g("WEBGL","Déjà vérifié"),!0;try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return L("WEBGL","WebGL non supporté"),we(),v.webGLChecked=!1,!1;v.webGLChecked=!0,g("WEBGL","WebGL OK — renderer:",e.getParameter(e.RENDERER));const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return L("WEBGL","Erreur vérification WebGL:",r),!1}}function we(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
        ...
        `)}function Ee(){if(window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod/i.test(navigator.userAgent))return;const e=document.querySelector(".cursor"),t=document.querySelector(".cursor-follower");if(!e||!t)return;let o=0,i=0,s=0,n=0,a=null,l=0;const d=16,u=p=>{const m=performance.now();m-l<d||(l=m,o=p.clientX,i=p.clientY)};document.addEventListener("mousemove",u,{passive:!0});function h(){e.style.transform=`translate(${o}px, ${i}px)`,s+=(o-s)*.1,n+=(i-n)*.1,t.style.transform=`translate(${s}px, ${n}px)`,a=requestAnimationFrame(h)}a=requestAnimationFrame(h),window.addEventListener("beforeunload",()=>{a&&cancelAnimationFrame(a),document.removeEventListener("mousemove",u)},{once:!0})}async function Me(){return new Promise(r=>{const e=document.querySelector("l-jelly"),t=document.getElementById("transition-video-in"),o=document.getElementById("loading-screen"),i=document.getElementById("main-container");if(!t){r();return}e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),i&&(i.style.opacity="1"),o&&(o.style.background="transparent"),P.register(t,{loop:!1,muted:!0,autoRetry:!0,name:"transition-video-in"}),t.classList.add("active"),t.currentTime=0,t.play().then(()=>{t.addEventListener("ended",function(){t.classList.remove("active"),o&&(o.style.display="none",o.classList.add("hidden")),setTimeout(()=>r(),300)},{once:!0})}).catch(s=>{t.classList.remove("active"),r()}),t.addEventListener("loadedmetadata",function(){const s=t.duration;setTimeout(()=>{t.classList.contains("active")&&(t.classList.remove("active"),r())},(s+2)*1e3)},{once:!0}),setTimeout(()=>{t.classList.contains("active")&&(t.classList.remove("active"),r())},15e3)})}async function Ce(){if(v.appStarted){g("APP","Déjà démarré, skip");return}v.appStarted=!0,g("APP","=== DÉMARRAGE APPLICATION ===");try{g("APP","initApp()..."),ye();const r=xe();if(!r)throw new Error("Instance application non disponible");g("APP","Instance app OK, globeManager:",!!r.globeManager),Pe(),r.globeManager&&r.globeManager.preloadAllAssets?(g("APP","Préchargement assets..."),await r.globeManager.preloadAllAssets(),g("APP","Assets préchargés OK")):A("APP","preloadAllAssets non disponible"),g("APP","Lancement vidéo de transition..."),await Me(),g("APP","Vidéo de transition terminée"),g("APP","Démarrage exploration..."),r.startExploration(!0),g("APP","Affichage éléments interface..."),Le(r),g("APP","=== APPLICATION PRÊTE ===")}catch(r){L("APP","ERREUR CRITIQUE:",r),Ie()}}function Pe(){const r=document.getElementById("main-container");if(!r)return;r.classList.remove("hidden"),r.style.opacity="0",r.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),o=document.querySelector(".satellite-crosshair"),i=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(s=>{s.style.opacity="0"}),o&&(o.style.opacity="0"),i&&(i.style.opacity="0")}function Le(r){const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),o=document.querySelector(".satellite-crosshair"),i=document.querySelectorAll(".hotspot-label"),s=document.querySelectorAll("svg"),n=document.querySelector(".scanner-effect");r&&r.globeManager&&r.globeManager.showLabels(),e&&(e.style.pointerEvents="auto"),window.gsap?(e&&gsap.to(e,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...t,o,n].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...i,...s],{opacity:1,duration:.8,ease:"power2.out"})):(e&&(e.style.transition="all 0.8s ease",e.style.opacity="1",e.style.transform="translateY(0)"),t.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),o&&(o.style.transition="opacity 0.8s ease",o.style.opacity="1"),n&&(n.style.transition="opacity 0.8s ease",n.style.opacity="1"),i.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),s.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}))}function Ie(r){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function Se(){const r=document.getElementById("welcome-screen");r&&(r.style.display="none",r.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Te(){if(v.initialized){g("INIT","Déjà initialisé, skip");return}if(v.initialized=!0,g("INIT","=== INITIALISATION ==="),!ve()){L("INIT","WebGL incompatible, arrêt");return}g("INIT","Préparation environnement..."),Se(),["loading-screen","main-container","globe-container","app"].forEach(o=>{document.getElementById(o)?g("INIT",`#${o} OK`):A("INIT",`Élément manquant: #${o}`)});let e=0;const t=setInterval(()=>{e+=12.5,e>=100&&(clearInterval(t),g("INIT","Chargement simulé terminé, démarrage app..."),setTimeout(()=>{Ce()},300))},200)}function ke(){v.cleanupDone||(v.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(g("DOM","DOMContentLoaded déclenché"),v.domReady){A("DOM","DOMContentLoaded déjà traité, skip");return}v.domReady=!0,Ee(),setTimeout(()=>{Te()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){A("ERR","Ressource non chargée:",r.target.tagName,r.target.src||r.target.href);return}L("ERR","Erreur globale:",r.message,r.filename,"ligne",r.lineno)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{L("PROMISE","Promise rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",ke,{once:!0});window.addEventListener("pageshow",r=>{(r.persisted||window.performance&&window.performance.navigation.type===2)&&window.location.reload()});
