import{R as L,V as F,C as U,a as v,S as W,A as I,D as q,F as k,P as Y,W as X,b as _,c as A,L as C,d as D,e as z,H as Z,T,f as x,M as w,g as y,h as K,B as J,i as B,j as O,k as H,l as R,m as P,n as Q,o as ee,p as N,q as te}from"./three-4x0lhi4J.js";import{g as d}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const oe="modulepreload",ie=function(l){return"/nationalgeographic.fr-mondesimmerges/interface/"+l},V={},ne=function(e,t,i){let o=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),a=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));o=Promise.allSettled(t.map(r=>{if(r=ie(r),r in V)return;V[r]=!0;const c=r.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":oe,c||(p.as="script"),p.crossOrigin="",p.href=r,a&&p.setAttribute("nonce",a),document.head.appendChild(p),c)return new Promise((m,h)=>{p.addEventListener("load",m),p.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${r}`)))})}))}function n(s){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=s,window.dispatchEvent(a),!a.defaultPrevented)throw s}return o.then(s=>{for(const a of s||[])a.status==="rejected"&&n(a.reason);return e().catch(n)})};ne(()=>import("https://unpkg.com/ldrs/dist/auto/jelly.js"),[]);const se={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ae="/nationalgeographic.fr-mondesimmerges/accueil/";function S(l){return se[l]||ae}class re{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new L,this.mouse=new F,this.clock=new U,this.labelsVisible=!1,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new v(100,20,100),moonPosition:new v(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new W;const e=new I(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new k(0,15e-5),this.camera=new Y(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new X({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=_;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e),d.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),d.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}setupLighting(){const e=new I(4210768,.5);this.scene.add(e);const t=new q(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new Z(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new T,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new x(3,32,32),o=new w({map:t,transparent:!0,opacity:.95}),n=new y(i,o);n.position.copy(this.celestialParams.sunPosition),this.scene.add(n);const s=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new x(1.5,32,32),r=new K({map:s}),c=new y(a,r);c.position.copy(this.celestialParams.moonPosition),this.scene.add(c),this.sun=n,this.moon=c}createOrbitPath(){const e=[];for(let n=0;n<=100;n++){const s=n/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,r=this.orbitParams.ellipseMinorAxis,c=this.orbitParams.inclination;let u=a*Math.cos(s),p=r*Math.sin(s);const m=p*Math.sin(c);p=p*Math.cos(c),e.push(new v(u,m,p))}new J().setFromPoints(e);const i=new x(.2,16,16),o=new w({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new y(i,o),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const i=document.createElement("video");i.src=this.currentVideoPath,i.loop=!0,i.muted=!0,i.autoplay=!1,i.playsInline=!0,i.crossOrigin="anonymous",i.preload="auto",this.videoElement=i,console.log("📦 Préchargement de la vidéo du globe...",this.currentVideoPath);let o=!1;const n=setTimeout(()=>{o||(console.warn("⚠️ Timeout préchargement vidéo - continuation"),o=!0,e())},1e4);i.addEventListener("canplaythrough",()=>{o||(console.log("✅ Vidéo du globe préchargée et prête"),o=!0,clearTimeout(n),e())},{once:!0}),i.addEventListener("canplay",()=>{o||(console.log("✅ Vidéo du globe peut être jouée"),o=!0,clearTimeout(n),e())},{once:!0}),i.addEventListener("error",h=>{o||(console.error("❌ Erreur chargement vidéo globe:",h),console.warn("Continuation malgré l'erreur"),o=!0,clearTimeout(n),e())}),i.addEventListener("ended",()=>{i.play()}),setInterval(()=>{i.paused&&!i.ended&&(console.log("Vidéo en pause, relance..."),i.play().catch(h=>{console.error("Impossible de relancer la vidéo:",h)}))},1e3),this.videoTexture=new A(i),this.videoTexture.minFilter=C,this.videoTexture.magFilter=C,this.videoTexture.format=D,this.videoTexture.colorSpace=z;const s=new x(1.99,64,64),a=new w({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:B}),r=new y(s,a);r.renderOrder=0,this.scene.add(r),this.depthSphere=r;const c=new x(2,64,64),u=new w({map:this.videoTexture,transparent:!0,opacity:1,side:B,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new y(c,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const p=new x(2.02,64,64),m=new w({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new y(p,m),this.clouds.renderOrder=2,this.scene.add(this.clouds),i.load()})}createAtmosphere(){const e=new x(2.15,64,64),t=new O({vertexShader:`
        ...
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","svg");n.style.cssText=`
            ...
            z-index: 999;
            opacity: 0;
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","line");s.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),s.setAttribute("stroke-width","1.5"),s.setAttribute("stroke-dasharray","4, 4"),n.appendChild(s),document.body.appendChild(o),document.body.appendChild(n);const a=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},r=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffcc00",o.style.transform="scale(1)"},c=u=>{u.stopPropagation();const p=e.userData.hotspot;p&&(console.log(`Label cliqué: ${p.title}`),this.activateHotspot(p))};o.addEventListener("mouseenter",a),o.addEventListener("mouseleave",r),o.addEventListener("click",c),e.userData.label=o,e.userData.connectorSvg=n,e.userData.connectorLine=s,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:r,onClick:c},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),r=90-s*180/Math.PI,c=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${r.toFixed(2)}, lng: ${c.toFixed(2)}`);const u=this._findNearestHotspot(r,c,10);if(u){console.log(`Hotspot trouvé: ${u.title}`),this.activateHotspot(u);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of s){const r=a.position.lat,c=a.position.lng,u=Math.sqrt(Math.pow(r-e,2)+Math.pow(c-t,2));u<n&&(n=u,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),r=new v(n,s,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const c=this.camera.position.clone(),m=r.clone().normalize().multiplyScalar(3.5),h=new v().addVectors(c,m).multiplyScalar(.5);h.normalize().multiplyScalar(h.length()+1.8);const g=d.timeline();g.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}}),g.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),g.to(this.camera,{fov:40,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ==="),this.playTransitionVideoAndRedirect(e.id)}playTransitionVideoAndRedirect(e){const t=document.getElementById("transition-video");if(!t){console.warn("⚠️ Vidéo de transition introuvable, redirection directe");const i=S(e);window.location.href=i;return}console.log("🎬 Lecture vidéo de transition avant redirection..."),t.classList.add("active"),t.currentTime=0,t.play().then(()=>{console.log("Vidéo de transition lancée"),t.addEventListener("ended",()=>{console.log("✅ Vidéo terminée, redirection...");const i=S(e);window.location.href=i},{once:!0})}).catch(i=>{console.error("❌ Erreur vidéo:",i);const o=S(e);window.location.href=o}),setTimeout(()=>{console.warn("⚠️ Timeout vidéo, redirection forcée");const i=S(e);window.location.href=i},1e4)}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),a=new N(0,.3,32),r=new O({uniforms:{color:{value:new P(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `;for(let u=0;u<3;u++){const p=document.createElement("div");p.style.cssText=`
            ...
            `;for(let m=0;m<3+u;m++){const h=document.createElement("div"),f=360/(3+u)*m;h.style.cssText=`
                ...
                `,p.appendChild(h)}n.appendChild(p)}const s=document.createElement("div");s.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,n.appendChild(a),o.appendChild(n);const r=document.createElement("style");r.textContent=`
            @keyframes orbit0 {
        ...
        `,this.effectsContainer.appendChild(t),d.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),a=Math.random()*3+1,r=Math.random()*100,c=Math.random()*100,u=Math.random()*5,p=Math.random()*10+10,m=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${n}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const j=new me;function he(){j.init()}function ge(){return j}const b={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function fe(){if(b.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const l=document.createElement("canvas"),e=l.getContext("webgl")||l.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),be(),b.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),b.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(l){return console.error("❌ Erreur vérification WebGL:",l),!1}}function be(){const l=document.getElementById("loading-screen");l&&(l.innerHTML=`
        ...
        `)}function ye(){const l=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!l||!e)return;let t=0,i=0,o=0,n=0,s=null;const a=c=>{t=c.clientX,i=c.clientY};document.addEventListener("mousemove",a,{passive:!0});function r(){l.style.left=t+"px",l.style.top=i+"px",o+=(t-o)*.1,n+=(i-n)*.1,e.style.left=o+"px",e.style.top=n+"px",s=requestAnimationFrame(r)}s=requestAnimationFrame(r),window.addEventListener("beforeunload",()=>{s&&cancelAnimationFrame(s),document.removeEventListener("mousemove",a)}),console.log("✅ Curseur initialisé")}async function xe(){return new Promise(l=>{const e=document.querySelector("l-jelly"),t=document.getElementById("transition-video"),i=document.getElementById("loading-screen"),o=document.getElementById("main-container");if(!t){console.warn("⚠️ Vidéo de transition introuvable"),l();return}console.log(">>> DÉCLENCHEMENT DE LA TRANSITION <<<"),e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),o&&(o.style.opacity="1",console.log("🌍 Globe visible immédiatement")),i&&(i.style.background="transparent",console.log("✅ Loading-screen transparent")),t.classList.add("active"),t.currentTime=0,t.play().then(()=>{console.log("Vidéo de transition lancée"),t.addEventListener("ended",function(){console.log("✅ Vidéo de transition terminée"),t.classList.remove("active"),i&&(i.style.display="none",i.classList.add("hidden")),setTimeout(()=>l(),300)},{once:!0})}).catch(n=>{console.error("❌ Erreur lors du lancement de la vidéo:",n),t.classList.remove("active"),l()}),t.addEventListener("loadedmetadata",function(){const n=t.duration;console.log("📹 Durée de la vidéo:",n+"s"),setTimeout(()=>{t.classList.contains("active")&&(console.warn("⚠️ Timeout vidéo transition"),t.classList.remove("active"),l())},(n+2)*1e3)},{once:!0}),setTimeout(()=>{t.classList.contains("active")&&(console.warn("⚠️ Timeout ultime"),t.classList.remove("active"),l())},15e3)})}async function ve(){if(b.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),b.appStarted=!0;try{he();const l=ge();if(!l)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),we(),console.log("⏳ PRÉCHARGEMENT DES ASSETS EN COURS..."),l.globeManager&&l.globeManager.preloadAllAssets?(await l.globeManager.preloadAllAssets(),console.log("✅ TOUS LES ASSETS SONT PRÊTS")):console.warn("⚠️  preloadAllAssets non disponible, passage direct"),await xe(),console.log("🌊 Démarrage exploration..."),l.startExploration(!0),Ee(l)}catch(l){console.error("❌ Erreur application:",l),Me()}}function we(){const l=document.getElementById("main-container");if(!l)return;l.classList.remove("hidden"),l.style.opacity="0",l.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(n=>{n.style.opacity="0"}),i&&(i.style.opacity="0"),o&&(o.style.opacity="0"),console.log("✅ Interface initialisée en mode clear")}function Ee(l){const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelectorAll(".hotspot-label"),n=document.querySelectorAll("svg"),s=document.querySelector(".scanner-effect");console.log("✨ Apparition des éléments UI + hotspots + connector lines"),l&&l.globeManager&&l.globeManager.showLabels(),e&&(e.style.pointerEvents="auto"),window.gsap?(e&&gsap.to(e,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...t,i,s].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...o,...n],{opacity:1,duration:.8,ease:"power2.out"})):(e&&(e.style.transition="all 0.8s ease",e.style.opacity="1",e.style.transform="translateY(0)"),t.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),i&&(i.style.transition="opacity 0.8s ease",i.style.opacity="1"),s&&(s.style.transition="opacity 0.8s ease",s.style.opacity="1"),o.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),n.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}))}function Me(l){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function Ce(){const l=document.getElementById("welcome-screen");l&&(l.style.display="none",l.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Se(){if(b.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),b.initialized=!0,!fe())return;Ce();let l=0;const e=setInterval(()=>{l+=12.5,l>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{ve()},300))},200)}function Te(){b.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),b.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(b.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),b.domReady=!0,ye(),setTimeout(()=>{Se()},100)});window.addEventListener("error",l=>{if(l.target!==window&&(l.target.tagName==="IMG"||l.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",l.target.src||l.target.href);return}console.error("❌ Erreur:",l.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",l=>{console.error("❌ Promesse rejetée:",l.reason),l.preventDefault()},{once:!1});window.addEventListener("beforeunload",Te,{once:!0});window.addEventListener("pageshow",l=>{(l.persisted||window.performance&&window.performance.navigation.type===2)&&(console.log("🔄 Page restaurée depuis le cache, rechargement..."),window.location.reload())});
