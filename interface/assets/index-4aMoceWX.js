import{R as k,V as U,C as X,a as v,S as Y,A as q,D as A,F as z,P as _,W as Z,b as K,c as B,L as T,d as D,e as H,H as J,T as L,f as w,M as S,g as x,h as Q,B as ee,i as O,j as $,k as N,l as V,m as te,n as oe,o as R,p as ie,q as se}from"./three-Bmxrupip.js";import{g as c}from"./gsap-xHO-obUW.js";import{i as ne}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const ae={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},re="/nationalgeographic.fr-mondesimmerges/accueil/";function le(l){return ae[l]||re}class ce{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new k,this.mouse=new U,this.clock=new X,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new v(100,20,100),moonPosition:new v(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new Y;const e=new q(16777215,1.2);this.scene.add(e);const t=new A(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new z(0,15e-5),this.camera=new _(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new Z({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=K;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `,e.appendChild(t),this.container.appendChild(e)}setupLighting(){const e=new q(4210768,.5);this.scene.add(e);const t=new A(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new J(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new L,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new w(3,32,32),o=new S({map:t,transparent:!0,opacity:.95}),s=new x(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new w(1.5,32,32),d=new Q({map:n}),r=new x(a,d);r.position.copy(this.celestialParams.moonPosition),this.scene.add(r),this.sun=s,this.moon=r}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,d=this.orbitParams.ellipseMinorAxis,r=this.orbitParams.inclination;let p=a*Math.cos(n),u=d*Math.sin(n);const m=u*Math.sin(r);u=u*Math.cos(r),e.push(new v(p,m,u))}new ee().setFromPoints(e);const i=new w(.2,16,16),o=new S({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(r=>{console.error("Impossible de relancer la vidéo:",r)}))},1e3),this.videoTexture=new B(e),this.videoTexture.minFilter=T,this.videoTexture.magFilter=T,this.videoTexture.format=D,this.videoTexture.colorSpace=H;const t=new w(1.99,64,64),i=new S({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:O}),o=new x(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const s=new w(2,64,64),n=new S({map:this.videoTexture,transparent:!0,opacity:1,side:O,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(s,n),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const a=new w(2.02,64,64),d=new S({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(a,d),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(r=>{console.error("Erreur lors de la lecture de la vidéo:",r),this.handleVideoError()})}createAtmosphere(){const e=new w(2.08,64,64),t=new $({vertexShader:`
            ...
            `,uniforms:{cameraPosition:{value:new v}},blending:V,side:N,transparent:!0}),i=new x(e,t);this.scene.add(i),this.atmosphere=i,this.updateAtmosphereUniforms=()=>{this.atmosphere&&this.atmosphere.material.uniforms&&this.atmosphere.material.uniforms.cameraPosition.value.copy(this.camera.position)}}createSkybox(){new L().load("/nationalgeographic.fr-mondesimmerges/interface/images/night-sky.png",i=>{this.renderer.toneMapping=te,this.renderer.toneMappingExposure=.3;const o=new oe(i.image.height);o.fromEquirectangularTexture(this.renderer,i),this.scene.background=o.texture,this.scene.fog=new z(17,8e-5)},void 0,i=>{console.error("Erreur lors du chargement de la texture du ciel:",i),this.scene.background=new R(17)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,n,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new v(i,n,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{this.scene.remove(t),t.userData.labelContainer&&document.body.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],e.forEach(t=>{const{position:i,title:o}=t,s=i.lat*(Math.PI/180),n=i.lng*(Math.PI/180),a=2.1,d=a*Math.cos(s)*Math.cos(n),r=a*Math.sin(s),p=a*Math.cos(s)*Math.sin(n);console.log(`Hotspot ${o}: GPS(${i.lat}, ${i.lng}) -> 3D(${d.toFixed(2)}, ${r.toFixed(2)}, ${p.toFixed(2)})`);const u=new w(.05,16,16),m=new S({color:16763904,transparent:!0,opacity:.8}),h=new x(u,m);h.position.set(d,r,p),h.userData={hotspot:t};const M=new w(.08,16,16),E=new S({color:16763904,transparent:!0,opacity:.5,side:N}),C=new x(M,E);h.add(C),this.addHotspotLabel(h,o,new v(d,r,p)),this.scene.add(h),this.hotspotObjects.push(h)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label-container",o.style.cssText=`
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        `;const s=document.createElement("div");s.className="hotspot-label",s.textContent=t,s.style.cssText=`
            ...
            pointer-events: auto;
            cursor: pointer;
        `,s.addEventListener("mouseenter",()=>{s.style.backgroundColor="rgba(255, 204, 0, 0.9)",s.style.color="#000",s.style.transform="scale(1.05)"}),s.addEventListener("mouseleave",()=>{s.style.backgroundColor="rgba(0, 0, 0, 0.7)",s.style.color="#ffcc00",s.style.transform="scale(1)"}),s.addEventListener("click",d=>{d.stopPropagation();const r=e.userData.hotspot;r&&(console.log(`Label cliqué: ${r.title}`),this.activateHotspot(r))});const n=document.createElement("div");n.className="connector-line",n.style.cssText=`
            position: absolute;
        ...
        `,o.appendChild(s),o.appendChild(n),document.body.appendChild(o),e.userData.label=s,e.userData.connector=n,e.userData.labelContainer=o,e.userData.worldPosition=i.clone();const a=d=>{const r=new v().copy(d).project(this.camera);if(r.z>1||r.x<-1||r.x>1||r.y<-1||r.y>1)return!1;const p=new v().subVectors(d,this.camera.position).normalize(),m=new k(this.camera.position,p).intersectObject(this.globe);if(m.length>0){const h=m[0].distance,M=this.camera.position.distanceTo(d);return h>M-.1}return!0};e.onBeforeRender=()=>{if(!e.userData.label||!e.userData.connector)return;if(a(e.userData.worldPosition)&&!this.orbitParams.inHotspotMode){const r=e.userData.worldPosition.clone();r.project(this.camera);const p=(r.x*.5+.5)*window.innerWidth,u=(-r.y*.5+.5)*window.innerHeight,m=window.innerWidth/2,h=window.innerHeight/2,M=Math.sqrt(Math.pow(p-m,2)+Math.pow(u-h,2)),E=Math.atan2(u-h,p-m),C=Math.min(m,h)*.6;let g,y;if(M<C){const P=C+60+Math.sin(E*5)*20;g=m+Math.cos(E)*P,y=h+Math.sin(E)*P;const f=20;g<f&&(g=f),g>window.innerWidth-f&&(g=window.innerWidth-f),y<f&&(y=f),y>window.innerHeight-f&&(y=window.innerHeight-f)}else{const P=t.length*8,f=25+P*.25,I=10;p+f+P>window.innerWidth-20?g=p-f-P:g=p+f,u-I-30<20?y=u+I:y=u-I}e.userData.label.style.left=`${g}px`,e.userData.label.style.top=`${y}px`,e.userData.label.style.opacity="1",n.style.left=`${p}px`,n.style.top=`${u}px`;const F=Math.sqrt(Math.pow(g-p,2)+Math.pow(y-u,2)),W=Math.atan2(y-u,g-p);n.style.width=`${F}px`,n.style.transform=`rotate(${W}rad)`,n.style.opacity="1",n.style.animation="pulseConnector 2s infinite alternate"}else e.userData.label.style.opacity="0",n.style.opacity="0"}}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,n=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),d=90-n*180/Math.PI,r=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${d.toFixed(2)}, lng: ${r.toFixed(2)}`);const p=this._findNearestHotspot(d,r,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,s=i;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const d=a.position.lat,r=a.position.lng,p=Math.sqrt(Math.pow(d-e,2)+Math.pow(r-t,2));p<s&&(s=p,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,s=o*Math.cos(t)*Math.cos(i),n=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),d=new v(s,n,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=d.clone().normalize().multiplyScalar(3.5);c.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),c.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
           ...
           z-index: 9999;
           pointer-events: none;
       `,document.body.appendChild(t),c.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=le(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(i),a=new ie(0,.3,32),d=new $({uniforms:{color:{value:new R(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `;const o=document.createElement("div");o.style.cssText=`
            ...
            justify-content: center;
            align-items: center;
        `;for(let a=0;a<3;a++){const d=document.createElement("div");d.style.cssText=`
                position: absolute;
                border-radius: 50%;
            ...
            `;for(let r=0;r<3+a;r++){const p=document.createElement("div"),u=360/(3+a)*r;p.style.cssText=`
                    position: absolute;
                    width: ${8-a}px;
                    height: ${8-a}px;
                    ...
                    transform: translate(-50%, -50%) rotate(${u}deg) translateX(${60+a*20}px);
                `,d.appendChild(p)}o.appendChild(d)}const s=document.createElement("div");s.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
        ...
        `,o.appendChild(s),i.appendChild(o);const n=document.createElement("style");n.textContent=`
            @keyframes orbit0 {
        ...
        `,document.head.appendChild(n),this.effectsContainer.appendChild(i),c.fromTo(i,{opacity:0},{opacity:1,duration:.5}),setTimeout(()=>{c.to(i,{opacity:0,duration:.5,onComplete:()=>{i.remove(),n.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),c.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{c.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const o={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let s=0;s<o.pulseCount;s++)setTimeout(()=>{const n=document.createElement("div");n.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<i.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,d=Math.random()*100,r=Math.random()*100,p=Math.random()*5,u=Math.random()*10+10,m=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `,i.appendChild(o),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(d=>{const r=document.createElement("div");r.className="minimap-dot",r.dataset.id=d.id,r.title=d.name,r.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,r.addEventListener("mouseenter",()=>{c.to(r,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(r,d.name,{position:"top",duration:2e3})}),r.addEventListener("mouseleave",()=>{c.to(r,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),r.addEventListener("click",()=>{t&&t(d.id)}),i.appendChild(r)});const n=document.createElement("div");n.className="minimap-toggle",n.innerHTML="−",n.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.visualEffects&&this.visualEffects.showNotification("Retour à l'exploration globale","info",3e3),this.currentHotspot=null}}const G=new ge;function fe(){G.init()}function be(){return G}const b={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function ye(){if(b.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const l=document.createElement("canvas"),e=l.getContext("webgl")||l.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),xe(),b.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),b.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(l){return console.error("❌ Erreur vérification WebGL:",l),!1}}function xe(){const l=document.getElementById("loading-screen");l&&(l.innerHTML=`
        ...
        `)}function ve(){const l=document.getElementById("loading-screen");if(!l)return;const e=l.querySelector(".spinner");e&&e.remove();try{ne.register();const t=document.createElement("l-jelly");t.setAttribute("size","60"),t.setAttribute("speed","0.9"),t.setAttribute("color","#ffcc00"),l.insertBefore(t,l.firstChild),console.log("✅ Spinner initialisé")}catch(t){console.warn("⚠️  Fallback spinner CSS");const i=document.createElement("div");i.className="spinner",l.insertBefore(i,l.firstChild)}}function we(){const l=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!l||!e)return;let t=0,i=0,o=0,s=0,n=null;const a=r=>{t=r.clientX,i=r.clientY};document.addEventListener("mousemove",a,{passive:!0});function d(){l.style.left=t+"px",l.style.top=i+"px",o+=(t-o)*.1,s+=(i-s)*.1,e.style.left=o+"px",e.style.top=s+"px",n=requestAnimationFrame(d)}n=requestAnimationFrame(d),window.addEventListener("beforeunload",()=>{n&&cancelAnimationFrame(n),document.removeEventListener("mousemove",a)}),console.log("✅ Curseur initialisé")}async function Ee(){if(b.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),b.appStarted=!0;try{fe();const l=be();if(!l)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),await Me(),Ce(),setTimeout(()=>{l.startupSequence&&typeof l.startupSequence=="function"?(console.log("🎬 Séquence de démarrage..."),l.startupSequence(),setTimeout(()=>{console.log("🌊 Démarrage exploration..."),l.startExploration(!0)},5e3)):(console.log("🌊 Démarrage direct..."),l.startExploration(!0))},300)}catch(l){console.error("❌ Erreur application:",l),Se()}}function Me(){return new Promise(l=>{const e=document.getElementById("loading-screen");if(!e){l();return}e.style.transition="opacity 0.7s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="0",setTimeout(()=>{e.style.display="none",e.classList.add("hidden"),l()},700)})}function Ce(){const l=document.getElementById("main-container");l&&(l.classList.remove("hidden"),l.style.transition="opacity 0.7s cubic-bezier(0.19, 1, 0.22, 1)",l.offsetHeight,l.style.opacity="1",console.log("✅ Conteneur principal visible"))}function Se(l){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function Pe(){const l=document.getElementById("welcome-screen");l&&(l.style.display="none",l.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Te(){if(b.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),b.initialized=!0,!ye())return;Pe(),ve();let l=0;const e=setInterval(()=>{l+=12.5,l>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{Ee()},300))},200)}function Ie(){b.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),b.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(b.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),b.domReady=!0,we(),setTimeout(()=>{Te()},100)});window.addEventListener("error",l=>{if(l.target!==window&&(l.target.tagName==="IMG"||l.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",l.target.src||l.target.href);return}console.error("❌ Erreur:",l.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",l=>{console.error("❌ Promesse rejetée:",l.reason),l.preventDefault()},{once:!1});window.addEventListener("beforeunload",Ie,{once:!0});
