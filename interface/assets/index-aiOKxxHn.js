import{R as I,V as j,C as G,a as w,S as F,A as k,D as q,F as A,P as U,W,H as _,T as P,b as v,M as E,c as x,d as Y,B as X,e as Z,L as D,f as K,g as J,h as z,i as B,j as H,k as O,l as L,m as Q,n as ee,o as R,p as te}from"./three-DErGBpjY.js";import{g as r}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const ie={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},oe="/mondes-immerges/accueil/";function S(c){return ie[c]||oe}class se{constructor(){this.videos=new Map,this.retryAttempts=new Map,this.maxRetries=5,this.checkInterval=null,this.isActive=!0,this._contextLost=!1}onContextLost(){this._contextLost=!0,this.stopMonitoring()}onContextRestored(){this._contextLost=!1,this.videos.forEach((e,t)=>{this.playVideo(t,e)}),this.startMonitoring(2e3)}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement))return;const o={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,autoRetry:t.autoRetry!==!1,onError:t.onError||null,onPlay:t.onPlay||null,onStall:t.onStall||null,name:t.name||"video-"+this.videos.size};e.loop=o.shouldLoop,e.muted=o.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,o),this.retryAttempts.set(e,0),this.attachListeners(e,o)}attachListeners(e,t){e.addEventListener("ended",()=>{t.shouldLoop&&this.isActive&&this.playVideo(e,t)}),e.addEventListener("pause",()=>{e.ended||e.dataset.intentionalPause!=="true"&&(this._contextLost||this.isActive&&setTimeout(()=>{this.isActive&&!this._contextLost&&this.playVideo(e,t)},100))}),e.addEventListener("stalled",()=>{t.onStall&&t.onStall(e),setTimeout(()=>{e.readyState>=2&&this.isActive&&!this._contextLost&&this.playVideo(e,t)},500)}),e.addEventListener("waiting",()=>{}),e.addEventListener("suspend",()=>{}),e.addEventListener("error",o=>{t.onError&&t.onError(o);const i=this.retryAttempts.get(e)||0;i<this.maxRetries&&t.autoRetry&&this.isActive&&!this._contextLost&&(this.retryAttempts.set(e,i+1),setTimeout(()=>{e.load(),this.playVideo(e,t)},2e3*(i+1)))}),e.addEventListener("loadeddata",()=>{}),e.addEventListener("play",()=>{this.retryAttempts.set(e,0),t.onPlay&&t.onPlay(e)})}playVideo(e,t){if(!e||!this.isActive||this._contextLost)return;const o=e.play();o!==void 0&&o.then(()=>{}).catch(i=>{if(i.name==="NotAllowedError"){const s=()=>{this.playVideo(e,t),document.removeEventListener("click",s)};document.addEventListener("click",s,{once:!0})}})}startMonitoring(e=2e3){this.checkInterval||(this.checkInterval=setInterval(()=>{!this.isActive||this._contextLost||this.videos.forEach((t,o)=>{o.paused&&!o.ended&&t.shouldLoop&&this.playVideo(o,t),o.readyState<3&&o.paused})},e))}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null)}unregister(e){this.videos.has(e)&&(this.videos.delete(e),this.retryAttempts.delete(e))}unregisterAll(){this.videos.clear(),this.retryAttempts.clear()}disable(){this.isActive=!1,this.stopMonitoring()}enable(){this.isActive=!0,this.startMonitoring()}destroy(){this.disable(),this.unregisterAll()}}const M=new se;class ne{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new I,this.mouse=new j,this.clock=new G,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.init()}init(){this.scene=new F;const e=new k(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new U(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const o=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),i=o||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new W({antialias:!o,alpha:!0,logarithmicDepthBuffer:!i,powerPreference:"high-performance",precision:o?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(o?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!1,this.isMobile=o,this.container.appendChild(this.renderer.domElement);const s=this.renderer.domElement;s.addEventListener("webglcontextlost",n=>{n.preventDefault(),this._contextLost=!0,M.onContextLost()}),s.addEventListener("webglcontextrestored",()=>{this._contextLost=!1,M.onContextRestored()})}catch(o){this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e)}setupLighting(){const e=new k(4210768,.5);this.scene.add(e);const t=new q(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!1,this.scene.add(t),this.sunLight=t;const o=new _(35071,65416,.6);this.scene.add(o)}createCelestialBodies(){const e=new P,t=e.load("/mondes-immerges/interface/images/sun-texture.jpg"),o=new v(3,32,32),i=new E({map:t,transparent:!0,opacity:.95}),s=new x(o,i);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/mondes-immerges/interface/images/moon-texture.jpg"),a=new v(1.5,32,32),l=new Y({map:n}),d=new x(a,l);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,l=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),h=l*Math.sin(n);const p=h*Math.sin(d);h=h*Math.cos(d),e.push(new w(u,p,h))}new X().setFromPoints(e);const o=new v(.2,16,16),i=new E({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(o,i),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const o=document.createElement("video");o.src=this.currentVideoPath,o.loop=!0,o.muted=!0,o.autoplay=!1,o.playsInline=!0,o.crossOrigin="anonymous",o.preload="auto",this.videoElement=o;let i=!1;const s=setTimeout(()=>{i||(i=!0,e())},1e4);o.addEventListener("canplaythrough",()=>{i||(i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("canplay",()=>{i||(i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("error",m=>{i||(i=!0,clearTimeout(s),e())}),M.register(o,{loop:!0,muted:!0,autoRetry:!0,name:"globe-texture",onError:m=>{},onPlay:()=>{}}),this.videoTexture=new Z(o),this.videoTexture.minFilter=D,this.videoTexture.magFilter=D,this.videoTexture.format=K,this.videoTexture.colorSpace=J;const n=new v(1.99,64,64),a=new E({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:z}),l=new x(n,a);l.renderOrder=0,this.scene.add(l),this.depthSphere=l;const d=new v(2,64,64),u=new E({map:this.videoTexture,transparent:!0,opacity:1,side:z,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(d,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const h=new v(2.02,64,64),p=new E({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(h,p),this.clouds.renderOrder=2,this.scene.add(this.clouds),o.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new B({vertexShader:`
        ...
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(i),document.body.appendChild(s);const a=()=>{i.style.backgroundColor="rgba(255, 204, 0, 0.9)",i.style.color="#000",i.style.transform="scale(1.05)"},l=()=>{i.style.backgroundColor="rgba(0, 0, 0, 0.8)",i.style.color="#ffdd00",i.style.transform="scale(1)"},d=u=>{u.stopPropagation();const h=e.userData.hotspot;h&&this.activateHotspot(h)};i.addEventListener("mouseenter",a),i.addEventListener("mouseleave",l),i.addEventListener("click",d),e.userData.label=i,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=o.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:l,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const i=t[0].point,n=Math.acos(i.y/2),a=Math.atan2(i.z,i.x),l=90-n*180/Math.PI,d=a*180/Math.PI-180,u=this._findNearestHotspot(l,d,10);if(u){this.activateHotspot(u);return}}const o=this.raycaster.intersectObjects(this.hotspotObjects);if(o.length>0){const i=o[0].object.userData.hotspot;this.activateHotspot(i)}}_findNearestHotspot(e,t,o){let i=null,s=o;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const l=a.position.lat,d=a.position.lng,u=Math.sqrt(Math.pow(l-e,2)+Math.pow(d-t,2));u<s&&(s=u,i=a)}return i}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;const t=e.position.lat*(Math.PI/180),o=e.position.lng*(Math.PI/180),i=2.1,s=i*Math.cos(t)*Math.cos(o),n=i*Math.sin(t),a=i*Math.cos(t)*Math.sin(o),l=new w(s,n,a);this.orbitParams.isOrbiting=!1;const d=this.camera.position.clone(),p=l.clone().normalize().multiplyScalar(5.2),m=new w().addVectors(d,p).multiplyScalar(.5);m.normalize().multiplyScalar(m.length()+1.8);const f=r.timeline();f.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}});let b=document.getElementById("fade-overlay");b||(b=document.createElement("div"),b.id="fade-overlay",b.style.cssText=`
                ...
                z-index: 98000;
                pointer-events: none;
            `,document.body.appendChild(b)),f.to(this.camera.position,{x:p.x,y:p.y,z:p.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),f.to(b,{opacity:1,duration:.8,ease:"power2.in"},"-=0.8"),f.to(this.camera,{fov:55,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){this.playTransitionVideoAndRedirect(e.id)}playTransitionVideoAndRedirect(e){const t=document.getElementById("transition-video-out");if(!t){const o=S(e);window.location.href=o;return}t.classList.add("active"),t.currentTime=0,t.play().then(()=>{t.addEventListener("ended",()=>{const o=S(e);window.location.href=o},{once:!0})}).catch(o=>{const i=S(e);window.location.href=i}),setTimeout(()=>{const o=S(e);window.location.href=o},1e4)}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),o=(e.lng+180)*(Math.PI/180),i=-(2.1*Math.sin(t)*Math.cos(o)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(o),a=new R(0,.3,32),l=new B({uniforms:{color:{value:new L(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
           ...
           `,side:te,transparent:!0,blending:O,depthWrite:!1}),d=new x(a,l);d.position.set(i,s,n),d.lookAt(0,0,0),this.scene.add(d);let u=performance.now();const h=()=>{const p=(performance.now()-u)/1e3;l.uniforms.time.value=p,p<2?requestAnimationFrame(h):(this.scene.remove(d),d.geometry.dispose(),l.dispose())};h(),r.to(d.scale,{x:4,y:4,z:1,duration:2,ease:"power1.out"}),r.to(l.uniforms.color.value,{r:1,g:.8,b:.2,duration:2,ease:"power1.out"})}exitHotspotMode(){this.orbitParams.inHotspotMode&&(this.orbitParams.inHotspotMode=!1,r.to(this.camera,{fov:60,duration:1,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}}),setTimeout(()=>{this.orbitParams.isOrbiting=!0,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed},500))}exitHotspotModeExternal(){this.exitHotspotMode()}handleVideoError(){new P().load("/mondes-immerges/interface/images/video-placeholder.jpg",t=>{this.globe&&this.globe.material&&(this.globe.material.uniforms&&this.globe.material.uniforms.map?this.globe.material.uniforms.map.value=t:this.globe.material.map=t,this.globe.material.needsUpdate=!0)})}zoom(e){const t=e?.85:1.15,o=this.orbitParams.zoomLevel*t;this.orbitParams.zoomLevel=Math.min(Math.max(o,this.orbitParams.minZoomLevel),this.orbitParams.maxZoomLevel),r.to(this.camera.position,{x:this.camera.position.x*t,y:this.camera.position.y*t,z:this.camera.position.z*t,duration:.5,ease:"back.out(1.2)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}resetView(){this.orbitParams.zoomLevel=1,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed;const e=this.orbitParams.ellipseMajorAxis,t=this.orbitParams.ellipseMinorAxis,o=this.orbitParams.inclination,i=this.orbitParams.orbitAngle,s=e*Math.cos(i),n=t*Math.sin(i),a=n*Math.sin(o),l=n*Math.cos(o);r.to(this.camera.position,{x:s,y:a,z:l,duration:1,ease:"elastic.out(1, 0.7)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}setHotspotSelectCallback(e){this.onHotspotSelect=e}setHotspotExitCallback(e){this.onHotspotExit=e}updateHotspotLabels(){if(this.orbitParams.inHotspotMode){this.hotspotObjects.forEach(e=>{e.userData.label&&(e.userData.label.style.opacity="0"),e.userData.connectorSvg&&(e.userData.connectorSvg.style.opacity="0")});return}this.hotspotObjects.forEach(e=>{if(!e.userData.label||!e.userData.worldPosition)return;const t=e.userData.worldPosition,o=t.clone().project(this.camera);if(o.z>1||o.x<-1||o.x>1||o.y<-1||o.y>1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}const i=new w().subVectors(t,this.camera.position).normalize(),n=new I(this.camera.position,i).intersectObject(this.globe);if(n.length>0){const b=n[0].distance,C=this.camera.position.distanceTo(t);if(b<C-.1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}}const a=(o.x*.5+.5)*window.innerWidth,l=(-o.y*.5+.5)*window.innerHeight,d=e.userData.labelText.length*7,u=40,h=-15;let p=a+u,m=l+h;const g=10;p+d>window.innerWidth-g&&(p=a-u-d),p<g&&(p=g),m<g&&(m=g),m>window.innerHeight-g&&(m=window.innerHeight-g),e.userData.label.style.left=`${p}px`,e.userData.label.style.top=`${m}px`,this.labelsVisible&&(e.userData.label.style.opacity="1");const f=e.userData.connectorLine;f&&(f.setAttribute("x1",a),f.setAttribute("y1",l),f.setAttribute("x2",p),f.setAttribute("y2",m+10),this.labelsVisible&&(e.userData.connectorSvg.style.opacity="1"))})}showLabels(){this.labelsVisible=!0,this.hotspotObjects.forEach((e,t)=>{e.userData.materials&&e.userData.materials.forEach((o,i)=>{const s=i===0?.8:.5;r.to(o,{opacity:s,duration:.8,delay:t*.1,ease:"power2.out"})})})}animate(){if(requestAnimationFrame(this.animate.bind(this)),this._contextLost)return;const e=this.clock.getDelta(),t=this.clock.getElapsedTime()*1e3;this.orbitParams.isOrbiting&&!this.orbitParams.inHotspotMode&&this.updateCameraPosition(),this.updateSkyboxTime&&this.updateSkyboxTime(t),this.hotspotObjects.forEach(o=>{const i=o.userData.waveRings;i&&i.forEach(s=>{s.userData.waveTime+=e;const n=s.userData.waveTime-s.userData.initialDelay;if(n>0){const l=n%2.5/2.5,d=.05,h=d+(.18-d)*l;s.geometry.dispose(),s.geometry=new R(h,h+.02,32),s.material.opacity=.7*(1-l)}})}),this.updateHotspotLabels(),this.clouds&&(this.clouds.rotation.y+=1e-4),this.globe&&!this.orbitParams.inHotspotMode&&(this.globe.rotation.y+=2e-4),this.globe&&this.globe.material.uniforms&&this.globe.material.uniforms.time&&(this.globe.material.uniforms.time.value=t),this.videoElement&&this.videoElement.paused&&!this.videoElement.ended&&!this._contextLost&&this.videoElement.play().catch(o=>{}),this.renderer.render(this.scene,this.camera)}}class ae{constructor(e){this.container=e.container,this.effectsContainer=null,this.notificationContainer=null,this.init()}init(){this.effectsContainer=document.createElement("div"),this.effectsContainer.classList.add("effects-container"),this.effectsContainer.style.position="absolute",this.effectsContainer.style.top="0",this.effectsContainer.style.left="0",this.effectsContainer.style.width="100%",this.effectsContainer.style.height="100%",this.effectsContainer.style.pointerEvents="none",this.effectsContainer.style.zIndex="5",this.container.appendChild(this.effectsContainer),this.createNotificationContainer()}createNotificationContainer(){this.notificationContainer=document.createElement("div"),this.notificationContainer.className="notification-container",this.notificationContainer.style.cssText=`
            ...
            pointer-events: none;
            max-width: 400px;
        `,this.container.appendChild(this.notificationContainer)}transitionIn(){const e=document.createElement("div");e.classList.add("transition-overlay"),e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.backgroundColor="#000000",e.style.zIndex="10",this.effectsContainer.appendChild(e),r.fromTo(e,{opacity:1},{opacity:0,duration:1.5,ease:"power2.out",onComplete:()=>{e.remove()}})}transitionOut(e){const t=document.createElement("div");t.classList.add("transition-overlay"),t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor="#000000",t.style.zIndex="10",t.style.opacity="0",this.effectsContainer.appendChild(t),r.to(t,{opacity:1,duration:1,ease:"power2.in",onComplete:()=>{e&&e()}})}createOrbitalLoaderEffect(e,t=4,o=null){const i=document.createElement("div");i.className="orbital-loader",o?i.style.cssText=`
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
        ...
        `;for(let u=0;u<3;u++){const h=document.createElement("div");h.style.cssText=`
            ...
            `;for(let p=0;p<3+u;p++){const m=document.createElement("div"),g=360/(3+u)*p;m.style.cssText=`
                    position: absolute;
                    width: ${8-u}px;
                    height: ${8-u}px;
        ...
        `,document.head.appendChild(l),(o||this.effectsContainer).appendChild(i),r.fromTo(i,{opacity:0},{opacity:1,duration:.5,onComplete:()=>{o&&e&&e()}}),setTimeout(()=>{o?(i.remove(),l.remove()):r.to(i,{opacity:0,duration:1,onComplete:()=>{i.remove(),l.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),r.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{r.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const i={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let s=0;s<i.pulseCount;s++)setTimeout(()=>{const n=document.createElement("div");n.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
                    ...
                    z-index: 100;
                    pointer-events: none;
                `,this.effectsContainer.appendChild(n),r.to(n,{width:i.radius*2,height:i.radius*2,opacity:0,duration:i.duration,ease:"power2.out",onComplete:()=>{n.remove()}})},s*(i.duration*300))}flashScreen(e="#ffffff"){const t=document.createElement("div");t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor=e,t.style.pointerEvents="none",t.style.zIndex="20",t.style.opacity="0",this.effectsContainer.appendChild(t),r.timeline().to(t,{opacity:.7,duration:.1}).to(t,{opacity:0,duration:.3,onComplete:()=>{t.remove()}})}showNotification(e,t="info",o=3e3){this.notificationContainer||this.createNotificationContainer();const i=document.createElement("div");i.className="notification";let s="",n="#2196F3";switch(t){case"success":s="✓",n="#4CAF50";break;case"warning":s="!",n="#FF9800";break;case"error":s="✗",n="#F44336";break;default:s="i",n="#2196F3"}i.innerHTML=`
        ...
        `;const a=i.querySelector(".notification-icon");a&&(a.style.cssText=`
            ...
            `);const l=i.querySelector(".notification-message");l&&(l.style.cssText=`
                flex: 1;
                line-height: 1.4;
            `),this.notificationContainer.appendChild(i),r.fromTo(i,{opacity:0,x:50},{opacity:1,x:0,duration:.4,ease:"power2.out"}),setTimeout(()=>{r.to(i,{opacity:0,x:50,duration:.4,ease:"power2.in",onComplete:()=>{i.remove()}})},o)}showSystemMessage(e){const t=document.createElement("div");t.className="system-message",t.textContent=e,t.style.cssText=`
            position: absolute;
            bottom: 20px;
            right: 20px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(i=>{i.style.cssText=`
            ...
            `,i.addEventListener("mouseenter",()=>{r.to(i,{backgroundColor:"rgba(255, 204, 0, 0.9)",color:"#000000",borderColor:"#ffcc00",boxShadow:"0 2px 15px rgba(255, 204, 0, 0.5), 0 0 8px rgba(255, 204, 0, 0.7)",duration:.25})}),i.addEventListener("mouseleave",()=>{r.to(i,{backgroundColor:"rgba(0, 10, 30, 0.7)",color:"#ffcc00",borderColor:"rgba(255, 204, 0, 0.7)",boxShadow:"0 2px 10px rgba(0, 0, 0, 0.3), 0 0 4px rgba(255, 204, 0, 0.4)",duration:.3})})}),this.infoBtn&&(this.infoBtn.style.cssText=`
                width: 50px;
                height: 50px;
                border-radius: 50%;
            ...
            `,this.infoBtn.addEventListener("mouseenter",()=>{r.to(this.infoBtn,{backgroundColor:"rgba(255, 204, 0, 0.9)",color:"#000000",borderColor:"#ffcc00",boxShadow:"0 2px 15px rgba(255, 204, 0, 0.5), 0 0 8px rgba(255, 204, 0, 0.7)",duration:.3})}),this.infoBtn.addEventListener("mouseleave",()=>{r.to(this.infoBtn,{backgroundColor:"rgba(0, 10, 30, 0.7)",color:"#ffcc00",borderColor:"rgba(255, 204, 0, 0.7)",boxShadow:"0 2px 10px rgba(0, 0, 0, 0.3), 0 0 4px rgba(255, 204, 0, 0.4)",duration:.3})})),this.infoOverlay){this.infoOverlay.style.cssText=`
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
            ...
            pointer-events: none;
            max-width: 400px;
        `,document.getElementById("main-container").appendChild(this.notificationContainer)}animateButtonsIn(){this.buttons.forEach(e=>{r.set(e,{opacity:0,y:20,scale:.8})}),this.buttons.forEach((e,t)=>{r.to(e,{opacity:1,y:0,scale:1,duration:.7,delay:1.5+t*.15,ease:"back.out(1.7)"})})}animateButtonClick(e){r.timeline().to(e,{scale:.85,duration:.15,ease:"power2.in"}).to(e,{scale:1,duration:.4,ease:"elastic.out(1.2, 0.5)"})}toggleInfoOverlay(){this.isInfoVisible?this.hideInfoOverlay():this.showInfoOverlay()}showInfoOverlay(){if(this.isInfoVisible)return;this.isInfoVisible=!0,this.infoOverlay.classList.add("visible"),r.to(this.infoOverlay,{opacity:1,duration:.4,ease:"power2.out",onStart:()=>{this.infoOverlay.style.pointerEvents="all"}});const e=this.infoOverlay.querySelector(".overlay-content");r.fromTo(e,{opacity:0,y:30,scale:.95},{opacity:1,y:0,scale:1,duration:.6,delay:.1,ease:"back.out(1.7)"}),e.querySelectorAll("h3, p, button").forEach((o,i)=>{r.fromTo(o,{opacity:0,y:20},{opacity:1,y:0,duration:.5,delay:.3+i*.1,ease:"power2.out"})})}hideInfoOverlay(){if(!this.isInfoVisible)return;this.isInfoVisible=!1;const e=this.infoOverlay.querySelector(".overlay-content");r.to(e,{opacity:0,y:30,scale:.95,duration:.4,ease:"power3.in"}),r.to(this.infoOverlay,{opacity:0,duration:.5,delay:.2,ease:"power2.in",onComplete:()=>{this.infoOverlay.classList.remove("visible"),this.infoOverlay.style.pointerEvents="none"}})}showNotification(e,t="info",o=3e3){const i=document.createElement("div");i.classList.add("notification",`notification-${t}`);let s="",n="#2196F3";switch(t){case"success":s="✓",n="#4CAF50";break;case"warning":s="!",n="#FF9800";break;case"error":s="✗",n="#F44336";break;default:s="i",n="#2196F3"}i.innerHTML=`
            <div class="notification-icon" style="background-color: ${n};">${s}</div>
            <div class="notification-message">${e}</div>
        `,i.style.cssText=`
            display: flex;
        ...
        `;i.querySelector(".notification-icon").style.cssText=a,i.querySelector(".notification-message").style.cssText=`
            flex: 1;
            line-height: 1.4;
        `,this.notificationContainer.appendChild(i),r.fromTo(i,{opacity:0,x:50},{opacity:1,x:0,duration:.4,ease:"power2.out"}),setTimeout(()=>{r.to(i,{opacity:0,x:50,duration:.4,ease:"power2.in",onComplete:()=>{i.remove()}})},o)}setUIVisibility(e){const t=e?1:0,o=e?0:20,i=e?"auto":"none",s=document.getElementById("ui-controls");s&&r.to(s,{opacity:t,y:o,duration:.4,ease:e?"power2.out":"power2.in",onComplete:()=>{s.style.pointerEvents=i}}),document.querySelectorAll(".satellite-hud, .coordinates-display").forEach(a=>{r.to(a,{opacity:t,duration:.4,ease:e?"power2.out":"power2.in"})})}showTooltip(e,t,o={}){const s={...{position:"top",duration:3e3,offset:10,className:""},...o},n=document.createElement("div");n.className=`tooltip ${s.className}`,n.textContent=t,n.style.cssText=`
            position: absolute;
        ...
        `,o.appendChild(i),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(l=>{const d=document.createElement("div");d.className="minimap-dot",d.dataset.id=l.id,d.title=l.name,d.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,d.addEventListener("mouseenter",()=>{r.to(d,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(d,l.name,{position:"top",duration:2e3})}),d.addEventListener("mouseleave",()=>{r.to(d,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),d.addEventListener("click",()=>{t&&t(l.id)}),o.appendChild(d)});const n=document.createElement("div");n.className="minimap-toggle",n.innerHTML="−",n.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
        ...
        `,this.drawerContent=document.createElement("div"),this.drawerContent.className="drawer-content",this.drawerContent.style.cssText=`
            ...
            grid-gap: 24px;
        `,this.drawer.appendChild(this.drawerContent),document.body.appendChild(this.drawer),this.drawerToggle.addEventListener("click",()=>{this.toggleDrawer()})}toggleDrawer(){this.isDrawerOpen?this.closeDrawer():this.openDrawer()}openDrawer(){if(this.isDrawerOpen||!this.drawer)return;this.isDrawerOpen=!0,this.drawer.style.display="block",r.to(this.drawer,{y:0,duration:.7,ease:"back.out(1.2)"});const e=this.drawerToggle.querySelector(".arrow");e&&(e.classList.remove("up"),e.classList.add("down")),this.drawerToggle&&r.to(this.drawerToggle,{bottom:"auto",top:-28,duration:.5}),this.panel&&r.to(this.panel,{scale:.95,opacity:.85,duration:.5,ease:"power2.out"})}closeDrawer(){if(!this.isDrawerOpen||!this.drawer)return;this.isDrawerOpen=!1,r.to(this.drawer,{y:"100%",duration:.5,ease:"power3.in",onComplete:()=>{this.drawer.style.display="none"}});const e=this.drawerToggle.querySelector(".arrow");e&&(e.classList.remove("down"),e.classList.add("up")),this.drawerToggle&&r.to(this.drawerToggle,{top:"auto",bottom:0,duration:.5}),this.panel&&r.to(this.panel,{scale:1,opacity:1,duration:.5,ease:"power2.out"})}update(e){if(!this.titleElement||!this.descriptionElement)return;this.titleElement.textContent=e.title||"Information";let t=e.description||"";if(e.coordinates&&(t=`
            ...
            `),this.descriptionElement.innerHTML=t,this.videoElement&&e.videoSrc){if(this.videoElement.style.display="block",this.videoElement.querySelector("source"))this.videoElement.querySelector("source").src=e.videoSrc;else{const o=document.createElement("source");o.src=e.videoSrc,o.type="video/mp4",this.videoElement.appendChild(o)}this.videoElement.load()}else this.videoElement&&(this.videoElement.style.display="none");if((e.detailedInfo||e.links)&&this.drawerContent){let o="";o+="<h3>INFORMATIONS COMPLÉMENTAIRES</h3>",e.detailedInfo&&(o+=`
                ...
                `),this.drawerContent.innerHTML=o,this.drawerToggle&&(this.drawerToggle.style.display="flex")}else this.drawerToggle&&(this.drawerToggle.style.display="none")}show(){if(this.isVisible||!this.panel)return;this.isVisible=!0,this.panel.classList.remove("hidden"),this.panel.classList.add("visible"),this.closeDrawer(),r.fromTo(this.panel,{x:"100%",opacity:0,scale:.95},{x:"0%",opacity:1,scale:1,duration:.7,ease:"back.out(1.2)"});const e=document.getElementById("main-container");e&&r.to(e.querySelectorAll(":not(#content-panel)"),{filter:"blur(2px)",opacity:.8,duration:.5,ease:"power2.out"})}hide(){if(!this.isVisible||!this.panel)return;this.isVisible=!1,this.isDrawerOpen&&this.closeDrawer(),r.to(this.panel,{x:"100%",opacity:0,scale:.95,duration:.5,ease:"power3.in",onComplete:()=>{this.panel.classList.remove("visible"),this.panel.classList.add("hidden"),this.videoElement&&this.videoElement.pause()}});const e=document.getElementById("main-container");e&&r.to(e.querySelectorAll(":not(#content-panel)"),{filter:"blur(0px)",opacity:1,duration:.5,ease:"power2.out"})}}const $=[{id:"grande-barriere",title:"Grande Barrière de Corail",position:{lat:-18.2871,lng:147.6992},description:`
        ...
        `;t.area&&(o+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(o+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(o+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(o+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),o+="</div>";let i="";e.detailedInfo&&(i=`
            ...
            ${i}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const N=new ue;function pe(){N.init()}function he(){return N}const y={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function me(){if(y.webGLChecked)return!0;try{const c=document.createElement("canvas"),e=c.getContext("webgl")||c.getContext("experimental-webgl");if(!e)return fe(),y.webGLChecked=!1,!1;y.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(c){return!1}}function fe(){const c=document.getElementById("loading-screen");c&&(c.innerHTML=`
        ...
        `)}function ge(){if(window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod/i.test(navigator.userAgent))return;const e=document.querySelector(".cursor"),t=document.querySelector(".cursor-follower");if(!e||!t)return;let o=0,i=0,s=0,n=0,a=null,l=0;const d=16,u=p=>{const m=performance.now();m-l<d||(l=m,o=p.clientX,i=p.clientY)};document.addEventListener("mousemove",u,{passive:!0});function h(){e.style.transform=`translate(${o}px, ${i}px)`,s+=(o-s)*.1,n+=(i-n)*.1,t.style.transform=`translate(${s}px, ${n}px)`,a=requestAnimationFrame(h)}a=requestAnimationFrame(h),window.addEventListener("beforeunload",()=>{a&&cancelAnimationFrame(a),document.removeEventListener("mousemove",u)},{once:!0})}async function be(){return new Promise(c=>{const e=document.querySelector("l-jelly"),t=document.getElementById("transition-video-in"),o=document.getElementById("loading-screen"),i=document.getElementById("main-container");if(!t){c();return}e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),i&&(i.style.opacity="1"),o&&(o.style.background="transparent"),M.register(t,{loop:!1,muted:!0,autoRetry:!0,name:"transition-video-in"}),t.classList.add("active"),t.currentTime=0,t.play().then(()=>{t.addEventListener("ended",function(){t.classList.remove("active"),o&&(o.style.display="none",o.classList.add("hidden")),setTimeout(()=>c(),300)},{once:!0})}).catch(s=>{t.classList.remove("active"),c()}),t.addEventListener("loadedmetadata",function(){const s=t.duration;setTimeout(()=>{t.classList.contains("active")&&(t.classList.remove("active"),c())},(s+2)*1e3)},{once:!0}),setTimeout(()=>{t.classList.contains("active")&&(t.classList.remove("active"),c())},15e3)})}async function ye(){if(!y.appStarted){y.appStarted=!0;try{pe();const c=he();if(!c)throw new Error("Instance application non disponible");xe(),c.globeManager&&c.globeManager.preloadAllAssets&&await c.globeManager.preloadAllAssets(),await be(),c.startExploration(!0),ve(c)}catch(c){we()}}}function xe(){const c=document.getElementById("main-container");if(!c)return;c.classList.remove("hidden"),c.style.opacity="0",c.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),o=document.querySelector(".satellite-crosshair"),i=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(s=>{s.style.opacity="0"}),o&&(o.style.opacity="0"),i&&(i.style.opacity="0")}function ve(c){const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),o=document.querySelector(".satellite-crosshair"),i=document.querySelectorAll(".hotspot-label"),s=document.querySelectorAll("svg"),n=document.querySelector(".scanner-effect");c&&c.globeManager&&c.globeManager.showLabels(),e&&(e.style.pointerEvents="auto"),window.gsap?(e&&gsap.to(e,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...t,o,n].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...i,...s],{opacity:1,duration:.8,ease:"power2.out"})):(e&&(e.style.transition="all 0.8s ease",e.style.opacity="1",e.style.transform="translateY(0)"),t.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),o&&(o.style.transition="opacity 0.8s ease",o.style.opacity="1"),n&&(n.style.transition="opacity 0.8s ease",n.style.opacity="1"),i.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),s.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}))}function we(c){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function Ee(){const c=document.getElementById("welcome-screen");c&&(c.style.display="none",c.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Me(){if(y.initialized||(y.initialized=!0,!me()))return;Ee();let c=0;const e=setInterval(()=>{c+=12.5,c>=100&&(clearInterval(e),setTimeout(()=>{ye()},300))},200)}function Ce(){y.cleanupDone||(y.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{y.domReady||(y.domReady=!0,ge(),setTimeout(()=>{Me()},100))});window.addEventListener("error",c=>{c.target!==window&&(c.target.tagName==="IMG"||c.target.tagName)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",c=>{c.preventDefault()},{once:!1});window.addEventListener("beforeunload",Ce,{once:!0});window.addEventListener("pageshow",c=>{(c.persisted||window.performance&&window.performance.navigation.type===2)&&window.location.reload()});
