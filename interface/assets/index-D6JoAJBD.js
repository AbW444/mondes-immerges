import{R as T,V,C as F,a as w,S as G,A as q,D as k,F as A,P as U,W as _,H as Y,T as I,b as v,M as E,c as x,d as W,B as X,e as Z,L as D,f as K,g as J,h as z,i as B,j as H,k as O,l as P,m as Q,n as ee,o as $,p as te}from"./three-DErGBpjY.js";import{g as l}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const ie={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},oe="/mondes-immerges/accueil/";function L(c){return ie[c]||oe}class se{constructor(){this.videos=new Map,this.isActive=!0,this._contextLost=!1,this._playInProgress=new Map,this.checkInterval=null}onContextLost(){this._contextLost=!0,this.stopMonitoring()}onContextRestored(){this._contextLost=!1,this.videos.forEach((e,t)=>{this._tryPlay(t)}),this.startMonitoring()}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement))return;const o={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,onError:t.onError||null,onPlay:t.onPlay||null,name:t.name||"video-"+this.videos.size};e.loop=o.shouldLoop,e.muted=o.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,o),e.addEventListener("ended",()=>{o.shouldLoop&&this.isActive&&!this._contextLost&&(e.currentTime=0,this._tryPlay(e))}),e.addEventListener("play",()=>{o.onPlay&&o.onPlay(e)});let i=0;e.addEventListener("error",s=>{o.onError&&o.onError(s),i<2&&this.isActive&&!this._contextLost&&(i++,setTimeout(()=>{e.load(),e.addEventListener("canplay",()=>this._tryPlay(e),{once:!0})},3e3*i))})}_tryPlay(e){if(!e||!this.isActive||this._contextLost||this._playInProgress.get(e))return;this._playInProgress.set(e,!0);const t=e.play();t&&t.then?t.then(()=>{this._playInProgress.set(e,!1)}).catch(()=>{this._playInProgress.set(e,!1)}):this._playInProgress.set(e,!1)}startMonitoring(e=1e4){this.checkInterval||(this.checkInterval=setInterval(()=>{!this.isActive||this._contextLost||this.videos.forEach((t,o)=>{o.paused&&!o.ended&&t.shouldLoop&&this._tryPlay(o)})},e))}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null)}unregister(e){this.videos.delete(e),this._playInProgress.delete(e)}unregisterAll(){this.videos.clear(),this._playInProgress.clear()}disable(){this.isActive=!1,this.stopMonitoring()}enable(){this.isActive=!0,this.startMonitoring()}destroy(){this.disable(),this.unregisterAll()}}const M=new se;class ne{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new T,this.mouse=new V,this.clock=new F,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.init()}init(){this.scene=new G;const e=new q(16777215,1.2);this.scene.add(e);const t=new k(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new U(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const o=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),i=o||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new _({antialias:!o,alpha:!0,logarithmicDepthBuffer:!i,powerPreference:"high-performance",precision:o?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(o?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!1,this.isMobile=o,this.container.appendChild(this.renderer.domElement);const s=this.renderer.domElement;s.addEventListener("webglcontextlost",n=>{n.preventDefault(),this._contextLost=!0,M.onContextLost()}),s.addEventListener("webglcontextrestored",()=>{this._contextLost=!1,M.onContextRestored()})}catch(o){this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.classList.add("hotspot-connector"),s.style.cssText=`
            ...
            z-index: 50;
            opacity: 0;
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(i),document.body.appendChild(s);const a=()=>{i.style.backgroundColor="rgba(255, 204, 0, 0.9)",i.style.color="#000",i.style.transform="scale(1.05)"},r=()=>{i.style.backgroundColor="rgba(0, 0, 0, 0.8)",i.style.color="#ffdd00",i.style.transform="scale(1)"},d=u=>{u.stopPropagation();const h=e.userData.hotspot;h&&this.activateHotspot(h)};i.addEventListener("mouseenter",a),i.addEventListener("mouseleave",r),i.addEventListener("click",d),e.userData.label=i,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=o.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:r,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const i=t[0].point,n=Math.acos(i.y/2),a=Math.atan2(i.z,i.x),r=90-n*180/Math.PI,d=a*180/Math.PI-180,u=this._findNearestHotspot(r,d,10);if(u){this.activateHotspot(u);return}}const o=this.raycaster.intersectObjects(this.hotspotObjects);if(o.length>0){const i=o[0].object.userData.hotspot;this.activateHotspot(i)}}_findNearestHotspot(e,t,o){let i=null,s=o;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const r=a.position.lat,d=a.position.lng,u=Math.sqrt(Math.pow(r-e,2)+Math.pow(d-t,2));u<s&&(s=u,i=a)}return i}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;const t=e.position.lat*(Math.PI/180),o=e.position.lng*(Math.PI/180),i=2.1,s=i*Math.cos(t)*Math.cos(o),n=i*Math.sin(t),a=i*Math.cos(t)*Math.sin(o),r=new w(s,n,a);this.orbitParams.isOrbiting=!1;const d=this.camera.position.clone(),p=r.clone().normalize().multiplyScalar(5.2),m=new w().addVectors(d,p).multiplyScalar(.5);m.normalize().multiplyScalar(m.length()+1.8);const f=l.timeline();f.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}});let b=document.getElementById("fade-overlay");b||(b=document.createElement("div"),b.id="fade-overlay",b.style.cssText=`
                position: fixed;
                top: 0;
                left: 0;
                width: 100%;
        ...
        `,s.appendChild(a),i.appendChild(s);const r=document.createElement("style");r.textContent=`
            @keyframes orbit0 {
        ...
        `,document.head.appendChild(r),(o||this.effectsContainer).appendChild(i),l.fromTo(i,{opacity:0},{opacity:1,duration:.5,onComplete:()=>{o&&e&&e()}}),setTimeout(()=>{o?(i.remove(),r.remove()):l.to(i,{opacity:0,duration:1,onComplete:()=>{i.remove(),r.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),l.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{l.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const i={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let s=0;s<i.pulseCount;s++)setTimeout(()=>{const n=document.createElement("div");n.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
        ...
        `;const a=i.querySelector(".notification-icon");a&&(a.style.cssText=`
                ...
                font-weight: bold;
                flex-shrink: 0;
            `);const r=i.querySelector(".notification-message");r&&(r.style.cssText=`
                flex: 1;
                line-height: 1.4;
        ...
        `,this.effectsContainer.appendChild(t),l.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const o={...{count:50,container:this.container},...e},i=document.createElement("div");i.className="background-particles",i.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<o.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,r=Math.random()*100,d=Math.random()*100,u=Math.random()*5,h=Math.random()*10+10,p=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(i=>{i.style.cssText=`
        ...
        `,o.appendChild(i),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(r=>{const d=document.createElement("div");d.className="minimap-dot",d.dataset.id=r.id,d.title=r.name,d.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,d.addEventListener("mouseenter",()=>{l.to(d,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(d,r.name,{position:"top",duration:2e3})}),d.addEventListener("mouseleave",()=>{l.to(d,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),d.addEventListener("click",()=>{t&&t(r.id)}),o.appendChild(d)});const n=document.createElement("div");n.className="minimap-toggle",n.innerHTML="−",n.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
