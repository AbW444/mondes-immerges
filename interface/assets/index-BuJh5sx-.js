import{R as q,V as X,C as Y,a as w,S as _,A as k,D as A,F as z,P as Z,W as K,b as J,c as B,L as T,d as D,e as O,H as Q,T as L,f as E,M as S,g as v,h as ee,B as te,i as $,j as H,k as N,l as V,m as oe,n as ie,o as R,p as ne,q as se}from"./three-Bmxrupip.js";import{g as c}from"./gsap-xHO-obUW.js";import{i as ae}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const re={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},le="/nationalgeographic.fr-mondesimmerges/accueil/";function ce(r){return re[r]||le}class de{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new q,this.mouse=new X,this.clock=new Y,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new _;const e=new k(16777215,1.2);this.scene.add(e);const t=new A(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new z(0,15e-5),this.camera=new Z(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new K({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=J;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,e.appendChild(t),this.container.appendChild(e)}setupLighting(){const e=new k(4210768,.5);this.scene.add(e);const t=new A(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new Q(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new L,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new E(3,32,32),o=new S({map:t,transparent:!0,opacity:.95}),n=new v(i,o);n.position.copy(this.celestialParams.sunPosition),this.scene.add(n);const s=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),l=new E(1.5,32,32),d=new ee({map:s}),a=new v(l,d);a.position.copy(this.celestialParams.moonPosition),this.scene.add(a),this.sun=n,this.moon=a}createOrbitPath(){const e=[];for(let n=0;n<=100;n++){const s=n/100*Math.PI*2,l=this.orbitParams.ellipseMajorAxis,d=this.orbitParams.ellipseMinorAxis,a=this.orbitParams.inclination;let p=l*Math.cos(s),u=d*Math.sin(s);const h=u*Math.sin(a);u=u*Math.cos(a),e.push(new w(p,h,u))}new te().setFromPoints(e);const i=new E(.2,16,16),o=new S({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new v(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(a=>{console.error("Impossible de relancer la vidéo:",a)}))},1e3),this.videoTexture=new B(e),this.videoTexture.minFilter=T,this.videoTexture.magFilter=T,this.videoTexture.format=D,this.videoTexture.colorSpace=O;const t=new E(1.99,64,64),i=new S({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:$}),o=new v(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const n=new E(2,64,64),s=new S({map:this.videoTexture,transparent:!0,opacity:1,side:$,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new v(n,s),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const l=new E(2.02,64,64),d=new S({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new v(l,d),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(a=>{console.error("Erreur lors de la lecture de la vidéo:",a),this.handleVideoError()})}createAtmosphere(){const e=new E(2.08,64,64),t=new H({vertexShader:`
            ...
            `,uniforms:{cameraPosition:{value:new w}},blending:V,side:N,transparent:!0}),i=new v(e,t);this.scene.add(i),this.atmosphere=i,this.updateAtmosphereUniforms=()=>{this.atmosphere&&this.atmosphere.material.uniforms&&this.atmosphere.material.uniforms.cameraPosition.value.copy(this.camera.position)}}createSkybox(){new L().load("/nationalgeographic.fr-mondesimmerges/interface/images/night-sky.png",i=>{this.renderer.toneMapping=oe,this.renderer.toneMappingExposure=.3;const o=new ie(i.image.height);o.fromEquirectangularTexture(this.renderer,i),this.scene.background=o.texture,this.scene.fog=new z(17,8e-5)},void 0,i=>{console.error("Erreur lors du chargement de la texture du ciel:",i),this.scene.background=new R(17)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const n=this.orbitParams.inclination,s=o*Math.sin(n);o=o*Math.cos(n),this.camera.position.set(i,s,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,s,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new w(i,s,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const n=this.orbitParams.inclination,s=o*Math.sin(n);o=o*Math.cos(n),this.camera.position.set(i,s,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(i=>{if(this.scene.remove(i),i.userData.labelContainer)try{i.userData.labelContainer.parentNode&&i.userData.labelContainer.parentNode.removeChild(i.userData.labelContainer)}catch(o){console.warn("Erreur lors de la suppression du label:",o)}}),this.hotspotObjects=[],document.querySelectorAll(".hotspot-label-container").forEach(i=>{try{i.parentNode&&i.parentNode.removeChild(i)}catch(o){console.warn("Erreur lors du nettoyage des labels orphelins:",o)}}),e.forEach(i=>{const{position:o,title:n}=i,s=o.lat*(Math.PI/180),l=o.lng*(Math.PI/180),d=2.1,a=d*Math.cos(s)*Math.cos(l),p=d*Math.sin(s),u=d*Math.cos(s)*Math.sin(l);console.log(`Hotspot ${n}: GPS(${o.lat}, ${o.lng}) -> 3D(${a.toFixed(2)}, ${p.toFixed(2)}, ${u.toFixed(2)})`);const h=new E(.05,16,16),m=new S({color:16763904,transparent:!0,opacity:.8}),g=new v(h,m);g.position.set(a,p,u),g.userData={hotspot:i};const M=new E(.08,16,16),C=new S({color:16763904,transparent:!0,opacity:.5,side:N}),f=new v(M,C);g.add(f),this.addHotspotLabel(g,n,new w(a,p,u)),this.scene.add(g),this.hotspotObjects.push(g)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label-container",o.style.cssText=`
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        `;const n=document.createElement("div");n.className="hotspot-label",n.textContent=t,n.style.cssText=`
            ...
            pointer-events: auto;
            cursor: pointer;
        `,n.addEventListener("mouseenter",()=>{n.style.backgroundColor="rgba(255, 204, 0, 0.9)",n.style.color="#000",n.style.transform="scale(1.05)"}),n.addEventListener("mouseleave",()=>{n.style.backgroundColor="rgba(0, 0, 0, 0.7)",n.style.color="#ffcc00",n.style.transform="scale(1)"}),n.addEventListener("click",d=>{d.stopPropagation();const a=e.userData.hotspot;a&&(console.log(`Label cliqué: ${a.title}`),this.activateHotspot(a))});const s=document.createElement("div");s.className="connector-line",s.style.cssText=`
            position: absolute;
        ...
        `,o.appendChild(n),o.appendChild(s),document.body.appendChild(o),e.userData.label=n,e.userData.connector=s,e.userData.labelContainer=o,e.userData.worldPosition=i.clone();const l=d=>{const a=new w().copy(d).project(this.camera);if(a.z>1||a.x<-1||a.x>1||a.y<-1||a.y>1)return!1;const p=new w().subVectors(d,this.camera.position).normalize(),h=new q(this.camera.position,p).intersectObject(this.globe);if(h.length>0){const m=h[0].distance,g=this.camera.position.distanceTo(d);return m>g-.1}return!0};e.onBeforeRender=()=>{if(!e.userData.label||!e.userData.connector)return;if(l(e.userData.worldPosition)&&!this.orbitParams.inHotspotMode){const a=e.userData.worldPosition.clone();a.project(this.camera);const p=(a.x*.5+.5)*window.innerWidth,u=(-a.y*.5+.5)*window.innerHeight,h=window.innerWidth/2,m=window.innerHeight/2,g=Math.sqrt(Math.pow(p-h,2)+Math.pow(u-m,2)),M=Math.atan2(u-m,p-h),C=Math.min(h,m)*.6;let f,x;if(g<C){const P=C+60+Math.sin(M*5)*20;f=h+Math.cos(M)*P,x=m+Math.sin(M)*P;const b=20;f<b&&(f=b),f>window.innerWidth-b&&(f=window.innerWidth-b),x<b&&(x=b),x>window.innerHeight-b&&(x=window.innerHeight-b)}else{const P=t.length*8,b=25+P*.25,I=10;p+b+P>window.innerWidth-20?f=p-b-P:f=p+b,u-I-30<20?x=u+I:x=u-I}e.userData.label.style.left=`${f}px`,e.userData.label.style.top=`${x}px`,e.userData.label.style.opacity="1",s.style.left=`${p}px`,s.style.top=`${u}px`;const W=Math.sqrt(Math.pow(f-p,2)+Math.pow(x-u,2)),U=Math.atan2(x-u,f-p);s.style.width=`${W}px`,s.style.transform=`rotate(${U}rad)`,s.style.opacity="1",s.style.animation="pulseConnector 2s infinite alternate"}else e.userData.label.style.opacity="0",s.style.opacity="0"}}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),l=Math.atan2(o.z,o.x),d=90-s*180/Math.PI,a=l*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${d.toFixed(2)}, lng: ${a.toFixed(2)}`);const p=this._findNearestHotspot(d,a,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(l=>l.userData.hotspot).filter(Boolean);for(const l of s){const d=l.position.lat,a=l.position.lng,p=Math.sqrt(Math.pow(d-e,2)+Math.pow(a-t,2));p<n&&(n=p,o=l)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),l=o*Math.cos(t)*Math.sin(i),d=new w(n,s,l);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=d.clone().normalize().multiplyScalar(3.5);c.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),c.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
           ...
           z-index: 9999;
           pointer-events: none;
       `,document.body.appendChild(t),c.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=ce(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),l=new ne(0,.3,32),d=new H({uniforms:{color:{value:new R(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,this.container.appendChild(this.notificationContainer)}transitionIn(){const e=document.createElement("div");e.classList.add("transition-overlay"),e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.backgroundColor="#000000",e.style.zIndex="10",this.effectsContainer.appendChild(e),c.fromTo(e,{opacity:1},{opacity:0,duration:1.5,ease:"power2.out",onComplete:()=>{e.remove()}})}transitionOut(e){const t=document.createElement("div");t.classList.add("transition-overlay"),t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.width="100%",t.style.height="100%",t.style.backgroundColor="#000000",t.style.zIndex="10",t.style.opacity="0",this.effectsContainer.appendChild(t),c.to(t,{opacity:1,duration:1,ease:"power2.in",onComplete:()=>{e&&e()}})}createOrbitalLoaderEffect(e,t=4,i=null){const o=document.createElement("div");o.className="orbital-loader",i?o.style.cssText=`
            ...
            justify-content: center;
            align-items: center;
        `;for(let a=0;a<3;a++){const p=document.createElement("div");p.style.cssText=`
                position: absolute;
                border-radius: 50%;
                border: 2px solid rgba(255, 204, 0, ${.7-a*.2});
                width: ${120+a*40}px;
                height: ${120+a*40}px;
                animation: orbit${a} ${4-a*.5}s linear infinite;
            `;for(let u=0;u<3+a;u++){const h=document.createElement("div"),m=360/(3+a)*u;h.style.cssText=`
                    position: absolute;
                    width: ${8-a}px;
                    height: ${8-a}px;
                    ...
                    transform: translate(-50%, -50%) rotate(${m}deg) translateX(${60+a*20}px);
        ...
        `,n.appendChild(s),o.appendChild(n);const l=document.createElement("style");l.textContent=`
            @keyframes orbit0 {
        ...
        `,o.style.cssText=`
            ...
            backdrop-filter: blur(5px);
        `;const l=o.querySelector(".notification-icon");l&&(l.style.cssText=`
                display: flex;
                align-items: center;
                justify-content: center;
                width: 24px;
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),l=Math.random()*3+1,d=Math.random()*100,a=Math.random()*100,p=Math.random()*5,u=Math.random()*10+10,h=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${l}px;
                height: ${l}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
            ...
            `;const o=this.infoOverlay.querySelector(".overlay-content");if(o){o.style.cssText=`
                ...
                `;const n=o.querySelector("h3");if(n&&(n.style.cssText=`
                    ...
                    `),o.querySelectorAll("p").forEach(l=>{l.style.cssText=`
                        margin-bottom: 25px;
                        line-height: 1.8;
                        color: #e0e0e0;
                        font-size: 1.1rem;
                    ...
                    `,document.head.appendChild(l)}}}}createNotificationContainer(){this.notificationContainer=document.createElement("div"),this.notificationContainer.className="notifications-container",this.notificationContainer.style.cssText=`
            position: absolute;
            bottom: 30px;
            right: 30px;
            display: flex;
        ...
        `,document.body.appendChild(s);const l=e.getBoundingClientRect();switch(n.position){case"top":s.style.bottom=`${window.innerHeight-l.top+n.offset}px`,s.style.left=`${l.left+l.width/2}px`,s.style.transform="translateX(-50%) scale(0.9)";break;case"bottom":s.style.top=`${l.bottom+n.offset}px`,s.style.left=`${l.left+l.width/2}px`,s.style.transform="translateX(-50%) scale(0.9)";break;case"left":s.style.top=`${l.top+l.height/2}px`,s.style.right=`${window.innerWidth-l.left+n.offset}px`,s.style.transform="translateY(-50%) scale(0.9)";break;case"right":s.style.top=`${l.top+l.height/2}px`,s.style.left=`${l.right+n.offset}px`,s.style.transform="translateY(-50%) scale(0.9)";break}return c.to(s,{opacity:1,scale:1,duration:.3,ease:"back.out(1.7)"}),setTimeout(()=>{c.to(s,{opacity:0,scale:.9,duration:.2,ease:"power2.in",onComplete:()=>{s.remove()}})},n.duration),{hide:()=>{c.to(s,{opacity:0,scale:.9,duration:.2,ease:"power2.in",onComplete:()=>{s.remove()}})}}}createMinimap(e,t){const i=document.createElement("div");i.className="minimap",i.style.cssText=`
            position: absolute;
            bottom: 30px;
            right: 30px;
            width: 200px;
        ...
        `,i.appendChild(o),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(d=>{const a=document.createElement("div");a.className="minimap-dot",a.dataset.id=d.id,a.title=d.name,a.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,a.addEventListener("mouseenter",()=>{c.to(a,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(a,d.name,{position:"top",duration:2e3})}),a.addEventListener("mouseleave",()=>{c.to(a,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),a.addEventListener("click",()=>{t&&t(d.id)}),i.appendChild(a)});const s=document.createElement("div");s.className="minimap-toggle",s.innerHTML="−",s.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${n}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.visualEffects&&this.visualEffects.showNotification("Retour à l'exploration globale","info",3e3),this.currentHotspot=null}}const F=new ge;function be(){F.init()}function ye(){return F}const y={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function xe(){if(y.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),ve(),y.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),y.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return console.error("❌ Erreur vérification WebGL:",r),!1}}function ve(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
        ...
        `)}function we(){const r=document.getElementById("loading-screen");if(!r)return;const e=r.querySelector(".spinner");e&&e.remove();try{ae.register();const t=document.createElement("l-jelly");t.setAttribute("size","60"),t.setAttribute("speed","0.9"),t.setAttribute("color","#ffcc00"),r.insertBefore(t,r.firstChild),console.log("✅ Spinner initialisé")}catch(t){console.warn("⚠️  Fallback spinner CSS");const i=document.createElement("div");i.className="spinner",r.insertBefore(i,r.firstChild)}}function Ee(){const r=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!r||!e)return;let t=0,i=0,o=0,n=0,s=null;const l=a=>{t=a.clientX,i=a.clientY};document.addEventListener("mousemove",l,{passive:!0});function d(){r.style.left=t+"px",r.style.top=i+"px",o+=(t-o)*.1,n+=(i-n)*.1,e.style.left=o+"px",e.style.top=n+"px",s=requestAnimationFrame(d)}s=requestAnimationFrame(d),window.addEventListener("beforeunload",()=>{s&&cancelAnimationFrame(s),document.removeEventListener("mousemove",l)}),console.log("✅ Curseur initialisé")}async function Me(){if(y.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),y.appStarted=!0;try{be();const r=ye();if(!r)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),Ce(),Se(),setTimeout(()=>{r.startupSequence&&typeof r.startupSequence=="function"?(console.log("🎬 Séquence de démarrage..."),r.startupSequence(()=>{j(),setTimeout(()=>{console.log("🌊 Démarrage exploration..."),r.startExploration(!0)},1e3)})):(console.log("🌊 Démarrage direct..."),j(),r.startExploration(!0))},300)}catch(r){console.error("❌ Erreur application:",r),Pe()}}function Ce(){const r=document.getElementById("loading-screen");if(!r)return;const e=r.querySelector("l-jelly"),t=r.querySelector(".spinner");e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),t&&(t.style.transition="opacity 0.3s ease",t.style.opacity="0",setTimeout(()=>t.remove(),300)),console.log("✅ Spinner caché, fond noir conservé")}function Se(){const r=document.getElementById("main-container");r&&(r.classList.remove("hidden"),r.style.opacity="0",r.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)")}function j(){const r=document.getElementById("loading-screen");if(!r)return;r.style.transition="opacity 2s cubic-bezier(0.19, 1, 0.22, 1)",r.style.opacity="0";const e=document.getElementById("main-container");e&&setTimeout(()=>{e.style.opacity="1"},500),setTimeout(()=>{r.style.display="none",r.classList.add("hidden"),console.log("✅ Écran de chargement complètement masqué")},2e3)}function Pe(r){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `,document.head.appendChild(t)}function Ie(){if(y.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),y.initialized=!0,!xe())return;Te(),we();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{Me()},300))},200)}function Le(){y.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),y.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(y.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),y.domReady=!0,Ee(),setTimeout(()=>{Ie()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Le,{once:!0});
