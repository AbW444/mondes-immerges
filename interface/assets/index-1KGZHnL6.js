import{R as q,V as X,C as Y,a as v,S as _,A as k,D as A,F as z,P as Z,W as K,b as J,c as B,L as T,d as D,e as O,H as Q,T as L,f as w,M as S,g as x,h as ee,B as te,i as $,j as H,k as N,l as V,m as oe,n as ie,o as R,p as ne,q as se}from"./three-Bmxrupip.js";import{g as c}from"./gsap-xHO-obUW.js";import{i as ae}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const re={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},le="/nationalgeographic.fr-mondesimmerges/accueil/";function ce(r){return re[r]||le}class de{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new q,this.mouse=new X,this.clock=new Y,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:12,ellipseMinorAxis:8,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.1,minZoomLevel:.6,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new v(100,20,100),moonPosition:new v(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new _;const e=new k(16777215,1.2);this.scene.add(e);const t=new A(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new z(0,15e-5),this.camera=new Z(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new K({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=J;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `,e.appendChild(t),this.container.appendChild(e)}setupLighting(){const e=new k(4210768,.5);this.scene.add(e);const t=new A(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new Q(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new L,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new w(3,32,32),o=new S({map:t,transparent:!0,opacity:.95}),n=new x(i,o);n.position.copy(this.celestialParams.sunPosition),this.scene.add(n);const s=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),l=new w(1.5,32,32),d=new ee({map:s}),a=new x(l,d);a.position.copy(this.celestialParams.moonPosition),this.scene.add(a),this.sun=n,this.moon=a}createOrbitPath(){const e=[];for(let n=0;n<=100;n++){const s=n/100*Math.PI*2,l=this.orbitParams.ellipseMajorAxis,d=this.orbitParams.ellipseMinorAxis,a=this.orbitParams.inclination;let p=l*Math.cos(s),u=d*Math.sin(s);const m=u*Math.sin(a);u=u*Math.cos(a),e.push(new v(p,m,u))}new te().setFromPoints(e);const i=new w(.2,16,16),o=new S({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(a=>{console.error("Impossible de relancer la vidéo:",a)}))},1e3),this.videoTexture=new B(e),this.videoTexture.minFilter=T,this.videoTexture.magFilter=T,this.videoTexture.format=D,this.videoTexture.colorSpace=O;const t=new w(1.99,64,64),i=new S({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:$}),o=new x(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const n=new w(2,64,64),s=new S({map:this.videoTexture,transparent:!0,opacity:1,side:$,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(n,s),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const l=new w(2.02,64,64),d=new S({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(l,d),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(a=>{console.error("Erreur lors de la lecture de la vidéo:",a),this.handleVideoError()})}createAtmosphere(){const e=new w(2.08,64,64),t=new H({vertexShader:`
        ...
        `,o.appendChild(n),o.appendChild(s),document.body.appendChild(o),e.userData.label=n,e.userData.connector=s,e.userData.labelContainer=o,e.userData.worldPosition=i.clone();const l=d=>{const a=new v().copy(d).project(this.camera);if(a.z>1||a.x<-1||a.x>1||a.y<-1||a.y>1)return!1;const p=new v().subVectors(d,this.camera.position).normalize(),m=new q(this.camera.position,p).intersectObject(this.globe);if(m.length>0){const h=m[0].distance,M=this.camera.position.distanceTo(d);return h>M-.1}return!0};e.onBeforeRender=()=>{if(!e.userData.label||!e.userData.connector)return;if(l(e.userData.worldPosition)&&!this.orbitParams.inHotspotMode){const a=e.userData.worldPosition.clone();a.project(this.camera);const p=(a.x*.5+.5)*window.innerWidth,u=(-a.y*.5+.5)*window.innerHeight,m=window.innerWidth/2,h=window.innerHeight/2,M=Math.sqrt(Math.pow(p-m,2)+Math.pow(u-h,2)),E=Math.atan2(u-h,p-m),C=Math.min(m,h)*.6;let f,y;if(M<C){const P=C+60+Math.sin(E*5)*20;f=m+Math.cos(E)*P,y=h+Math.sin(E)*P;const g=20;f<g&&(f=g),f>window.innerWidth-g&&(f=window.innerWidth-g),y<g&&(y=g),y>window.innerHeight-g&&(y=window.innerHeight-g)}else{const P=t.length*8,g=25+P*.25,I=10;p+g+P>window.innerWidth-20?f=p-g-P:f=p+g,u-I-30<20?y=u+I:y=u-I}e.userData.label.style.left=`${f}px`,e.userData.label.style.top=`${y}px`,e.userData.label.style.opacity="1",s.style.left=`${p}px`,s.style.top=`${u}px`;const W=Math.sqrt(Math.pow(f-p,2)+Math.pow(y-u,2)),U=Math.atan2(y-u,f-p);s.style.width=`${W}px`,s.style.transform=`rotate(${U}rad)`,s.style.opacity="1",s.style.animation="pulseConnector 2s infinite alternate"}else e.userData.label.style.opacity="0",s.style.opacity="0"}}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),l=Math.atan2(o.z,o.x),d=90-s*180/Math.PI,a=l*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${d.toFixed(2)}, lng: ${a.toFixed(2)}`);const p=this._findNearestHotspot(d,a,10);if(p){console.log(`Hotspot trouvé: ${p.title}`),this.activateHotspot(p);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(l=>l.userData.hotspot).filter(Boolean);for(const l of s){const d=l.position.lat,a=l.position.lng,p=Math.sqrt(Math.pow(d-e,2)+Math.pow(a-t,2));p<n&&(n=p,o=l)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),l=o*Math.cos(t)*Math.sin(i),d=new v(n,s,l);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const u=d.clone().normalize().multiplyScalar(3.5);c.to(this.camera.position,{x:u.x,y:u.y,z:u.z,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}}),c.to(this.camera,{fov:40,duration:1.5,ease:"power2.inOut",onUpdate:()=>{this.camera.updateProjectionMatrix()}})}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
       ...
       `,document.body.appendChild(t),c.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=ce(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),l=new ne(0,.3,32),d=new H({uniforms:{color:{value:new R(16763904)},time:{value:0}},vertexShader:`
        ...
        `;for(let a=0;a<3;a++){const p=document.createElement("div");p.style.cssText=`
            ...
            `;for(let u=0;u<3+a;u++){const m=document.createElement("div"),h=360/(3+a)*u;m.style.cssText=`
                    position: absolute;
                    width: ${8-a}px;
                    height: ${8-a}px;
                    ...
                    transform: translate(-50%, -50%) rotate(${h}deg) translateX(${60+a*20}px);
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),l=Math.random()*3+1,d=Math.random()*100,a=Math.random()*100,p=Math.random()*5,u=Math.random()*10+10,m=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${l}px;
                height: ${l}px;
                ...
                top: ${a}%;
                left: ${d}%;
                box-shadow: 0 0 ${l*2}px rgba(255, 255, 255, ${m*.8});
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${n}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.visualEffects&&this.visualEffects.showNotification("Retour à l'exploration globale","info",3e3),this.currentHotspot=null}}const F=new ge;function be(){F.init()}function ye(){return F}const b={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function xe(){if(b.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),ve(),b.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),b.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return console.error("❌ Erreur vérification WebGL:",r),!1}}function ve(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
    ...
    `,document.head.appendChild(t)}function Ie(){if(b.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),b.initialized=!0,!xe())return;Te(),we();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{Me()},300))},200)}function Le(){b.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),b.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(b.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),b.domReady=!0,Ee(),setTimeout(()=>{Ie()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Le,{once:!0});
