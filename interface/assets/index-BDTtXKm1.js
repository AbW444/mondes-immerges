import{R as P,V as F,C as U,a as v,S as W,A as I,D as L,F as q,P as Y,W as X,b as _,c as k,L as C,d as A,e as D,H as Z,T as S,f as x,M as w,g,h as K,B as J,i as z,j as B,k as T,l as H,m as Q,n as ee,o as O,p as te,q as oe}from"./three-Bmxrupip.js";import{g as l}from"./gsap-xHO-obUW.js";import{i as ie}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const se={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ne="/nationalgeographic.fr-mondesimmerges/accueil/";function ae(r){return se[r]||ne}class re{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new P,this.mouse=new F,this.clock=new U,this.labelsVisible=!1,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:1.3,minZoomLevel:.5,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new v(100,20,100),moonPosition:new v(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new W;const e=new I(16777215,1.2);this.scene.add(e);const t=new L(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new q(0,15e-5),this.camera=new Y(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new X({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=_;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.createSkybox(),this.setupLighting(),this.createGlobe(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this)),this.addLogo()}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,e.appendChild(t),this.container.appendChild(e)}setupLighting(){const e=new I(4210768,.5);this.scene.add(e);const t=new L(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new Z(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new S,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new x(3,32,32),o=new w({map:t,transparent:!0,opacity:.95}),s=new g(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new x(1.5,32,32),c=new K({map:n}),d=new g(a,c);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,c=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),p=c*Math.sin(n);const h=p*Math.sin(d);p=p*Math.cos(d),e.push(new v(u,h,p))}new J().setFromPoints(e);const i=new x(.2,16,16),o=new w({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new g(i,o),this.scene.add(this.cameraMarker)}createGlobe(){const e=document.createElement("video");e.src=this.currentVideoPath,e.loop=!0,e.muted=!0,e.autoplay=!0,e.playsInline=!0,e.crossOrigin="anonymous",this.videoElement=e,e.addEventListener("ended",()=>{e.play()}),setInterval(()=>{e.paused&&!e.ended&&(console.log("Vidéo en pause, relance..."),e.play().catch(d=>{console.error("Impossible de relancer la vidéo:",d)}))},1e3),this.videoTexture=new k(e),this.videoTexture.minFilter=C,this.videoTexture.magFilter=C,this.videoTexture.format=A,this.videoTexture.colorSpace=D;const t=new x(1.99,64,64),i=new w({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:z}),o=new g(t,i);o.renderOrder=0,this.scene.add(o),this.depthSphere=o;const s=new x(2,64,64),n=new w({map:this.videoTexture,transparent:!0,opacity:1,side:z,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new g(s,n),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const a=new x(2.02,64,64),c=new w({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new g(a,c),this.clouds.renderOrder=2,this.scene.add(this.clouds),e.play().catch(d=>{console.error("Erreur lors de la lecture de la vidéo:",d),this.handleVideoError()})}createAtmosphere(){const e=new x(2.15,64,64),t=new B({vertexShader:`
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.visualEffects&&this.visualEffects.showNotification("Retour à l'exploration globale","info",3e3),this.currentHotspot=null}}const R=new me;function he(){R.init()}function fe(){return R}const b={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function ge(){if(b.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),be(),b.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),b.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return console.error("❌ Erreur vérification WebGL:",r),!1}}function be(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
    ...
    `)}function Ce(){const r=document.getElementById("welcome-screen");r&&(r.style.display="none",r.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Se(){if(b.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),b.initialized=!0,!ge())return;Ce(),ye();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{ve()},300))},200)}function Te(){b.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),b.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(b.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),b.domReady=!0,xe(),setTimeout(()=>{Se()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Te,{once:!0});
