import{R as T,V as _,C as F,a as w,S as G,A as q,D as k,F as A,P as U,W as Y,H as W,T as I,b as v,M as E,c as y,d as X,B as Z,e as K,L as D,f as J,g as Q,h as z,i as B,j as H,k as O,l as C,m as ee,n as te,o as $,p as ie}from"./three-DErGBpjY.js";import{g as c}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const oe={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},se="/mondes-immerges/accueil/";function P(r){return oe[r]||se}class ne{constructor(){this.videos=new Map,this.isActive=!0,this._contextLost=!1,this._playInProgress=new Map,this.checkInterval=null}onContextLost(){this._contextLost=!0,this.stopMonitoring()}onContextRestored(){this._contextLost=!1,this.videos.forEach((e,t)=>{this._tryPlay(t)}),this.startMonitoring()}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement))return;const o={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,onError:t.onError||null,onPlay:t.onPlay||null,name:t.name||"video-"+this.videos.size};e.loop=o.shouldLoop,e.muted=o.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,o),e.addEventListener("ended",()=>{o.shouldLoop&&this.isActive&&!this._contextLost&&(e.currentTime=0,this._tryPlay(e))}),e.addEventListener("play",()=>{o.onPlay&&o.onPlay(e)});let i=0;e.addEventListener("error",s=>{o.onError&&o.onError(s),i<2&&this.isActive&&!this._contextLost&&(i++,setTimeout(()=>{e.load(),e.addEventListener("canplay",()=>this._tryPlay(e),{once:!0})},3e3*i))})}_tryPlay(e){if(!e||!this.isActive||this._contextLost||this._playInProgress.get(e))return;this._playInProgress.set(e,!0);const t=e.play();t&&t.then?t.then(()=>{this._playInProgress.set(e,!1)}).catch(()=>{this._playInProgress.set(e,!1)}):this._playInProgress.set(e,!1)}startMonitoring(e=1e4){this.checkInterval||(this.checkInterval=setInterval(()=>{!this.isActive||this._contextLost||this.videos.forEach((t,o)=>{o.paused&&!o.ended&&t.shouldLoop&&this._tryPlay(o)})},e))}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null)}unregister(e){this.videos.delete(e),this._playInProgress.delete(e)}unregisterAll(){this.videos.clear(),this._playInProgress.clear()}disable(){this.isActive=!1,this.stopMonitoring()}enable(){this.isActive=!0,this.startMonitoring()}destroy(){this.disable(),this.unregisterAll()}}const M=new ne;class ae{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new T,this.mouse=new _,this.clock=new F,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.boundAnimate=this.animate.bind(this),this._tempRaycaster=new T,this._tempDirection=new w,this.init()}init(){this.scene=new G;const e=new q(16777215,1.2);this.scene.add(e);const t=new k(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new U(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const o=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),i=o||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new Y({antialias:!o,alpha:!0,logarithmicDepthBuffer:!i,powerPreference:"high-performance",precision:o?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(o?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!1,this.isMobile=o,this.container.appendChild(this.renderer.domElement);const s=this.renderer.domElement;s.addEventListener("webglcontextlost",n=>{n.preventDefault(),this._contextLost=!0,M.onContextLost()}),s.addEventListener("webglcontextrestored",()=>{this._contextLost=!1,M.onContextRestored()})}catch(o){this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e)}setupLighting(){const e=new q(4210768,.5);this.scene.add(e);const t=new k(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!1,this.scene.add(t),this.sunLight=t;const o=new W(35071,65416,.6);this.scene.add(o)}createCelestialBodies(){const e=new I,t=e.load("/mondes-immerges/interface/images/sun-texture.jpg"),o=new v(3,32,32),i=new E({map:t,transparent:!0,opacity:.95}),s=new y(o,i);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/mondes-immerges/interface/images/moon-texture.jpg"),a=new v(1.5,32,32),l=new X({map:n}),d=new y(a,l);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,l=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),p=l*Math.sin(n);const h=p*Math.sin(d);p=p*Math.cos(d),e.push(new w(u,h,p))}new Z().setFromPoints(e);const o=new v(.2,16,16),i=new E({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new y(o,i),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const o=document.createElement("video");o.src=this.currentVideoPath,o.loop=!0,o.muted=!0,o.autoplay=!1,o.playsInline=!0,o.crossOrigin="anonymous",o.preload="auto",this.videoElement=o;let i=!1;const s=setTimeout(()=>{i||(i=!0,e())},1e4);o.addEventListener("canplaythrough",()=>{i||(i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("canplay",()=>{i||(i=!0,clearTimeout(s),e())},{once:!0}),o.addEventListener("error",m=>{i||(i=!0,clearTimeout(s),e())}),M.register(o,{loop:!0,muted:!0,autoRetry:!0,name:"globe-texture",onError:m=>{},onPlay:()=>{}}),this.videoTexture=new K(o),this.videoTexture.minFilter=D,this.videoTexture.magFilter=D,this.videoTexture.format=J,this.videoTexture.colorSpace=Q;const n=new v(1.99,64,64),a=new E({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:z}),l=new y(n,a);l.renderOrder=0,this.scene.add(l),this.depthSphere=l;const d=new v(2,64,64),u=new E({map:this.videoTexture,transparent:!0,opacity:1,side:z,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new y(d,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const p=new v(2.02,64,64),h=new E({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new y(p,h),this.clouds.renderOrder=2,this.scene.add(this.clouds),o.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new B({vertexShader:`
        ...
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(i),document.body.appendChild(s);const a=()=>{i.style.backgroundColor="rgba(255, 204, 0, 0.9)",i.style.color="#000",i.style.transform="scale(1.05)"},l=()=>{i.style.backgroundColor="rgba(0, 0, 0, 0.8)",i.style.color="#ffdd00",i.style.transform="scale(1)"},d=u=>{u.stopPropagation();const p=e.userData.hotspot;p&&this.activateHotspot(p)};i.addEventListener("mouseenter",a),i.addEventListener("mouseleave",l),i.addEventListener("click",d),e.userData.label=i,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=o.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:l,onClick:d},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const i=t[0].point,n=Math.acos(i.y/2),a=Math.atan2(i.z,i.x),l=90-n*180/Math.PI,d=a*180/Math.PI-180,u=this._findNearestHotspot(l,d,10);if(u){this.activateHotspot(u);return}}const o=this.raycaster.intersectObjects(this.hotspotObjects);if(o.length>0){const i=o[0].object.userData.hotspot;this.activateHotspot(i)}}_findNearestHotspot(e,t,o){let i=null,s=o;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const l=a.position.lat,d=a.position.lng,u=Math.sqrt(Math.pow(l-e,2)+Math.pow(d-t,2));u<s&&(s=u,i=a)}return i}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;const t=e.position.lat*(Math.PI/180),o=e.position.lng*(Math.PI/180),i=2.1,s=i*Math.cos(t)*Math.cos(o),n=i*Math.sin(t),a=i*Math.cos(t)*Math.sin(o),l=new w(s,n,a);this.orbitParams.isOrbiting=!1;const d=this.camera.position.clone(),h=l.clone().normalize().multiplyScalar(5.2),m=new w().addVectors(d,h).multiplyScalar(.5);m.normalize().multiplyScalar(m.length()+1.8);const f=c.timeline();f.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}});let g=document.getElementById("fade-overlay");g||(g=document.createElement("div"),g.id="fade-overlay",g.style.cssText=`
                ...
                z-index: 98000;
                pointer-events: none;
            `,document.body.appendChild(g)),f.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),f.to(g,{opacity:1,duration:.8,ease:"power2.in"},"-=0.8"),f.to(this.camera,{fov:55,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){this.playTransitionVideoAndRedirect(e.id)}playTransitionVideoAndRedirect(e){const t=document.getElementById("transition-video-out");if(!t){const o=P(e);window.location.href=o;return}t.classList.add("active"),t.currentTime=0,t.play().then(()=>{t.addEventListener("ended",()=>{const o=P(e);window.location.href=o},{once:!0})}).catch(o=>{const i=P(e);window.location.href=i}),setTimeout(()=>{const o=P(e);window.location.href=o},1e4)}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),o=(e.lng+180)*(Math.PI/180),i=-(2.1*Math.sin(t)*Math.cos(o)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(o),a=new $(0,.3,32),l=new B({uniforms:{color:{value:new C(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
           ...
           `,side:ie,transparent:!0,blending:O,depthWrite:!1}),d=new y(a,l);d.position.set(i,s,n),d.lookAt(0,0,0),this.scene.add(d);let u=performance.now();const p=()=>{const h=(performance.now()-u)/1e3;l.uniforms.time.value=h,h<2?requestAnimationFrame(p):(this.scene.remove(d),d.geometry.dispose(),l.dispose())};p(),c.to(d.scale,{x:4,y:4,z:1,duration:2,ease:"power1.out"}),c.to(l.uniforms.color.value,{r:1,g:.8,b:.2,duration:2,ease:"power1.out"})}exitHotspotMode(){this.orbitParams.inHotspotMode&&(this.orbitParams.inHotspotMode=!1,c.to(this.camera,{fov:60,duration:1,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}}),setTimeout(()=>{this.orbitParams.isOrbiting=!0,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed},500))}exitHotspotModeExternal(){this.exitHotspotMode()}handleVideoError(){new I().load("/mondes-immerges/interface/images/video-placeholder.jpg",t=>{this.globe&&this.globe.material&&(this.globe.material.uniforms&&this.globe.material.uniforms.map?this.globe.material.uniforms.map.value=t:this.globe.material.map=t,this.globe.material.needsUpdate=!0)})}zoom(e){const t=e?.85:1.15,o=this.orbitParams.zoomLevel*t;this.orbitParams.zoomLevel=Math.min(Math.max(o,this.orbitParams.minZoomLevel),this.orbitParams.maxZoomLevel),c.to(this.camera.position,{x:this.camera.position.x*t,y:this.camera.position.y*t,z:this.camera.position.z*t,duration:.5,ease:"back.out(1.2)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}resetView(){this.orbitParams.zoomLevel=1,this.orbitParams.currentSpeed=this.orbitParams.baseSpeed;const e=this.orbitParams.ellipseMajorAxis,t=this.orbitParams.ellipseMinorAxis,o=this.orbitParams.inclination,i=this.orbitParams.orbitAngle,s=e*Math.cos(i),n=t*Math.sin(i),a=n*Math.sin(o),l=n*Math.cos(o);c.to(this.camera.position,{x:s,y:a,z:l,duration:1,ease:"elastic.out(1, 0.7)",onUpdate:()=>{this.camera.lookAt(0,0,0)}})}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}setHotspotSelectCallback(e){this.onHotspotSelect=e}setHotspotExitCallback(e){this.onHotspotExit=e}updateHotspotLabels(){if(this.orbitParams.inHotspotMode){this.hotspotObjects.forEach(e=>{e.userData.label&&(e.userData.label.style.opacity="0"),e.userData.connectorSvg&&(e.userData.connectorSvg.style.opacity="0")});return}this.hotspotObjects.forEach(e=>{if(!e.userData.label||!e.userData.worldPosition)return;const t=e.userData.worldPosition,o=t.clone().project(this.camera);if(o.z>1||o.x<-1||o.x>1||o.y<-1||o.y>1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}this._tempDirection.subVectors(t,this.camera.position).normalize(),this._tempRaycaster.set(this.camera.position,this._tempDirection);const i=this._tempRaycaster.intersectObject(this.globe);if(i.length>0){const x=i[0].distance,f=this.camera.position.distanceTo(t);if(x<f-.1){e.userData.label.style.opacity="0",e.userData.connectorSvg.style.opacity="0";return}}const s=(o.x*.5+.5)*window.innerWidth,n=(-o.y*.5+.5)*window.innerHeight,a=e.userData.labelText.length*7,l=40,d=-15;let u=s+l,p=n+d;const h=10;u+a>window.innerWidth-h&&(u=s-l-a),u<h&&(u=h),p<h&&(p=h),p>window.innerHeight-h&&(p=window.innerHeight-h),e.userData.label.style.left=`${u}px`,e.userData.label.style.top=`${p}px`,this.labelsVisible&&(e.userData.label.style.opacity="1");const m=e.userData.connectorLine;m&&(m.setAttribute("x1",s),m.setAttribute("y1",n),m.setAttribute("x2",u),m.setAttribute("y2",p+10),this.labelsVisible&&(e.userData.connectorSvg.style.opacity="1"))})}showLabels(){this.labelsVisible=!0,this.hotspotObjects.forEach((e,t)=>{e.userData.materials&&e.userData.materials.forEach((o,i)=>{const s=i===0?.8:.5;c.to(o,{opacity:s,duration:.8,delay:t*.1,ease:"power2.out"})})})}stopAnimation(){this.animationId&&(cancelAnimationFrame(this.animationId),this.animationId=null)}animate(){if(this.animationId=requestAnimationFrame(this.boundAnimate),this._contextLost)return;const e=this.clock.getDelta(),t=this.clock.getElapsedTime()*1e3;this.orbitParams.isOrbiting&&!this.orbitParams.inHotspotMode&&this.updateCameraPosition(),this.updateSkyboxTime&&this.updateSkyboxTime(t),this.hotspotObjects.forEach(o=>{const i=o.userData.waveRings;i&&i.forEach(s=>{s.userData.waveTime+=e;const n=s.userData.waveTime-s.userData.initialDelay;if(n>0){const l=n%2.5/2.5,d=.05,p=d+(.18-d)*l;s.geometry.dispose(),s.geometry=new $(p,p+.02,32),s.material.opacity=.7*(1-l)}})}),this.updateHotspotLabels(),this.clouds&&(this.clouds.rotation.y+=1e-4),this.globe&&!this.orbitParams.inHotspotMode&&(this.globe.rotation.y+=2e-4),this.globe&&this.globe.material.uniforms&&this.globe.material.uniforms.time&&(this.globe.material.uniforms.time.value=t),this.renderer.render(this.scene,this.camera)}}class re{constructor(e){this.container=e.container,this.effectsContainer=null,this.notificationContainer=null,this.particleTweens=[],this.init()}init(){this.effectsContainer=document.createElement("div"),this.effectsContainer.classList.add("effects-container"),this.effectsContainer.style.position="absolute",this.effectsContainer.style.top="0",this.effectsContainer.style.left="0",this.effectsContainer.style.width="100%",this.effectsContainer.style.height="100%",this.effectsContainer.style.pointerEvents="none",this.effectsContainer.style.zIndex="5",this.container.appendChild(this.effectsContainer),this.createNotificationContainer()}createNotificationContainer(){this.notificationContainer=document.createElement("div"),this.notificationContainer.className="notification-container",this.notificationContainer.style.cssText=`
            position: absolute;
            bottom: 30px;
            right: 30px;
            display: flex;
        ...
        `;for(let u=0;u<3;u++){const p=document.createElement("div");p.style.cssText=`
            ...
            `;for(let h=0;h<3+u;h++){const m=document.createElement("div"),x=360/(3+u)*h;m.style.cssText=`
                    position: absolute;
                    width: ${8-u}px;
                    height: ${8-u}px;
                    ...
                    transform: translate(-50%, -50%) rotate(${x}deg) translateX(${60+u*20}px);
                `,p.appendChild(m)}s.appendChild(p)}const n=document.createElement("div");n.style.cssText=`
            width: 20px;
            height: 20px;
            background-color: #ffcc00;
            border-radius: 50%;
...
`),(t?t.querySelectorAll("button"):[]).forEach(i=>{i.style.cssText=`
        ...
        `,t.appendChild(o),this.mainContainer.appendChild(t)}initSatelliteInterface(){const e=document.getElementById("coord-lat"),t=document.getElementById("coord-lng"),o=document.getElementById("zoom-level"),i=document.getElementById("orbit-status"),s=document.getElementById("altitude-value"),n=document.getElementById("current-date"),a=document.getElementById("current-time");this.hudInterval=setInterval(()=>{const l=new Date,d={day:"2-digit",month:"2-digit",year:"numeric"};n&&(n.textContent=l.toLocaleDateString("fr-FR",d));const u=String(l.getUTCHours()).padStart(2,"0"),p=String(l.getUTCMinutes()).padStart(2,"0"),h=String(l.getUTCSeconds()).padStart(2,"0");if(a&&(a.textContent=`${u}:${p}:${h}`),this.globeManager&&this.globeManager.camera){const m=this.globeManager.camera.position,x=Math.sqrt(m.x*m.x+m.z*m.z),f=Math.atan2(m.z,m.x)*(180/Math.PI),g=Math.atan2(m.y,x)*(180/Math.PI);e&&(e.textContent=Math.abs(g).toFixed(4)+(g>=0?"":"-")),t&&(t.textContent=Math.abs(f).toFixed(4)+(f>=0?"":"-"));const V=(m.length()-2)*100;s&&(s.textContent=V.toFixed(2)),o&&this.globeManager.orbitParams&&(o.textContent=this.globeManager.orbitParams.zoomLevel.toFixed(1)),i&&this.globeManager.orbitParams&&(this.globeManager.orbitParams.inHotspotMode?(i.textContent="FIXÉE",i.style.color="#ffcc00"):this.globeManager.orbitParams.currentSpeed>this.globeManager.orbitParams.baseSpeed*1.5?(i.textContent="ACCÉLÉRÉE",i.style.color="#ff9900"):this.globeManager.orbitParams.currentSpeed<this.globeManager.orbitParams.baseSpeed?(i.textContent="RALENTIE",i.style.color="#66ccff"):(i.textContent="NORMALE",i.style.color="#ffffff"))}},100)}startupSequence(e){const t=document.getElementById("loading-screen");this.visualEffects.createOrbitalLoaderEffect(()=>{this.finalizeStartup(),e&&typeof e=="function"&&e()},3,t)}finalizeStartup(){this.showSystemMessages(),setTimeout(()=>{this.visualEffects.showNotification("Bienvenue dans l'exploration des Mondes Immergés","info",4e3)},1e3)}showSystemMessages(){}destroy(){this.hudInterval&&(clearInterval(this.hudInterval),this.hudInterval=null)}handleHotspotSelect(e){this.currentHotspot=e,this.explorationHistory.push({id:e.id,title:e.title,timestamp:Date.now()}),this.visualEffects.highlightSelection(e.position),this.visualEffects.flashScreen("rgba(255, 204, 0, 0.2)");const t=document.querySelector(".coordinates-display");t&&(t.style.backgroundColor="rgba(255, 204, 0, 0.2)",t.style.borderColor="rgba(255, 204, 0, 0.8)");const o=ue(e.id),i=this.generateDetailedInfoHTML(o),s=o.sources||[{title:"Étude scientifique de référence (National Geographic)",url:"https://www.nationalgeographic.com/environment/oceans"},{title:"Base de données océanographiques (NOAA)",url:"https://www.noaa.gov/oceans-coasts"},{title:"Conservation marine (UNESCO)",url:"https://en.unesco.org/themes/ocean"}];this.contentPanel&&this.contentPanel.update&&(this.contentPanel.update({title:e.title,description:e.description,videoSrc:e.videoSrc,coordinates:e.position,detailedInfo:i,links:s}),this.contentPanel.show()),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!1)}generateDetailedInfoHTML(e){if(!e||!e.scientificData)return"<p>Informations détaillées non disponibles pour cette zone.</p>";const t=e.scientificData;let o=`
        ...
        `;t.area&&(o+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(o+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(o+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(o+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),o+="</div>";let i="";e.detailedInfo&&(i=`
            ...
            ${i}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const N=new pe;function he(){N.init()}function j(){return N}const b={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function me(){if(b.webGLChecked)return!0;try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return fe(),b.webGLChecked=!1,!1;b.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return!1}}function fe(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
    ...
    `)}function Ee(){const r=document.getElementById("welcome-screen");r&&(r.style.display="none",r.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Me(){if(b.initialized||(b.initialized=!0,!me()))return;Ee();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),setTimeout(()=>{ye()},300))},200)}function Ce(){b.cleanupDone||(b.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{b.domReady||(b.domReady=!0,ge(),setTimeout(()=>{Me()},100))});window.addEventListener("error",r=>{r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")||console.warn("[MondesImmerges]",r.error)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.warn("[MondesImmerges]",r.reason)},{once:!1});window.addEventListener("beforeunload",()=>{Ce();const r=j();r&&r.destroy()},{once:!0});window.addEventListener("pageshow",r=>{(r.persisted||window.performance&&window.performance.navigation.type===2)&&window.location.reload()});
