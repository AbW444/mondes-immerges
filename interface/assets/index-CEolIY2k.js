import{R as L,V as Y,C as X,a as w,S as _,A as I,D as q,F as k,P as Z,W as K,b as J,c as A,L as C,d as D,e as z,H as Q,T as S,f as v,M,g as x,h as ee,B as te,i as B,j as O,k as H,l as R,m as T,n as oe,o as ie,p as $,q as ne}from"./three-4x0lhi4J.js";import{g as d}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const se="modulepreload",ae=function(r){return"/nationalgeographic.fr-mondesimmerges/interface/"+r},N={},re=function(e,t,i){let o=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),a=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));o=Promise.allSettled(t.map(l=>{if(l=ae(l),l in N)return;N[l]=!0;const c=l.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":se,c||(p.as="script"),p.crossOrigin="",p.href=l,a&&p.setAttribute("nonce",a),document.head.appendChild(p),c)return new Promise((h,m)=>{p.addEventListener("load",h),p.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(s){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=s,window.dispatchEvent(a),!a.defaultPrevented)throw s}return o.then(s=>{for(const a of s||[])a.status==="rejected"&&n(a.reason);return e().catch(n)})};re(()=>import("https://unpkg.com/ldrs/dist/auto/jelly.js"),[]);const le={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ce="/nationalgeographic.fr-mondesimmerges/accueil/";function de(r){return le[r]||ce}class ue{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new L,this.mouse=new Y,this.clock=new X,this.labelsVisible=!1,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new _;const e=new I(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new k(0,15e-5),this.camera=new Z(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new K({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=J;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e),d.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),d.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}setupLighting(){const e=new I(4210768,.5);this.scene.add(e);const t=new q(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new Q(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new S,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new v(3,32,32),o=new M({map:t,transparent:!0,opacity:.95}),n=new x(i,o);n.position.copy(this.celestialParams.sunPosition),this.scene.add(n);const s=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new v(1.5,32,32),l=new ee({map:s}),c=new x(a,l);c.position.copy(this.celestialParams.moonPosition),this.scene.add(c),this.sun=n,this.moon=c}createOrbitPath(){const e=[];for(let n=0;n<=100;n++){const s=n/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,l=this.orbitParams.ellipseMinorAxis,c=this.orbitParams.inclination;let u=a*Math.cos(s),p=l*Math.sin(s);const h=p*Math.sin(c);p=p*Math.cos(c),e.push(new w(u,h,p))}new te().setFromPoints(e);const i=new v(.2,16,16),o=new M({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(i,o),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const i=document.createElement("video");i.src=this.currentVideoPath,i.loop=!0,i.muted=!0,i.autoplay=!1,i.playsInline=!0,i.crossOrigin="anonymous",i.preload="auto",this.videoElement=i,console.log("📦 Préchargement de la vidéo du globe...",this.currentVideoPath);let o=!1;const n=setTimeout(()=>{o||(console.warn("⚠️ Timeout préchargement vidéo - continuation"),o=!0,e())},1e4);i.addEventListener("canplaythrough",()=>{o||(console.log("✅ Vidéo du globe préchargée et prête"),o=!0,clearTimeout(n),e())},{once:!0}),i.addEventListener("canplay",()=>{o||(console.log("✅ Vidéo du globe peut être jouée"),o=!0,clearTimeout(n),e())},{once:!0}),i.addEventListener("error",m=>{o||(console.error("❌ Erreur chargement vidéo globe:",m),console.warn("Continuation malgré l'erreur"),o=!0,clearTimeout(n),e())}),i.addEventListener("ended",()=>{i.play()}),setInterval(()=>{i.paused&&!i.ended&&(console.log("Vidéo en pause, relance..."),i.play().catch(m=>{console.error("Impossible de relancer la vidéo:",m)}))},1e3),this.videoTexture=new A(i),this.videoTexture.minFilter=C,this.videoTexture.magFilter=C,this.videoTexture.format=D,this.videoTexture.colorSpace=z;const s=new v(1.99,64,64),a=new M({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:B}),l=new x(s,a);l.renderOrder=0,this.scene.add(l),this.depthSphere=l;const c=new v(2,64,64),u=new M({map:this.videoTexture,transparent:!0,opacity:1,side:B,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(c,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const p=new v(2.02,64,64),h=new M({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(p,h),this.clouds.renderOrder=2,this.scene.add(this.clouds),i.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new O({vertexShader:`
        ...
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","svg");n.style.cssText=`
            ...
            z-index: 999;
            opacity: 0;
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","line");s.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),s.setAttribute("stroke-width","1.5"),s.setAttribute("stroke-dasharray","4, 4"),n.appendChild(s),document.body.appendChild(o),document.body.appendChild(n);const a=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},l=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffcc00",o.style.transform="scale(1)"},c=u=>{u.stopPropagation();const p=e.userData.hotspot;p&&(console.log(`Label cliqué: ${p.title}`),this.activateHotspot(p))};o.addEventListener("mouseenter",a),o.addEventListener("mouseleave",l),o.addEventListener("click",c),e.userData.label=o,e.userData.connectorSvg=n,e.userData.connectorLine=s,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:l,onClick:c},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,s=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),l=90-s*180/Math.PI,c=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${l.toFixed(2)}, lng: ${c.toFixed(2)}`);const u=this._findNearestHotspot(l,c,10);if(u){console.log(`Hotspot trouvé: ${u.title}`),this.activateHotspot(u);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,n=i;const s=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of s){const l=a.position.lat,c=a.position.lng,u=Math.sqrt(Math.pow(l-e,2)+Math.pow(c-t,2));u<n&&(n=u,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,n=o*Math.cos(t)*Math.cos(i),s=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),l=new w(n,s,a);this.createScanEffect(e.position),this.orbitParams.isOrbiting=!1;const c=this.camera.position.clone(),h=l.clone().normalize().multiplyScalar(3.5),m=new w().addVectors(c,h).multiplyScalar(.5);m.normalize().multiplyScalar(m.length()+1.8);const f=d.timeline();f.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}}),f.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),f.to(this.camera,{fov:40,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ===");const t=document.createElement("div");t.style.cssText=`
           position: fixed;
           top: 0;
           left: 0;
           width: 100%;
       ...
       `,document.body.appendChild(t),d.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=de(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),n=2.1*Math.cos(t),s=2.1*Math.sin(t)*Math.sin(i),a=new $(0,.3,32),l=new O({uniforms:{color:{value:new T(16763904)},time:{value:0}},vertexShader:`
        ...
        `;for(let u=0;u<3;u++){const p=document.createElement("div");p.style.cssText=`
            ...
            `;for(let h=0;h<3+u;h++){const m=document.createElement("div"),g=360/(3+u)*h;m.style.cssText=`
                    position: absolute;
                    width: ${8-u}px;
                    height: ${8-u}px;
        ...
        `,n.appendChild(s);const a=document.createElement("div");a.className="orbital-loading-text",a.style.cssText=`
            position: absolute;
            bottom: -60px;
            left: 50%;
        ...
        `,n.appendChild(a),o.appendChild(n);const l=document.createElement("style");l.textContent=`
            @keyframes orbit0 {
        ...
        `,this.effectsContainer.appendChild(t),d.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let n=0;n<i.count;n++){const s=document.createElement("div"),a=Math.random()*3+1,l=Math.random()*100,c=Math.random()*100,u=Math.random()*5,p=Math.random()*10+10,h=Math.random()*.5+.1;s.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `,i.appendChild(o),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(l=>{const c=document.createElement("div");c.className="minimap-dot",c.dataset.id=l.id,c.title=l.name,c.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,c.addEventListener("mouseenter",()=>{d.to(c,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(c,l.name,{position:"top",duration:2e3})}),c.addEventListener("mouseleave",()=>{d.to(c,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),c.addEventListener("click",()=>{t&&t(l.id)}),i.appendChild(c)});const s=document.createElement("div");s.className="minimap-toggle",s.innerHTML="−",s.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
        ...
        `,t.appendChild(i),this.mainContainer.appendChild(t),console.log("✅ Logo National Geographic ajouté")}initSatelliteInterface(){const e=document.getElementById("coord-lat"),t=document.getElementById("coord-lng"),i=document.getElementById("zoom-level"),o=document.getElementById("orbit-status"),n=document.getElementById("altitude-value"),s=document.getElementById("current-date"),a=document.getElementById("current-time");setInterval(()=>{const l=new Date,c={day:"2-digit",month:"2-digit",year:"numeric"};s&&(s.textContent=l.toLocaleDateString("fr-FR",c));const u=String(l.getUTCHours()).padStart(2,"0"),p=String(l.getUTCMinutes()).padStart(2,"0"),h=String(l.getUTCSeconds()).padStart(2,"0");if(a&&(a.textContent=`${u}:${p}:${h}`),this.globeManager&&this.globeManager.camera){const m=this.globeManager.camera.position,g=Math.sqrt(m.x*m.x+m.z*m.z),f=Math.atan2(m.z,m.x)*(180/Math.PI),E=Math.atan2(m.y,g)*(180/Math.PI);e&&(e.textContent=Math.abs(E).toFixed(4)+(E>=0?"":"-")),t&&(t.textContent=Math.abs(f).toFixed(4)+(f>=0?"":"-"));const b=m.length();n&&(n.textContent=b.toFixed(3)),i&&this.globeManager.orbitParams&&(i.textContent=this.globeManager.orbitParams.zoomLevel.toFixed(1)),o&&this.globeManager.orbitParams&&(this.globeManager.orbitParams.inHotspotMode?(o.textContent="FIXÉE",o.style.color="#ffcc00"):this.globeManager.orbitParams.currentSpeed>this.globeManager.orbitParams.baseSpeed*1.5?(o.textContent="ACCÉLÉRÉE",o.style.color="#ff9900"):this.globeManager.orbitParams.currentSpeed<this.globeManager.orbitParams.baseSpeed?(o.textContent="RALENTIE",o.style.color="#66ccff"):(o.textContent="NORMALE",o.style.color="#ffffff"))}},100)}startupSequence(e){const t=document.getElementById("loading-screen");this.visualEffects.createOrbitalLoaderEffect(()=>{this.finalizeStartup(),e&&typeof e=="function"&&e()},3,t)}finalizeStartup(){this.showSystemMessages(),setTimeout(()=>{this.visualEffects.showNotification("Bienvenue dans l'exploration des Mondes Immergés","info",4e3)},1e3)}showSystemMessages(){}handleHotspotSelect(e){console.log(`Point d'intérêt sélectionné: ${e.title}`),this.currentHotspot=e,this.explorationHistory.push({id:e.id,title:e.title,timestamp:Date.now()}),this.visualEffects.highlightSelection(e.position),this.visualEffects.flashScreen("rgba(255, 204, 0, 0.2)");const t=document.querySelector(".coordinates-display");t&&(t.style.backgroundColor="rgba(255, 204, 0, 0.2)",t.style.borderColor="rgba(255, 204, 0, 0.8)");const i=fe(e.id),o=this.generateDetailedInfoHTML(i),n=i.sources||[{title:"Étude scientifique de référence (National Geographic)",url:"https://www.nationalgeographic.com/environment/oceans"},{title:"Base de données océanographiques (NOAA)",url:"https://www.noaa.gov/oceans-coasts"},{title:"Conservation marine (UNESCO)",url:"https://en.unesco.org/themes/ocean"}];this.contentPanel&&this.contentPanel.update?(this.contentPanel.update({title:e.title,description:e.description,videoSrc:e.videoSrc,coordinates:e.position,detailedInfo:o,links:n}),this.contentPanel.show()):(console.log("ContentPanel non disponible, affichage des informations dans la console:"),console.log("Titre:",e.title),console.log("Description:",e.description),console.log("Coordonnées:",e.position)),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!1)}generateDetailedInfoHTML(e){if(!e||!e.scientificData)return"<p>Informations détaillées non disponibles pour cette zone.</p>";const t=e.scientificData;let i=`
        ...
        `)}function Ee(){const r=document.querySelector(".cursor"),e=document.querySelector(".cursor-follower");if(!r||!e)return;let t=0,i=0,o=0,n=0,s=null;const a=c=>{t=c.clientX,i=c.clientY};document.addEventListener("mousemove",a,{passive:!0});function l(){r.style.left=t+"px",r.style.top=i+"px",o+=(t-o)*.1,n+=(i-n)*.1,e.style.left=o+"px",e.style.top=n+"px",s=requestAnimationFrame(l)}s=requestAnimationFrame(l),window.addEventListener("beforeunload",()=>{s&&cancelAnimationFrame(s),document.removeEventListener("mousemove",a)}),console.log("✅ Curseur initialisé")}async function Me(){return new Promise(r=>{const e=document.querySelector("l-jelly"),t=document.getElementById("transition-video");if(!t){console.warn("⚠️ Vidéo de transition introuvable"),r();return}console.log("🎬 Préparation vidéo de transition..."),e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300));let i,o=performance.now();const s=1e3/30,a=()=>{if(console.log(`📹 Durée vidéo: ${t.duration}s, ReadyState: ${t.readyState}`),!t.duration||isNaN(t.duration)){console.error("❌ Durée vidéo invalide:",t.duration),r();return}t.classList.add("active"),t.pause(),t.currentTime=t.duration,console.log(`▶️ Début lecture reverse depuis ${t.currentTime.toFixed(2)}s`);const l=c=>{if(c-o>=s&&(t.currentTime-=s/1e3,o=c,t.currentTime<=0)){cancelAnimationFrame(i),console.log("✅ Vidéo de transition terminée"),t.classList.remove("active"),setTimeout(()=>r(),300);return}i=requestAnimationFrame(l)};i=requestAnimationFrame(l)};t.readyState>=1&&t.duration&&!isNaN(t.duration)?(console.log("✅ Métadonnées déjà chargées"),a()):(console.log("⏳ Attente chargement métadonnées..."),t.addEventListener("loadedmetadata",a,{once:!0}),t.load()),setTimeout(()=>{i&&cancelAnimationFrame(i),console.warn("⚠️ Timeout vidéo transition"),t.classList.remove("active"),r()},1e4)})}async function Ce(){if(y.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),y.appStarted=!0;try{ye();const r=xe();if(!r)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),Se(),console.log("⏳ PRÉCHARGEMENT DES ASSETS EN COURS..."),r.globeManager&&r.globeManager.preloadAllAssets?(await r.globeManager.preloadAllAssets(),console.log("✅ TOUS LES ASSETS SONT PRÊTS")):console.warn("⚠️  preloadAllAssets non disponible, passage direct"),await Me(),setTimeout(()=>{r.startupSequence&&typeof r.startupSequence=="function"?(console.log("🎬 Séquence de démarrage..."),r.startupSequence(()=>{j(),setTimeout(()=>{console.log("🌊 Démarrage exploration..."),r.startExploration(!0),setTimeout(()=>{V(r)},200)},2500)})):(console.log("🌊 Démarrage direct..."),j(),setTimeout(()=>{r.startExploration(!0),setTimeout(()=>{V(r)},200)},2500))},300)}catch(r){console.error("❌ Erreur application:",r),Te()}}function Se(){const r=document.getElementById("main-container");if(!r)return;r.classList.remove("hidden"),r.style.opacity="0",r.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(n=>{n.style.opacity="0"}),i&&(i.style.opacity="0"),o&&(o.style.opacity="0"),console.log("✅ Interface initialisée en mode clear")}function V(r){const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelectorAll(".hotspot-label"),n=document.querySelectorAll("svg"),s=document.querySelector(".scanner-effect");console.log("✨ Apparition des éléments UI + hotspots + connector lines"),r&&r.globeManager&&r.globeManager.showLabels(),e&&(e.style.pointerEvents="auto"),window.gsap?(e&&gsap.to(e,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...t,i,s].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...o,...n],{opacity:1,duration:.8,ease:"power2.out"})):(e&&(e.style.transition="all 0.8s ease",e.style.opacity="1",e.style.transform="translateY(0)"),t.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),i&&(i.style.transition="opacity 0.8s ease",i.style.opacity="1"),s&&(s.style.transition="opacity 0.8s ease",s.style.opacity="1"),o.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),n.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}))}function j(){const r=document.getElementById("loading-screen"),e=document.getElementById("main-container");r&&(console.log("🌑 Début transition fond noir (100% → 0% sur 4s)"),console.log("🌍 Interface (globe) visible immédiatement derrière le fond noir"),e&&(e.style.opacity="1"),r.style.transition="opacity 2.5s cubic-bezier(0.19, 1, 0.22, 1)",r.style.opacity="0",setTimeout(()=>{r.style.display="none",r.classList.add("hidden"),console.log("✅ Écran de chargement complètement masqué")},2500))}function Te(r){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `)}function Pe(){const r=document.getElementById("welcome-screen");r&&(r.style.display="none",r.classList.add("hidden"));const e=document.getElementById("main-container");e&&(e.classList.add("hidden"),e.style.opacity="0");const t=document.createElement("style");t.textContent=`
    ...
    `,document.head.appendChild(t)}function Le(){if(y.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),y.initialized=!0,!ve())return;Pe();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{Ce()},300))},200)}function Ie(){y.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),y.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(y.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),y.domReady=!0,Ee(),setTimeout(()=>{Le()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Ie,{once:!0});window.addEventListener("pageshow",r=>{(r.persisted||window.performance&&window.performance.navigation.type===2)&&(console.log("🔄 Page restaurée depuis le cache, rechargement..."),window.location.reload())});
