import{R as P,V as G,C as F,a as x,S as U,A as I,D as L,F as q,P as W,W as Y,b as X,c as k,L as M,d as A,e as D,H as _,T as S,f as v,M as w,g as y,h as Z,B as K,i as z,j as B,k as H,l as O,m as T,n as J,o as Q,p as R,q as ee}from"./three-4x0lhi4J.js";import{g as c}from"./gsap-xHO-obUW.js";import{i as te}from"./vendor-CFRTidej.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const oe={"grande-barriere":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",abysses:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",arctique:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",plastique:"/nationalgeographic.fr-mondesimmerges/into-the-okavango/","triangle-corail":"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/",requins:"/nationalgeographic.fr-mondesimmerges/les-ombres-de-la-mer/"},ie="/nationalgeographic.fr-mondesimmerges/accueil/";function se(r){return oe[r]||ie}class ne{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new P,this.mouse=new G,this.clock=new F,this.labelsVisible=!1,this.currentVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video.webm",this.alternateVideoPath="/nationalgeographic.fr-mondesimmerges/interface/videos/globe-video-aberration.webm",this.isAlternateVideo=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:0,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new x(100,20,100),moonPosition:new x(-70,30,-50)},this._savedState=null,this.init()}init(){this.scene=new U;const e=new I(16777215,1.2);this.scene.add(e);const t=new L(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new q(0,15e-5),this.camera=new W(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{this.renderer=new Y({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0,powerPreference:"high-performance"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=X;const i=this.renderer.getContext();console.log("WebGL Version:",i.getParameter(i.VERSION)),console.log("WebGL Vendor:",i.getParameter(i.VENDOR)),console.log("Max Texture Size:",i.getParameter(i.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement)}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createCelestialBodies(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),document.addEventListener("keydown",this.onKeyDown.bind(this))}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
        ...
        `,this.container.appendChild(e),c.timeline().to(e,{opacity:1,duration:.1,ease:"power2.out"}).to(e,{opacity:0,duration:.3,ease:"power2.out",onComplete:()=>{e.remove()}}),this.showVideoSwitchNotification()}showVideoSwitchNotification(){const e=document.createElement("div");e.textContent=this.isAlternateVideo?"Mode Aberration Activé":"Mode Normal Activé",e.style.cssText=`
            ...
            opacity: 0;
            letter-spacing: 1px;
        `,this.container.appendChild(e),c.timeline().to(e,{opacity:1,scale:1.1,duration:.3,ease:"back.out(1.7)"}).to(e,{scale:1,duration:.2}).to(e,{opacity:0,scale:.9,duration:.5,delay:1.5,ease:"power2.in",onComplete:()=>{e.remove()}})}setupLighting(){const e=new I(4210768,.5);this.scene.add(e);const t=new L(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,this.scene.add(t),this.sunLight=t;const i=new _(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new S,t=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/sun-texture.jpg"),i=new v(3,32,32),o=new w({map:t,transparent:!0,opacity:.95}),s=new y(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/nationalgeographic.fr-mondesimmerges/interface/images/moon-texture.jpg"),a=new v(1.5,32,32),l=new Z({map:n}),d=new y(a,l);d.position.copy(this.celestialParams.moonPosition),this.scene.add(d),this.sun=s,this.moon=d}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,l=this.orbitParams.ellipseMinorAxis,d=this.orbitParams.inclination;let u=a*Math.cos(n),m=l*Math.sin(n);const h=m*Math.sin(d);m=m*Math.cos(d),e.push(new x(u,h,m))}new K().setFromPoints(e);const i=new v(.2,16,16),o=new w({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new y(i,o),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const i=document.createElement("video");i.src=this.currentVideoPath,i.loop=!0,i.muted=!0,i.autoplay=!1,i.playsInline=!0,i.crossOrigin="anonymous",i.preload="auto",this.videoElement=i,console.log("📦 Préchargement de la vidéo du globe...",this.currentVideoPath);let o=!1;const s=setTimeout(()=>{o||(console.warn("⚠️ Timeout préchargement vidéo - continuation"),o=!0,e())},1e4);i.addEventListener("canplaythrough",()=>{o||(console.log("✅ Vidéo du globe préchargée et prête"),o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("canplay",()=>{o||(console.log("✅ Vidéo du globe peut être jouée"),o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("error",p=>{o||(console.error("❌ Erreur chargement vidéo globe:",p),console.warn("Continuation malgré l'erreur"),o=!0,clearTimeout(s),e())}),i.addEventListener("ended",()=>{i.play()}),setInterval(()=>{i.paused&&!i.ended&&(console.log("Vidéo en pause, relance..."),i.play().catch(p=>{console.error("Impossible de relancer la vidéo:",p)}))},1e3),this.videoTexture=new k(i),this.videoTexture.minFilter=M,this.videoTexture.magFilter=M,this.videoTexture.format=A,this.videoTexture.colorSpace=D;const n=new v(1.99,64,64),a=new w({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:z}),l=new y(n,a);l.renderOrder=0,this.scene.add(l),this.depthSphere=l;const d=new v(2,64,64),u=new w({map:this.videoTexture,transparent:!0,opacity:1,side:z,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new y(d,u),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe),this.createAtmosphere();const m=new v(2.02,64,64),h=new w({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new y(m,h),this.clouds.renderOrder=2,this.scene.add(this.clouds),i.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new B({vertexShader:`
       ...
       `,document.body.appendChild(t),c.to(t,{backgroundColor:"rgba(0, 0, 0, 1)",duration:1,ease:"power2.inOut",onComplete:()=>{const i=se(e.id);console.log(`Redirection vers: ${i}`),window.location.href=i}})}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(i),a=new R(0,.3,32),l=new B({uniforms:{color:{value:new T(16763904)},time:{value:0}},vertexShader:`
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<i.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,l=Math.random()*100,d=Math.random()*100,u=Math.random()*5,m=Math.random()*10+10,h=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
