import{R as I,V as j,C as G,a as w,S as F,A as k,D as q,F as A,P as W,W as U,H as _,T,b as v,M as E,c as x,d as Y,B as X,e as Z,L as D,f as K,g as J,h as z,i as B,j as O,k as $,l as S,m as Q,n as ee,o as R,p as te}from"./three-DErGBpjY.js";import{g as c}from"./gsap-xHO-obUW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const oe={"grande-barriere":"/mondes-immerges/interface/les-ombres-de-la-mer/",abysses:"/mondes-immerges/interface/les-ombres-de-la-mer/",arctique:"/mondes-immerges/interface/into-the-okavango/",plastique:"/mondes-immerges/interface/into-the-okavango/","triangle-corail":"/mondes-immerges/interface/les-ombres-de-la-mer/",requins:"/mondes-immerges/interface/into-the-okavango/"},ie="/mondes-immerges/accueil/";function L(r){return oe[r]||ie}class se{constructor(){this.videos=new Map,this.retryAttempts=new Map,this.maxRetries=5,this.checkInterval=null,this.isActive=!0,this._contextLost=!1}onContextLost(){this._contextLost=!0,this.stopMonitoring(),console.warn("🛑 VideoManager: WebGL context lost - arrêt de toutes les relances")}onContextRestored(){this._contextLost=!1,console.log("✅ VideoManager: WebGL context restored - reprise possible"),this.videos.forEach((e,t)=>{this.playVideo(t,e)}),this.startMonitoring(2e3)}register(e,t={}){if(!e||!(e instanceof HTMLVideoElement)){console.error("VideoManager: Élément vidéo invalide");return}const i={shouldLoop:t.loop!==!1,shouldMute:t.muted!==!1,autoRetry:t.autoRetry!==!1,onError:t.onError||null,onPlay:t.onPlay||null,onStall:t.onStall||null,name:t.name||"video-"+this.videos.size};e.loop=i.shouldLoop,e.muted=i.shouldMute,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),this.videos.set(e,i),this.retryAttempts.set(e,0),this.attachListeners(e,i),console.log(`✅ VideoManager: "${i.name}" enregistrée`)}attachListeners(e,t){e.addEventListener("ended",()=>{t.shouldLoop&&this.isActive&&(console.log(`🔄 VideoManager: "${t.name}" - Relance après ended`),this.playVideo(e,t))}),e.addEventListener("pause",()=>{e.ended||e.dataset.intentionalPause!=="true"&&(this._contextLost||this.isActive&&(console.warn(`⚠️ VideoManager: "${t.name}" - Pause détectée, relance...`),setTimeout(()=>{this.isActive&&!this._contextLost&&this.playVideo(e,t)},100)))}),e.addEventListener("stalled",()=>{console.warn(`⚠️ VideoManager: "${t.name}" - Stalled (buffering)`),t.onStall&&t.onStall(e),setTimeout(()=>{e.readyState>=2&&this.isActive&&!this._contextLost&&this.playVideo(e,t)},500)}),e.addEventListener("waiting",()=>{console.log(`⏳ VideoManager: "${t.name}" - Waiting for data...`)}),e.addEventListener("suspend",()=>{console.log(`💤 VideoManager: "${t.name}" - Suspended`)}),e.addEventListener("error",i=>{console.error(`❌ VideoManager: "${t.name}" - Erreur:`,i),t.onError&&t.onError(i);const o=this.retryAttempts.get(e)||0;o<this.maxRetries&&t.autoRetry&&this.isActive&&!this._contextLost&&(this.retryAttempts.set(e,o+1),console.log(`🔄 VideoManager: "${t.name}" - Tentative ${o+1}/${this.maxRetries}`),setTimeout(()=>{e.load(),this.playVideo(e,t)},2e3*(o+1)))}),e.addEventListener("loadeddata",()=>{console.log(`✅ VideoManager: "${t.name}" - Données chargées`)}),e.addEventListener("play",()=>{console.log(`▶️ VideoManager: "${t.name}" - Lecture démarrée`),this.retryAttempts.set(e,0),t.onPlay&&t.onPlay(e)})}playVideo(e,t){if(!e||!this.isActive||this._contextLost)return;const i=e.play();i!==void 0&&i.then(()=>{console.log(`✅ VideoManager: "${t.name}" - Play() réussi`)}).catch(o=>{if(console.error(`❌ VideoManager: "${t.name}" - Play() échoué:`,o),o.name==="NotAllowedError"){console.warn(`⚠️ VideoManager: "${t.name}" - Autoplay bloqué, en attente d'interaction...`);const s=()=>{this.playVideo(e,t),document.removeEventListener("click",s)};document.addEventListener("click",s,{once:!0})}})}startMonitoring(e=2e3){if(this.checkInterval){console.warn("VideoManager: Surveillance déjà active");return}console.log("🔍 VideoManager: Démarrage de la surveillance périodique"),this.checkInterval=setInterval(()=>{!this.isActive||this._contextLost||this.videos.forEach((t,i)=>{i.paused&&!i.ended&&t.shouldLoop&&(console.warn(`⚠️ VideoManager: "${t.name}" - En pause (surveillance), relance...`),this.playVideo(i,t)),i.readyState<3&&!i.paused&&console.log(`⏳ VideoManager: "${t.name}" - Buffering...`)})},e)}stopMonitoring(){this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null,console.log("⏹️ VideoManager: Surveillance arrêtée"))}unregister(e){if(this.videos.has(e)){const t=this.videos.get(e);console.log(`🗑️ VideoManager: "${t.name}" désenregistrée`),this.videos.delete(e),this.retryAttempts.delete(e)}}unregisterAll(){this.videos.clear(),this.retryAttempts.clear(),console.log("🗑️ VideoManager: Toutes les vidéos désenregistrées")}disable(){this.isActive=!1,this.stopMonitoring(),console.log("⏸️ VideoManager: Désactivé")}enable(){this.isActive=!0,this.startMonitoring(),console.log("▶️ VideoManager: Activé")}destroy(){this.disable(),this.unregisterAll(),console.log("💥 VideoManager: Détruit")}}const M=new se;class ne{constructor(e){this.options=e,this.container=document.getElementById(e.containerId),this.scene=null,this.camera=null,this.renderer=null,this.globe=null,this.videoElement=null,this.videoTexture=null,this.hotspotObjects=[],this.raycaster=new I,this.mouse=new j,this.clock=new G,this.labelsVisible=!1,this.orbitParams={isOrbiting:!0,baseSpeed:4e-4,currentSpeed:4e-4,maxSpeed:.002,accelerationFactor:1.3,decelerationFactor:.9,ellipseMajorAxis:9.5,ellipseMinorAxis:6.5,inclination:Math.PI/6,orbitAngle:Math.random()*Math.PI*2,zoomLevel:1,maxZoomLevel:2,minZoomLevel:.8,inHotspotMode:!1,orbitHistory:[]},this.celestialParams={sunPosition:new w(100,20,100),moonPosition:new w(-70,30,-50)},this._savedState=null,this.currentVideoPath="/mondes-immerges/interface/videos/globe-video.webm",this.aberrationVideoPath="/mondes-immerges/interface/videos/globe-video-aberration.webm",this.init()}init(){this.scene=new F;const e=new k(16777215,1.2);this.scene.add(e);const t=new q(16777215,.5);t.position.set(5,10,7),this.scene.add(t),this.scene.fog=new A(0,15e-5),this.camera=new W(60,window.innerWidth/window.innerHeight,.1,1e3),this.updateCameraPosition();try{const i=window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),o=i||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<4;this.renderer=new U({antialias:!i,alpha:!0,logarithmicDepthBuffer:!o,powerPreference:"high-performance",precision:i?"mediump":"highp"}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(i?1:Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!1,this.isMobile=i;const s=this.renderer.getContext();console.log("WebGL Version:",s.getParameter(s.VERSION)),console.log("WebGL Vendor:",s.getParameter(s.VENDOR)),console.log("Max Texture Size:",s.getParameter(s.MAX_TEXTURE_SIZE)),this.container.appendChild(this.renderer.domElement);const n=this.renderer.domElement;n.addEventListener("webglcontextlost",a=>{a.preventDefault(),console.warn("⚠️ WebGL context lost - arrêt du rendu"),this._contextLost=!0,M.onContextLost()}),n.addEventListener("webglcontextrestored",()=>{console.log("✅ WebGL context restored - reprise du rendu"),this._contextLost=!1,M.onContextRestored()})}catch(i){console.error("Erreur lors de la création du renderer WebGL:",i),this.handleWebGLError();return}this.skyboxLoaded=!1,this.setupLighting(),this.createOrbitPath(),window.addEventListener("resize",this.onWindowResize.bind(this)),this.container.addEventListener("click",this.onMouseClick.bind(this)),this.isMobile&&this.container.addEventListener("touchend",i=>{if(i.changedTouches.length===1){const o=i.changedTouches[0];this.onMouseClick({clientX:o.clientX,clientY:o.clientY})}},{passive:!0})}handleWebGLError(){const e=document.createElement("div");e.style.cssText=`
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        `,this.container.appendChild(e)}setupLighting(){const e=new k(4210768,.5);this.scene.add(e);const t=new q(16777215,1);t.position.copy(this.celestialParams.sunPosition),t.castShadow=!1,this.scene.add(t),this.sunLight=t;const i=new _(35071,65416,.6);this.scene.add(i)}createCelestialBodies(){const e=new T,t=e.load("/mondes-immerges/interface/images/sun-texture.jpg"),i=new v(3,32,32),o=new E({map:t,transparent:!0,opacity:.95}),s=new x(i,o);s.position.copy(this.celestialParams.sunPosition),this.scene.add(s);const n=e.load("/mondes-immerges/interface/images/moon-texture.jpg"),a=new v(1.5,32,32),d=new Y({map:n}),l=new x(a,d);l.position.copy(this.celestialParams.moonPosition),this.scene.add(l),this.sun=s,this.moon=l}createOrbitPath(){const e=[];for(let s=0;s<=100;s++){const n=s/100*Math.PI*2,a=this.orbitParams.ellipseMajorAxis,d=this.orbitParams.ellipseMinorAxis,l=this.orbitParams.inclination;let u=a*Math.cos(n),p=d*Math.sin(n);const m=p*Math.sin(l);p=p*Math.cos(l),e.push(new w(u,m,p))}new X().setFromPoints(e);const i=new v(.2,16,16),o=new E({color:16763904,transparent:!0,opacity:.9});this.cameraMarker=new x(i,o),this.scene.add(this.cameraMarker)}createGlobe(){return new Promise((e,t)=>{const i=document.createElement("video");i.src=this.currentVideoPath,i.loop=!0,i.muted=!0,i.autoplay=!1,i.playsInline=!0,i.crossOrigin="anonymous",i.preload="auto",this.videoElement=i,console.log("📦 Préchargement de la vidéo du globe...",this.currentVideoPath);let o=!1;const s=setTimeout(()=>{o||(console.warn("⚠️ Timeout préchargement vidéo - continuation"),o=!0,e())},1e4);i.addEventListener("canplaythrough",()=>{o||(console.log("✅ Vidéo du globe préchargée et prête"),o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("canplay",()=>{o||(console.log("✅ Vidéo du globe peut être jouée"),o=!0,clearTimeout(s),e())},{once:!0}),i.addEventListener("error",f=>{o||(console.error("❌ Erreur chargement vidéo globe:",f),console.warn("Continuation malgré l'erreur"),o=!0,clearTimeout(s),e())}),M.register(i,{loop:!0,muted:!0,autoRetry:!0,name:"globe-texture",onError:f=>{console.error("❌ Erreur critique vidéo du globe:",f)},onPlay:()=>{console.log("▶️ Vidéo du globe en lecture")}}),this.videoTexture=new Z(i),this.videoTexture.minFilter=D,this.videoTexture.magFilter=D,this.videoTexture.format=K,this.videoTexture.colorSpace=J;const n=this.isMobile?32:64,a=new v(1.99,n,n),d=new E({color:0,transparent:!0,opacity:0,colorWrite:!1,depthWrite:!0,side:z}),l=new x(a,d);l.renderOrder=0,this.scene.add(l),this.depthSphere=l;const u=new v(2,n,n),p=new E({map:this.videoTexture,transparent:!0,opacity:1,side:z,depthTest:!0,depthWrite:!1,color:16777215,toneMapped:!1});this.globe=new x(u,p),this.globe.castShadow=!0,this.globe.receiveShadow=!0,this.globe.renderOrder=1,this.scene.add(this.globe);const m=new v(2.02,64,64),h=new E({color:16777215,transparent:!0,opacity:.4,alphaTest:.1,depthTest:!0,depthWrite:!1});this.clouds=new x(m,h),this.clouds.renderOrder=2,this.scene.add(this.clouds),i.load()})}createAtmosphere(){const e=new v(2.15,64,64),t=new B({vertexShader:`
            ...
            `,blending:$,side:O,transparent:!0}),i=new x(e,t);this.scene.add(i),this.atmosphere=i}createSkybox(){return new Promise((e,t)=>{const i=new T,o="/mondes-immerges/interface/images/night-sky.png";console.log("📦 Préchargement de la skybox...",o);let s=!1;const n=setTimeout(()=>{s||(console.warn("⚠️ Timeout préchargement skybox - utilisation couleur par défaut"),this.scene.background=new S(17),s=!0,e())},8e3);i.load(o,a=>{if(!s){try{this.renderer.toneMapping=Q,this.renderer.toneMappingExposure=.6;const d=this.isMobile?512:1024,l=Math.min(a.image.height,d);console.log(`📐 Cubemap: ${l}px (image: ${a.image.width}x${a.image.height})`);const u=new ee(l);u.fromEquirectangularTexture(this.renderer,a),this.scene.background=u.texture,a.dispose(),this.scene.fog=new A(17,5e-5),console.log("✅ Skybox chargée avec exposition améliorée")}catch(d){console.error("❌ Erreur création cubemap skybox:",d),this.scene.background=new S(17)}s=!0,clearTimeout(n),e()}},void 0,a=>{s||(console.error("❌ Erreur chargement skybox:",a),this.scene.background=new S(17),s=!0,clearTimeout(n),e())})})}preloadAllAssets(){return console.log("🎬 DÉBUT DU PRÉCHARGEMENT COMPLET..."),Promise.all([this.createGlobe(),this.createSkybox()]).then(()=>{console.log("✅ PRÉCHARGEMENT COMPLET TERMINÉ"),console.log("   - Vidéo du globe: PRÊTE"),console.log("   - Skybox étoilée: PRÊTE"),console.log("   - Tous les assets: PRÊTS À AFFICHER"),this.videoElement&&this.videoElement.play().catch(e=>{console.error("Erreur lecture vidéo:",e)}),M.startMonitoring(2e3),console.log("✅ VideoManager: Surveillance active")}).catch(e=>{console.error("❌ Erreur durant le préchargement:",e),this.videoElement&&this.videoElement.play().catch(t=>{console.error("Erreur lecture vidéo:",t)}),M.startMonitoring(2e3)})}updateCameraPosition(){if(!this.orbitParams.isOrbiting)return;const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.set(i,n,o),this.orbitParams.orbitAngle+=this.orbitParams.currentSpeed,this.orbitParams.orbitHistory.push(new w(i,n,o)),this.orbitParams.orbitHistory.length>100&&this.orbitParams.orbitHistory.shift()}_updateCameraPositionManual(){const e=this.orbitParams.ellipseMajorAxis*this.orbitParams.zoomLevel,t=this.orbitParams.ellipseMinorAxis*this.orbitParams.zoomLevel;let i=e*Math.cos(this.orbitParams.orbitAngle),o=t*Math.sin(this.orbitParams.orbitAngle);const s=this.orbitParams.inclination,n=o*Math.sin(s);o=o*Math.cos(s),this.camera.position.set(i,n,o),this.camera.lookAt(0,0,0),this.cameraMarker&&this.cameraMarker.position.copy(this.camera.position)}addHotspots(e){this.hotspotObjects.forEach(t=>{if(this.scene.remove(t),t.userData.label&&t.userData.labelHandlers){const{onMouseEnter:i,onMouseLeave:o,onClick:s}=t.userData.labelHandlers;t.userData.label.removeEventListener("mouseenter",i),t.userData.label.removeEventListener("mouseleave",o),t.userData.label.removeEventListener("click",s)}t.userData.label&&t.userData.label.parentNode&&t.userData.label.parentNode.removeChild(t.userData.label),t.userData.connectorSvg&&t.userData.connectorSvg.parentNode&&t.userData.connectorSvg.parentNode.removeChild(t.userData.connectorSvg),t.userData.labelContainer&&t.userData.labelContainer.parentNode&&t.userData.labelContainer.parentNode.removeChild(t.userData.labelContainer)}),this.hotspotObjects=[],document.querySelectorAll(".hotspot-label").forEach(t=>t.remove()),document.querySelectorAll(".hotspot-label-container").forEach(t=>t.remove()),document.querySelectorAll(".connector-line").forEach(t=>t.remove()),e.forEach(t=>{const{position:i,title:o}=t,s=i.lat*(Math.PI/180),n=i.lng*(Math.PI/180),l=2+.15,u=l*Math.cos(s)*Math.cos(n),p=l*Math.sin(s),m=l*Math.cos(s)*Math.sin(n);console.log(`Hotspot ${o}: GPS(${i.lat}, ${i.lng}) -> 3D(${u.toFixed(2)}, ${p.toFixed(2)}, ${m.toFixed(2)})`);const h=new v(.05,16,16),f=new E({color:16768256,transparent:!0,opacity:0,depthTest:!0,depthWrite:!0,toneMapped:!1}),g=new x(h,f);g.position.set(u,p,m),g.userData={hotspot:t};const b=new v(.08,16,16),C=new E({color:16768256,transparent:!0,opacity:0,side:O,depthTest:!0,depthWrite:!1,toneMapped:!1}),P=new x(b,C);g.add(P),g.userData.materials=[f,C],this.addHotspotLabel(g,o,new w(u,p,m)),this.scene.add(g),this.hotspotObjects.push(g)})}addHotspotLabel(e,t,i){const o=document.createElement("div");o.className="hotspot-label",o.textContent=t,o.style.cssText=`
            position: fixed;
        ...
        `;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.classList.add("hotspot-connector"),s.style.cssText=`
            ...
            z-index: 50;
            opacity: 0;
        `;const n=document.createElementNS("http://www.w3.org/2000/svg","line");n.setAttribute("stroke","rgba(255, 204, 0, 0.6)"),n.setAttribute("stroke-width","1.5"),n.setAttribute("stroke-dasharray","4, 4"),s.appendChild(n),document.body.appendChild(o),document.body.appendChild(s);const a=()=>{o.style.backgroundColor="rgba(255, 204, 0, 0.9)",o.style.color="#000",o.style.transform="scale(1.05)"},d=()=>{o.style.backgroundColor="rgba(0, 0, 0, 0.8)",o.style.color="#ffdd00",o.style.transform="scale(1)"},l=u=>{u.stopPropagation();const p=e.userData.hotspot;p&&(console.log(`Label cliqué: ${p.title}`),this.activateHotspot(p))};o.addEventListener("mouseenter",a),o.addEventListener("mouseleave",d),o.addEventListener("click",l),e.userData.label=o,e.userData.connectorSvg=s,e.userData.connectorLine=n,e.userData.worldPosition=i.clone(),e.userData.labelHandlers={onMouseEnter:a,onMouseLeave:d,onClick:l},e.userData.labelText=t}onMouseClick(e){if(this.orbitParams.inHotspotMode)return;this.mouse.x=e.clientX/window.innerWidth*2-1,this.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);const t=this.raycaster.intersectObject(this.globe);if(t.length>0){const o=t[0].point,n=Math.acos(o.y/2),a=Math.atan2(o.z,o.x),d=90-n*180/Math.PI,l=a*180/Math.PI-180;console.log(`Clic sur le globe à lat: ${d.toFixed(2)}, lng: ${l.toFixed(2)}`);const u=this._findNearestHotspot(d,l,10);if(u){console.log(`Hotspot trouvé: ${u.title}`),this.activateHotspot(u);return}}const i=this.raycaster.intersectObjects(this.hotspotObjects);if(i.length>0){const o=i[0].object.userData.hotspot;console.log(`Hotspot sélectionné par raycasting: ${o.title}`),this.activateHotspot(o)}}_findNearestHotspot(e,t,i){let o=null,s=i;const n=this.hotspotObjects.map(a=>a.userData.hotspot).filter(Boolean);for(const a of n){const d=a.position.lat,l=a.position.lng,u=Math.sqrt(Math.pow(d-e,2)+Math.pow(l-t,2));u<s&&(s=u,o=a)}return o}activateHotspot(e){if(this.orbitParams.inHotspotMode)return;console.log(`=== ACTIVATION HOTSPOT: ${e.title} ===`);const t=e.position.lat*(Math.PI/180),i=e.position.lng*(Math.PI/180),o=2.1,s=o*Math.cos(t)*Math.cos(i),n=o*Math.sin(t),a=o*Math.cos(t)*Math.sin(i),d=new w(s,n,a);this.orbitParams.isOrbiting=!1;const l=this.camera.position.clone(),m=d.clone().normalize().multiplyScalar(5.2),h=new w().addVectors(l,m).multiplyScalar(.5);h.normalize().multiplyScalar(h.length()+1.8);const g=c.timeline();g.to(this.camera.position,{x:h.x,y:h.y,z:h.z,duration:1,ease:"power1.inOut",onUpdate:()=>{this.camera.lookAt(0,0,0)}});let b=document.getElementById("fade-overlay");b||(b=document.createElement("div"),b.id="fade-overlay",b.style.cssText=`
                position: fixed;
                top: 0;
                left: 0;
                width: 100%;
                ...
                z-index: 98000;
                pointer-events: none;
            `,document.body.appendChild(b)),g.to(this.camera.position,{x:m.x,y:m.y,z:m.z,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.lookAt(0,0,0)},onComplete:()=>{this.orbitParams.inHotspotMode=!0,this._redirectToExternalPage(e)}},"-=0.3"),g.to(b,{opacity:1,duration:.8,ease:"power2.in"},"-=0.8"),g.to(this.camera,{fov:55,duration:1.2,ease:"power2.out",onUpdate:()=>{this.camera.updateProjectionMatrix()}},"-=1.2")}_redirectToExternalPage(e){console.log("=== REDIRECTION VERS PAGE EXTERNE ==="),this.playTransitionVideoAndRedirect(e.id)}playTransitionVideoAndRedirect(e){const t=document.getElementById("transition-video-out");if(!t){console.warn("⚠️ Vidéo de transition de sortie introuvable, redirection directe");const i=L(e);window.location.href=i;return}console.log("🎬 TRANSITION SORTIE (vidéo normale)"),t.classList.add("active"),t.currentTime=0,t.play().then(()=>{console.log("Vidéo de transition lancée"),t.addEventListener("ended",()=>{console.log("✅ Vidéo terminée, redirection...");const i=L(e);window.location.href=i},{once:!0})}).catch(i=>{console.error("❌ Erreur vidéo:",i);const o=L(e);window.location.href=o}),setTimeout(()=>{console.warn("⚠️ Timeout vidéo, redirection forcée");const i=L(e);window.location.href=i},1e4)}createScanEffect(e){const t=(90-e.lat)*(Math.PI/180),i=(e.lng+180)*(Math.PI/180),o=-(2.1*Math.sin(t)*Math.cos(i)),s=2.1*Math.cos(t),n=2.1*Math.sin(t)*Math.sin(i),a=new R(0,.3,32),d=new B({uniforms:{color:{value:new S(16763904)},time:{value:0}},vertexShader:`
               varying vec2 vUv;
               void main() {
                   vUv = uv;
                   gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,s.appendChild(a),o.appendChild(s);const d=document.createElement("style");d.textContent=`
            @keyframes orbit0 {
        ...
        `,document.head.appendChild(d),(i||this.effectsContainer).appendChild(o),c.fromTo(o,{opacity:0},{opacity:1,duration:.5,onComplete:()=>{i&&e&&(console.log("🎨 Orbital loader visible, début transition fond noir"),e())}}),setTimeout(()=>{i?(o.remove(),d.remove(),console.log("✅ Orbital loader supprimé instantanément")):c.to(o,{opacity:0,duration:1,onComplete:()=>{o.remove(),d.remove(),e&&e()}})},t*1e3)}highlightSelection(e){const t=document.createElement("div");t.classList.add("highlight-effect"),t.style.position="absolute",t.style.width="100px",t.style.height="100px",t.style.borderRadius="50%",t.style.border="2px solid #ffcc00",t.style.boxShadow="0 0 20px rgba(255, 204, 0, 0.5)",t.style.transform="translate(-50%, -50%)",t.style.pointerEvents="none",t.style.top="50%",t.style.left="50%",this.effectsContainer.appendChild(t),c.fromTo(t,{scale:.5,opacity:0},{scale:1.5,opacity:.8,duration:.8,ease:"elastic.out(1, 0.3)",onComplete:()=>{c.to(t,{scale:2,opacity:0,duration:.5,delay:.3,onComplete:()=>{t.remove()}})}})}createRadarScanEffect(e,t={}){const o={...{radius:50,duration:1,color:"rgba(255, 204, 0, 0.4)",pulseCount:1},...t};for(let s=0;s<o.pulseCount;s++)setTimeout(()=>{const n=document.createElement("div");n.style.cssText=`
                    position: absolute;
                    top: ${e.y}px;
                    left: ${e.x}px;
                    width: 10px;
        ...
        `;const a=o.querySelector(".notification-icon");a&&(a.style.cssText=`
                ...
                font-weight: bold;
                flex-shrink: 0;
            `);const d=o.querySelector(".notification-message");d&&(d.style.cssText=`
                flex: 1;
                line-height: 1.4;
        ...
        `,this.effectsContainer.appendChild(t),c.timeline().to(t,{y:0,opacity:1,duration:.5,ease:"power2.out"}).to(t,{y:-10,opacity:0,duration:.5,delay:3,ease:"power2.in",onComplete:()=>{t.remove()}})}addBackgroundParticles(e={}){const i={...{count:50,container:this.container},...e},o=document.createElement("div");o.className="background-particles",o.style.cssText=`
            ...
            z-index: 1;
            pointer-events: none;
        `;for(let s=0;s<i.count;s++){const n=document.createElement("div"),a=Math.random()*3+1,d=Math.random()*100,l=Math.random()*100,u=Math.random()*5,p=Math.random()*10+10,m=Math.random()*.5+.1;n.style.cssText=`
                position: absolute;
                width: ${a}px;
                height: ${a}px;
...
`),(t?t.querySelectorAll("button"):[]).forEach(o=>{o.style.cssText=`
        ...
        `,i.appendChild(o),[{id:"grande-barriere",x:150,y:70,name:"Grande Barrière"},{id:"abysses",x:50,y:60,name:"Abysses"},{id:"arctique",x:100,y:20,name:"Arctique"},{id:"plastique",x:80,y:50,name:"Pollution"},{id:"triangle-corail",x:130,y:60,name:"Triangle Corail"},{id:"requins",x:70,y:40,name:"Requins"}].forEach(d=>{const l=document.createElement("div");l.className="minimap-dot",l.dataset.id=d.id,l.title=d.name,l.style.cssText=`
                ...
                transition: all 0.3s ease;
            `,l.addEventListener("mouseenter",()=>{c.to(l,{width:10,height:10,boxShadow:"0 0 10px rgba(255, 204, 0, 0.9)",duration:.3}),this.showTooltip(l,d.name,{position:"top",duration:2e3})}),l.addEventListener("mouseleave",()=>{c.to(l,{width:6,height:6,boxShadow:"0 0 5px rgba(255, 204, 0, 0.7)",duration:.3})}),l.addEventListener("click",()=>{t&&t(d.id)}),i.appendChild(l)});const n=document.createElement("div");n.className="minimap-toggle",n.innerHTML="−",n.style.cssText=`
            position: absolute;
            top: 5px;
            right: 5px;
            width: 20px;
        ...
        `;t.area&&(i+=`<strong>Superficie:</strong> ${t.area}<br>`),t.iceExtent&&(i+=`<strong>Étendue de glace:</strong> ${typeof t.iceExtent=="object"?`Hiver: ${t.iceExtent.winter}, Été: ${t.iceExtent.summer}`:t.iceExtent}<br>`),t.annualInput&&(i+=`<strong>Apport annuel:</strong> ${t.annualInput}<br>`),t.economicValue&&(i+=`<strong>Valeur économique:</strong> ${t.economicValue}<br>`),i+="</div>";let o="";e.detailedInfo&&(o=`
            ...
            ${o}
            ${s}
        `}handleHotspotExit(){this.contentPanel&&this.contentPanel.hide&&this.contentPanel.hide();const e=document.querySelector(".coordinates-display");e&&(e.style.backgroundColor="rgba(0, 0, 0, 0.7)",e.style.borderColor="rgba(255, 204, 0, 0.3)"),this.interfaceUI&&this.interfaceUI.setUIVisibility&&this.interfaceUI.setUIVisibility(!0),this.currentHotspot=null}}const H=new ue;function pe(){H.init()}function me(){return H}const y={initialized:!1,webGLChecked:!1,domReady:!1,appStarted:!1,cleanupDone:!1};function he(){if(y.webGLChecked)return!0;console.log("🔍 Vérification WebGL...");try{const r=document.createElement("canvas"),e=r.getContext("webgl")||r.getContext("experimental-webgl");if(!e)return console.error("❌ WebGL non supporté"),ge(),y.webGLChecked=!1,!1;console.log("✅ WebGL compatible"),y.webGLChecked=!0;const t=e.getExtension("WEBGL_lose_context");return t&&t.loseContext(),!0}catch(r){return console.error("❌ Erreur vérification WebGL:",r),!1}}function ge(){const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
        ...
        `)}function fe(){if(window.innerWidth<768||/Android|webOS|iPhone|iPad|iPod/i.test(navigator.userAgent)){console.log("📱 Curseur désactivé sur mobile");return}const e=document.querySelector(".cursor"),t=document.querySelector(".cursor-follower");if(!e||!t)return;let i=0,o=0,s=0,n=0,a=null,d=0;const l=16,u=m=>{const h=performance.now();h-d<l||(d=h,i=m.clientX,o=m.clientY)};document.addEventListener("mousemove",u,{passive:!0});function p(){e.style.transform=`translate(${i}px, ${o}px)`,s+=(i-s)*.1,n+=(o-n)*.1,t.style.transform=`translate(${s}px, ${n}px)`,a=requestAnimationFrame(p)}a=requestAnimationFrame(p),window.addEventListener("beforeunload",()=>{a&&cancelAnimationFrame(a),document.removeEventListener("mousemove",u)},{once:!0}),console.log("✅ Curseur initialisé (desktop)")}async function be(){return new Promise(r=>{const e=document.querySelector("l-jelly"),t=document.getElementById("transition-video-in"),i=document.getElementById("loading-screen"),o=document.getElementById("main-container");if(!t){console.warn("⚠️ Vidéo de transition d'entrée introuvable"),r();return}console.log("🎬 TRANSITION ENTRÉE (vidéo inversée)"),e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>e.remove(),300)),o&&(o.style.opacity="1",console.log("🌍 Globe visible immédiatement")),i&&(i.style.background="transparent",console.log("✅ Loading-screen transparent")),M.register(t,{loop:!1,muted:!0,autoRetry:!0,name:"transition-video-in"}),t.classList.add("active"),t.currentTime=0,t.play().then(()=>{console.log("Vidéo de transition lancée"),t.addEventListener("ended",function(){console.log("✅ Vidéo de transition terminée"),t.classList.remove("active"),i&&(i.style.display="none",i.classList.add("hidden")),setTimeout(()=>r(),300)},{once:!0})}).catch(s=>{console.error("❌ Erreur lors du lancement de la vidéo:",s),t.classList.remove("active"),r()}),t.addEventListener("loadedmetadata",function(){const s=t.duration;console.log("📹 Durée de la vidéo:",s+"s"),setTimeout(()=>{t.classList.contains("active")&&(console.warn("⚠️ Timeout vidéo transition"),t.classList.remove("active"),r())},(s+2)*1e3)},{once:!0}),setTimeout(()=>{t.classList.contains("active")&&(console.warn("⚠️ Timeout ultime"),t.classList.remove("active"),r())},15e3)})}async function ye(){if(y.appStarted){console.warn("⚠️  Application déjà démarrée");return}console.log("🚀 Démarrage application..."),y.appStarted=!0;try{pe();const r=me();if(!r)throw new Error("Instance application non disponible");console.log("✅ Application initialisée"),xe(),console.log("⏳ PRÉCHARGEMENT DES ASSETS EN COURS..."),r.globeManager&&r.globeManager.preloadAllAssets?(await r.globeManager.preloadAllAssets(),console.log("✅ TOUS LES ASSETS SONT PRÊTS")):console.warn("⚠️  preloadAllAssets non disponible, passage direct"),await be(),console.log("🌊 Démarrage exploration..."),r.startExploration(!0),ve(r)}catch(r){console.error("❌ Erreur application:",r),we()}}function xe(){const r=document.getElementById("main-container");if(!r)return;r.classList.remove("hidden"),r.style.opacity="0",r.style.transition="opacity 1s cubic-bezier(0.19, 1, 0.22, 1)";const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelector(".scanner-effect");e&&(e.style.opacity="0",e.style.transform="translateY(20px)",e.style.pointerEvents="none"),t.forEach(s=>{s.style.opacity="0"}),i&&(i.style.opacity="0"),o&&(o.style.opacity="0"),console.log("✅ Interface initialisée en mode clear")}function ve(r){const e=document.getElementById("ui-controls"),t=document.querySelectorAll(".satellite-hud, .coordinates-display"),i=document.querySelector(".satellite-crosshair"),o=document.querySelectorAll(".hotspot-label"),s=document.querySelectorAll("svg"),n=document.querySelector(".scanner-effect");console.log("✨ Apparition des éléments UI + hotspots + connector lines"),r&&r.globeManager&&r.globeManager.showLabels(),e&&(e.style.pointerEvents="auto"),window.gsap?(e&&gsap.to(e,{opacity:1,y:0,duration:.8,ease:"power2.out"}),gsap.to([...t,i,n].filter(Boolean),{opacity:1,duration:.8,ease:"power2.out"}),gsap.to([...o,...s],{opacity:1,duration:.8,ease:"power2.out"})):(e&&(e.style.transition="all 0.8s ease",e.style.opacity="1",e.style.transform="translateY(0)"),t.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),i&&(i.style.transition="opacity 0.8s ease",i.style.opacity="1"),n&&(n.style.transition="opacity 0.8s ease",n.style.opacity="1"),o.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}),s.forEach(a=>{a.style.transition="opacity 0.8s ease",a.style.opacity="1"}))}function we(r){const e=document.getElementById("loading-screen");e&&(e.innerHTML=`
    ...
    `,document.head.appendChild(t)}function Me(){if(y.initialized){console.warn("⚠️  Déjà initialisé");return}if(console.log("🌊 Initialisation Mondes Immergés..."),y.initialized=!0,!he())return;Ee();let r=0;const e=setInterval(()=>{r+=12.5,r>=100&&(clearInterval(e),console.log("✅ Chargement terminé"),setTimeout(()=>{ye()},300))},200)}function Ce(){y.cleanupDone||(console.log("🧹 Nettoyage des ressources..."),y.cleanupDone=!0)}document.addEventListener("DOMContentLoaded",()=>{if(y.domReady){console.warn("⚠️  DOM déjà prêt");return}console.log("📄 DOM chargé"),y.domReady=!0,fe(),setTimeout(()=>{Me()},100)});window.addEventListener("error",r=>{if(r.target!==window&&(r.target.tagName==="IMG"||r.target.tagName==="SCRIPT")){console.warn("⚠️  Ressource non chargée:",r.target.src||r.target.href);return}console.error("❌ Erreur:",r.message)},{once:!1,capture:!0});window.addEventListener("unhandledrejection",r=>{console.error("❌ Promesse rejetée:",r.reason),r.preventDefault()},{once:!1});window.addEventListener("beforeunload",Ce,{once:!0});window.addEventListener("pageshow",r=>{(r.persisted||window.performance&&window.performance.navigation.type===2)&&(console.log("🔄 Page restaurée depuis le cache, rechargement..."),window.location.reload())});
